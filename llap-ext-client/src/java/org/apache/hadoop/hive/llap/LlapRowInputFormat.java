...
public class LlapRowInputFormat implements InputFormat<NullWritable, Row> {
  ...
  private final LlapBaseInputFormat<BytesWritable> baseInputFormat = new LlapBaseInputFormat<>(LlapBaseRecordReader::createLlapBaseRecordReader);
  ...
  public RecordReader<NullWritable, Row> getRecordReader(InputSplit split, JobConf job, Reporter reporter)
    ...
    LlapBaseRecordReader<BytesWritable> reader = baseInputFormat.getRecordReader(llapSplit, job, reporter);
