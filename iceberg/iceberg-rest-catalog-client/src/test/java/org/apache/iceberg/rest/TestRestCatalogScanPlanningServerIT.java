 ...
 * planning to the catalog server ({@code POST /plan}). Excluded from the default Surefire fork (see
 * {@code iceberg-rest-catalog-client/pom.xml}) because this module depends on {@code
