...
public final class VariantPathUtil {
  ...
  public static final String SHREDDED_VARIANT_TYPED_VALUE_SEGMENT = ".typed_value.";
  ...
  public static String shreddedColumnPath(String variantColumn, List<String> segments) {
    ...
    return variantColumn + SHREDDED_VARIANT_TYPED_VALUE_SEGMENT + String.join(".", segments);
  }
  ...
  public static String extractVariantShreddedColumn(UnboundPredicate<?> predicate) {
    ...
    if (column != null && column.contains(SHREDDED_VARIANT_TYPED_VALUE_SEGMENT)) {
      return column;
    }
