 ...
 *
 * <p>What grows with scale: the footer, ~196 bytes per partition, read whole before any blob;
 * and a blob, ~634 bytes per column - under the ~64KiB an object store serves per request,
 * asking for fewer columns saves decode, not I/O.
 */
