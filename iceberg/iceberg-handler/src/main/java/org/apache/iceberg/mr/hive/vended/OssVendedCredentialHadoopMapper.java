...
enum OssVendedCredentialHadoopMapper implements VendedCredentialHadoopMapper {
  INSTANCE;

  static final String CLIENT_ACCESS_KEY_ID = "client.access-key-id";
  static final String CLIENT_ACCESS_KEY_SECRET = "client.access-key-secret";
  static final String CLIENT_SECURITY_TOKEN = "client.security-token";
  static final String OSS_ENDPOINT = "oss.endpoint";

  @Override
  public boolean supportsPrefix(String prefix) {
    return "oss".equals(VendedCredentialPrefixUtil.schemeFromPrefix(prefix));
  }
