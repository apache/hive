...
----------------------------------------------------------------------------------------------------------------
-- MINOR COMPACTION WITH FILE_SIZE_THRESHOLD CLAUSE
----------------------------------------------------------------------------------------------------------------

alter table ice_orc COMPACT 'minor' and wait file_size_threshold = '365bytes' pool 'iceberg' where first_name != 'Joe' order by first_name;
...
----------------------------------------------------------------------------------------------------------------
-- MINOR COMPACTION WITHOUT FILE_SIZE_THRESHOLD CLAUSE
----------------------------------------------------------------------------------------------------------------
