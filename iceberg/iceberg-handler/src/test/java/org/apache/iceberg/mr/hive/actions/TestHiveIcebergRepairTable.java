...
public class TestHiveIcebergRepairTable {
  ...
  public void testRepairWithNoMissingFiles() throws Exception {
    ...
    assertEquals("No files should be removed when all files exist", 0, result.getNumIssues());
  ...
  public void testRepairWithMissingFiles() throws Exception {
    ...
    assertEquals("One file reference should be removed", 1, result.getNumIssues());
  ...
  public void testRepairWithMultipleMissingFiles() throws Exception {
    ...
    assertEquals("Three file references should be removed", 3, result.getNumIssues());
  }
  ...
  public void testRepairDryRunMode() throws Exception {
    ...
    assertEquals("Should identify 1 missing file", 1, result.getNumIssues());
