...
public class TestCatalogs {
  ...
  public void testLoadCatalogHive() {
    String catalogName = "barCatalog";
    conf.set(IcebergCatalogProperties.catalogPropertyConfigKey(catalogName, CatalogUtil.ICEBERG_CATALOG_TYPE),
  ...
  public void testLoadCatalogHadoop() {
    ...
    conf.set(IcebergCatalogProperties.catalogPropertyConfigKey(catalogName, CatalogProperties.WAREHOUSE_LOCATION),
        "/tmp/mylocation");
  ...
  public void testLoadCatalogCustom() {
    String catalogName = "barCatalog";
    conf.set(IcebergCatalogProperties.catalogPropertyConfigKey(catalogName, CatalogProperties.CATALOG_IMPL),
  ...
  public void testDefaultCatalogProperties() {
    ...
    // Set global property
    final String defaultCatalogProperty = IcebergCatalogProperties.CATALOG_DEFAULT_CONFIG_PREFIX + catalogProperty;
