...
public class HiveIcebergRESTCatalogClientAdapterTest  {
    ...
    TableOperations ops = new TableOperations() {
      ...
      public TableMetadata current() {
        return TableMetadata
            .newTableMetadata(new Schema(),PartitionSpec.unpartitioned(),"location", new HashMap<>());
      }
  ...
  public void testCreateTable() throws TException {
    ...
    Mockito.verify(restCatalog).createTable(any(),
        any(), any(), any());
  }
