...
public class HiveIcebergRESTCatalogClientAdapter implements IMetaStoreClient, Configurable {
  ...
  private static final String SERDE_INFO = "serdeInfo";
  private static final String DEFAULT_INPUT_FORMAT_CLASS = "org.apache.hadoop.mapred.TextInputFormat";
  private static final String DEFAULT_OUTPUT_FORMAT_CLASS
      = "org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat";
  private static final String DEFAULT_SERDE_CLASS = "org.apache.hadoop.hive.serde2.lazy.LazySimpleSerDe";
  private Configuration conf;
  private RESTCatalog restCatalog;

  public HiveIcebergRESTCatalogClientAdapter() {
  }
  ...
  public void reconnect() throws MetaException {
    String uri = conf.get("metastore.rest.uri");
//    String identity = "user";
//    String credential = "60a0259abffa8ced:e9a7fcc9412d327dc23d33c30db9c463";
//    SessionCatalog.SessionContext context = new SessionCatalog.SessionContext(UUID.randomUUID().toString(), identity,
//        ImmutableMap.of("credential", credential), ImmutableMap.of());
    SessionCatalog.SessionContext context = SessionCatalog.SessionContext.createEmpty();

    restCatalog = new RESTCatalog(context, config -> HTTPClient.builder(config).uri(uri).build());
    String name = "prod";
    Map<String, String> properties = Maps.newHashMap();

    properties.put(CatalogProperties.CATALOG_IMPL, RESTCatalog.class.getName());
    properties.put(CatalogProperties.URI, uri);
    restCatalog.initialize(name, properties);
  }
  ...
  private Table convertIcebergTableToHiveTable(org.apache.iceberg.Table icebergTable) {
    ...
    hiveTable.setParameters(Maps.newHashMap());
    ...
    if (icebergTable.properties().containsKey(SERDE_INFO)) {
      ...
      serDeInfo.setSerializationLib(DEFAULT_SERDE_CLASS);
  ...
  public void createTable(Table tbl)
    ...
    restCatalog.createTable(TableIdentifier.of(tbl.getDbName(), tbl.getTableName()), schema);
  }
