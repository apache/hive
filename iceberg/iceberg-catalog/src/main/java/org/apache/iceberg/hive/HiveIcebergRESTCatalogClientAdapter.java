...
//        ImmutableMap.of("credential", credential), ImmutableMap.of());
  ...
  private Table convertIcebergTableToHiveTable(org.apache.iceberg.Table icebergTable) {
    ...
    icebergTableConverter.setHmsTableParameters(metadata.metadataFileLocation(), hiveTable,
        metadata, null, true);
  ...
  public void createTable(Table tbl)
    ...
    org.apache.iceberg.Table table = restCatalog.createTable(TableIdentifier.of(tbl.getDbName(), tbl.getTableName()),
        schema, org.apache.iceberg.PartitionSpec.unpartitioned(), catalogProperties);
    // TODOD use .buildTable(..).withSortOrder
  }
