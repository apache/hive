...
public class TestTxnIdUtils {
  ...
  public void testCheckEquivalentWriteIds() throws Exception {
    TableName tableName = TableName.fromString("hive.default.table1", null, null);
    ValidReaderWriteIdList id1 = new ValidReaderWriteIdList(tableName,
    ...
    ValidReaderWriteIdList id2 = new ValidReaderWriteIdList(tableName,
    ...
    ValidReaderWriteIdList id3 = new ValidReaderWriteIdList(tableName,
    ...
    ValidReaderWriteIdList id4 = new ValidReaderWriteIdList(tableName,
    ...
    ValidReaderWriteIdList id5 = new ValidReaderWriteIdList(tableName,
    ...
    ValidReaderWriteIdList id6 = new ValidReaderWriteIdList(
        TableName.fromString("hive.default.tab2", null, null),
        new long[] {1,2,3,4,5}, new BitSet(), 5, 1);
    assertFalse(TxnIdUtils.checkEquivalentWriteIds(id1, id6));

    // WriteID for table1, way in the future
    ValidReaderWriteIdList id7 = new ValidReaderWriteIdList(tableName,
    ...
    ValidReaderWriteIdList id8 = new ValidReaderWriteIdList(tableName,
    ...
    ValidReaderWriteIdList id9 = new ValidReaderWriteIdList(tableName,
        new long[] {}, new BitSet(), 5);
    ValidReaderWriteIdList id10 = new ValidReaderWriteIdList(tableName,
        new long[] {}, new BitSet(), 5);
