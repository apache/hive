...
$GLOBALS['serde_CONSTANTS']['SERIALIZATION_NULL_SORT_ORDER'] = "serialization.sort.order.null";
...
$GLOBALS['serde_CONSTANTS']['COLLECTION_DELIM'] = "collection.delim";
...
$GLOBALS['serde_CONSTANTS']['TIMESTAMPLOCALTZ_TYPE_NAME'] = "timestamp with local time zone";
...
$GLOBALS['serde_CONSTANTS']['COLUMN_NAME_DELIMITER'] = "column.name.delimiter";
...
$GLOBALS['serde_CONSTANTS']['MAX_CHAR_LENGTH'] = 255;

$GLOBALS['serde_CONSTANTS']['MAX_VARCHAR_LENGTH'] = 65535;

$GLOBALS['serde_CONSTANTS']['SYSTEM_DEFAULT_PRECISION'] = 38;

$GLOBALS['serde_CONSTANTS']['SYSTEM_DEFAULT_SCALE'] = 18;

$GLOBALS['serde_CONSTANTS']['USER_DEFAULT_PRECISION'] = 10;

$GLOBALS['serde_CONSTANTS']['USER_DEFAULT_SCALE'] = 0;

$GLOBALS['serde_CONSTANTS']['MAX_PRECISION'] = 38;

$GLOBALS['serde_CONSTANTS']['MAX_SCALE'] = 38;
