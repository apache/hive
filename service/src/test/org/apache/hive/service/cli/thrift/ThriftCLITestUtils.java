    ...
    public static void startHiveServer2WithConf(HiveConf hiveConf) throws Exception {
        ...
        for(int tryCount = 0; (tryCount < RETRY_COUNT); tryCount++){
            try {
                ...
                hs2Exception = e;
                hiveConf.setIntVar(hiveConf, HiveConf.ConfVars.HIVE_SERVER2_THRIFT_PORT, findFreePort());
                hiveConf.setIntVar(hiveConf, HiveConf.ConfVars.HIVE_SERVER2_THRIFT_HTTP_PORT, findFreePort());
                hiveConf.setIntVar(hiveConf, HiveConf.ConfVars.HIVE_SERVER2_WEBUI_PORT, findFreePortExcepting(
