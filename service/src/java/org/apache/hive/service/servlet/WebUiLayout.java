...
public final class WebUiLayout {
  ...
  public static String pill(String s) {
    ...
    if (u.contains("FINISH") || u.equals("CLOSED") || u.equals("OK")) {
  ...
  private static String navItem(String href, String label, String svg, boolean active) {
    ...
    return "<a href=\"" + href + "\" class=\"" + cls + "\">"
      ...
      + "stroke-width=\"1.7\" stroke-linecap=\"round\" stroke-linejoin=\"round\">" + svg + "</svg>"
      + "<span>" + label + "</span></a>";
  }
  ...
  public static String sidebar(String active, String version, String uptime) {
    ...
    String iDash = "<rect x='3' y='3' width='7' height='7' rx='1'/><rect x='14' y='3' width='7' height='7' rx='1'/><rect x='3' y='14' width='7' height='7' rx='1'/><rect x='14' y='14' width='7' height='7' rx='1'/>";
    String iCfg = "<path d='M4 7h10M18 7h2M4 12h2M10 12h10M4 17h7M15 17h5'/><circle cx='16' cy='7' r='2'/><circle cx='8' cy='12' r='2'/><circle cx='13' cy='17' r='2'/>";
    String iMetrics = "<path d='M3 21h18'/><rect x='5' y='10' width='3' height='8' rx='1'/><rect x='11' y='5' width='3' height='13' rx='1'/><rect x='17' y='13' width='3' height='5' rx='1'/>";
    String iStacks = "<path d='M12 3l9 5-9 5-9-5 9-5z'/><path d='M3 13l9 5 9-5'/>";
    String iLogs = "<path d='M14 3H7a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8z'/><path d='M14 3v5h5M9 13h6M9 17h6'/>";
    String iLlap = "<rect x='3' y='4' width='18' height='6' rx='1'/><rect x='3' y='14' width='18' height='6' rx='1'/><path d='M7 7h.01M7 17h.01'/>";
    String iLog = "<circle cx='12' cy='12' r='3'/><path d='M12 2v3M12 19v3M2 12h3M19 12h3M5 5l1.5 1.5M17.5 17.5L19 19M19 5l-1.5 1.5M6.5 17.5L5 19'/>";
    String foot = (uptime == null || uptime.isEmpty())
      ? "Hive " + version
      : "Hive " + version + " &middot; up " + uptime;
    return "<aside class=\"w-60 shrink-0 flex flex-col border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900\">"
      + "<div class=\"h-14 flex items-center gap-2.5 px-5 border-b border-slate-200 dark:border-slate-800\">"
      + "<img src=\"/static/hive-logo.png\" alt=\"Hive\" class=\"shrink-0\" style=\"height:24px;width:auto;display:block\">"
      + "<span class=\"font-semibold tracking-tight text-slate-900 dark:text-slate-100 whitespace-nowrap\">Hive WebUI</span></div>"
      + "<nav class=\"flex-1 overflow-y-auto p-3 space-y-6\">"
      + "<div class=\"space-y-0.5\">" + groupLabel("Overview")
      + navItem("/hiveserver2.jsp", "Dashboard", iDash, active.equals("dashboard"))
      + navItem("/metrics.jsp", "Metrics", iMetrics, active.equals("metrics"))
      + navItem("/conf.jsp", "Configuration", iCfg, active.equals("config")) + "</div>"
      + "<div class=\"space-y-0.5\">" + groupLabel("Diagnostics")
      + navItem("/stacks.jsp", "Stack traces", iStacks, active.equals("stacks"))
      + navItem("/logs.jsp", "Logs", iLogs, active.equals("logs"))
      + navItem("/logconf.jsp", "Logging", iLog, active.equals("logging"))
      + navItem("/llap.jsp", "LLAP daemons", iLlap, active.equals("llap")) + "</div></nav>"
      + "<div class=\"p-4 border-t border-slate-200 dark:border-slate-800 text-xs text-slate-500\">"
      + "<div class=\"flex items-center gap-2\"><span class=\"w-2 h-2 rounded-full bg-emerald-500 pulse-dot\"></span>Running</div>"
