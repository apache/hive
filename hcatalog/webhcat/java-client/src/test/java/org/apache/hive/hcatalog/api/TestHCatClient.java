...
public class TestHCatClient {
  ...
  public static void startMetaStoreServer() throws Exception {
    ...
    MetastoreConf.setBoolVar(conf, ConfVars.EVENT_DB_NOTIFICATION_API_AUTH, false);

    // turn on db notification listener on metastore
    MetastoreConf.setClass(conf, ConfVars.TRANSACTIONAL_EVENT_LISTENERS, DbNotificationListener.class, TransactionalMetaStoreEventListener.class);
    MetastoreConf.setClass(conf, ConfVars.EVENT_MESSAGE_FACTORY, JSONMessageEncoder.class, MessageEncoder.class);
