...
public class NotificationListener extends MetaStoreEventListener {
  ...
  public void onCreateDatabase(CreateDatabaseEvent dbEvent)
    ...
    if (dbEvent.getStatus()) {
      String topicName = getTopicPrefix(dbEvent.getHandler().getConf());
  ...
  public void onAlterTable(AlterTableEvent tableEvent) throws MetaException {
    if (tableEvent.getStatus()) {
      ...
      // DB topic - Alan.
      String topicName = getTopicPrefix(tableEvent.getHandler().getConf()) + "." +
  ...
  public void onDropTable(DropTableEvent tableEvent) throws MetaException {
    ...
    if (tableEvent.getStatus()) {
      ...
      // DB topic - Alan.
      String topicName = getTopicPrefix(tableEvent.getHandler().getConf()) + "." + table.getDbName().toLowerCase();
