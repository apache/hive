...
public class StrictRegexWriter extends AbstractRecordWriter {
  ...
  /**
   * @deprecated As of release 1.3/2.1.  Replaced by {@link #StrictRegexWriter(HiveEndPoint, HiveConf, StreamingConnection)}
   */
  @Deprecated
   ...
   */
  @Deprecated
  public StrictRegexWriter(HiveEndPoint endPoint, HiveConf conf) throws StreamingException {
    this(endPoint, conf, null);
  }
  
  /**
   * @deprecated As of release 1.3/2.1.  Replaced by {@link #StrictRegexWriter(String, HiveEndPoint, HiveConf, StreamingConnection)}
   */
  @Deprecated
  public StrictRegexWriter(String regex, HiveEndPoint endPoint, HiveConf conf) throws StreamingException {
