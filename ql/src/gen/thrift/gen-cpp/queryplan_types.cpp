...
const std::map<int, const char*> _AdjacencyType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(2, _kAdjacencyTypeValues, _kAdjacencyTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));

std::ostream& operator<<(std::ostream& out, const AdjacencyType::type& val) {
  std::map<int, const char*>::const_iterator it = _AdjacencyType_VALUES_TO_NAMES.find(val);
...
const std::map<int, const char*> _NodeType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(2, _kNodeTypeValues, _kNodeTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
const std::map<int, const char*> _TaskType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(3, _kTaskTypeValues, _kTaskTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
void swap(Adjacency &a, Adjacency &b) noexcept {
  using ::std::swap;
  swap(a.node, b.node);
...
bool Adjacency::operator==(const Adjacency & rhs) const
{
  if (!(node == rhs.node))
    return false;
...
void swap(Operator &a, Operator &b) noexcept {
  using ::std::swap;
...
void swap(Task &a, Task &b) noexcept {
  using ::std::swap;
...
void swap(Stage &a, Stage &b) noexcept {
  using ::std::swap;
...
void swap(Query &a, Query &b) noexcept {
  using ::std::swap;
...
void swap(QueryPlan &a, QueryPlan &b) noexcept {
  using ::std::swap;
...
bool QueryPlan::operator==(const QueryPlan & rhs) const
{
