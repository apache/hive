...
public class Stage implements org.apache.thrift.TBase<Stage, Stage._Fields>, java.io.Serializable, Cloneable, Comparable<Stage> {
  ...
  public int compareTo(Stage other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetStageType()).compareTo(other.isSetStageType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStageType()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetStageCounters()).compareTo(other.isSetStageCounters());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStageCounters()) {
