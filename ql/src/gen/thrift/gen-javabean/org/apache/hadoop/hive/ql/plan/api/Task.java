...
public class Task implements org.apache.thrift.TBase<Task, Task._Fields>, java.io.Serializable, Cloneable, Comparable<Task> {
  ...
  public Task(
    ...
    java.util.Map<java.lang.String,java.lang.Long> taskCounters,
    boolean done,
    boolean started)
  {
    this();
  ...
  public int compareTo(Task other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetTaskAttributes()).compareTo(other.isSetTaskAttributes());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTaskAttributes()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetTaskCounters()).compareTo(other.isSetTaskCounters());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTaskCounters()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetOperatorGraph()).compareTo(other.isSetOperatorGraph());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOperatorGraph()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetOperatorList()).compareTo(other.isSetOperatorList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOperatorList()) {
