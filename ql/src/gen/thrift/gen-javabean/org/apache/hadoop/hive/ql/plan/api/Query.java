...
public class Query implements org.apache.thrift.TBase<Query, Query._Fields>, java.io.Serializable, Cloneable, Comparable<Query> {
  ...
  public Query(
    ...
    java.util.Map<java.lang.String,java.lang.Long> queryCounters,
    Graph stageGraph,
    java.util.List<Stage> stageList,
    boolean done,
    boolean started)
  {
    this();
  ...
  public int compareTo(Query other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetQueryAttributes()).compareTo(other.isSetQueryAttributes());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetQueryAttributes()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetQueryCounters()).compareTo(other.isSetQueryCounters());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetQueryCounters()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetStageGraph()).compareTo(other.isSetStageGraph());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStageGraph()) {
