...
public class ImpalaThriftDoubleInspector extends AbstractPrimitiveObjectInspector
        implements DoubleObjectInspector {

    ImpalaThriftDoubleInspector() {
    ...
    public double get(Object o) {
        ...
        return (double) ImpalaResultInspector.toColumnValue(value);
    }
