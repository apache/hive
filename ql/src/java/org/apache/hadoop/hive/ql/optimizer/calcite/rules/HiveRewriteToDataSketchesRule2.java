 ...
 * </ol>
 */
public final class HiveRewriteToDataSketchesRule2 extends RelOptRule {

  protected static final Logger LOG = LoggerFactory.getLogger(HiveRewriteToDataSketchesRule2.class);
  private final Optional<String> countDistinctSketchType;
  private final Optional<String> percentileContSketchType;
  private final ProjectFactory projectFactory;

  public HiveRewriteToDataSketchesRule2(Optional<String> countDistinctSketchType,
