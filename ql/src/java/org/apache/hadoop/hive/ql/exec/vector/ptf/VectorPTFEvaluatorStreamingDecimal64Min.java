 ...
 */
public class VectorPTFEvaluatorStreamingDecimal64Min extends VectorPTFEvaluatorBase {

  protected boolean isNull;
  protected long min;

  public VectorPTFEvaluatorStreamingDecimal64Min(WindowFrameDef windowFrameDef, VectorExpression inputVecExpr,
      int outputColumnNum) {
