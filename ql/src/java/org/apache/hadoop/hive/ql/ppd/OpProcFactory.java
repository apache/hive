...
public final class OpProcFactory {
  ...
  public static class SimpleFilterPPD extends FilterPPD implements SemanticNodeProcessor {
    ...
    public Object process(Node nd, Stack<Node> stack, NodeProcessorCtx procCtx,
      ...
      // - the Filter is on top of a LateralViewJoinOperator (same as PTF)
      ...
      // functions gets enabled. Pushing the filter on top of a LateralViewJoinOperator can be done
      // after the table has been created off of the array to avoid the join back to the top level
      // fields.
