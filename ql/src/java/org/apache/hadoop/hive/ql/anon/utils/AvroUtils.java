...
public final class AvroUtils {
  ...
  public static final Map<Class<? extends SpecificRecordBase>, Integer> map = new HashMap<>();
  ...
  public static Msg4 createMsg4(final int userId) {
    return Msg4
      ...
      .setAddressBookList(Arrays.asList(
        Address.newBuilder().setCountry("US").setStreet("1 Main").build(),
        Address.newBuilder().setCountry("DE").setStreet("2 Haupt").build()))
      .build();
  }
