...
@Description(name = "bitmap_and_not", value = "_FUNC_(x1,x2) - Calculate the set after x1 minus x2, return the new bitmap.\n",
extended = "Example:\n >  select  _FUNC_(bitmap1, bitmap2) \n"
        + "binary"
)
public class UDFBitmapAndNot extends GenericUDF {
  public final static String FUNC_NAME = "bitmap_and_not";
  private static final Logger LOG = LoggerFactory.getLogger(UDFBitmapAndNot.class.getName());
