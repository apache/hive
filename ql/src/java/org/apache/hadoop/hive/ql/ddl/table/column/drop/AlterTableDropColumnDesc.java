...
public class AlterTableDropColumnDesc extends AbstractAlterTableDesc {
    ...
    public AlterTableDropColumnDesc(TableName tableName, Map<String, String> partitionSpec, boolean isCascade, String colName, boolean ifExists) throws SemanticException {
        super(AlterTableType.DROPCOL, tableName, partitionSpec, null, isCascade, false, null);
