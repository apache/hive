 ...
 */
public class VectorPTFEvaluatorDecimal64Max extends VectorPTFEvaluatorBase {

  protected boolean isGroupResultNull;
  protected long max;

  public VectorPTFEvaluatorDecimal64Max(WindowFrameDef windowFrameDef, VectorExpression inputVecExpr,
      int outputColumnNum) {
