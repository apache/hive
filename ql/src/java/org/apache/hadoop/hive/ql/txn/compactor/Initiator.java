...
public class Initiator extends MetaStoreCompactorThread {
        ...
        try {
          ...
          for (CompactionInfo ci : potentials) {
            try {
              ...
              Table t = cacheContainer.computeIfAbsent(ci.getFullTableName(),() -> resolveTable(ci));
  ...
  private String getPoolName(CompactionInfo ci, Table t) throws Exception {
    ...
    if (StringUtils.isBlank(poolName)) {
      params = cacheContainer.computeIfAbsent(ci.dbname, () -> resolveDatabase(ci)).getParameters();
  ...
  private boolean isEligibleForCompaction(CompactionInfo ci,
    ...
    try {
      ...
      Map<String, String> dbParams = cacheContainer.computeIfAbsent(ci.dbname, () -> resolveDatabase(ci)).getParameters();
