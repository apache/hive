...
@VectorizedExpressions({LongColMultiplyLongColumn.class, LongColMultiplyDoubleColumn.class,
  ...
  DecimalColMultiplyDecimalColumn.class, DecimalColMultiplyDecimalScalar.class,
    DecimalScalarMultiplyDecimalColumn.class, Decimal64ColMultiplyDecimal64Scalar.class,
  Decimal64ColMultiplyDecimal64Column.class, Decimal64ScalarMultiplyDecimal64Column.class})
