...
public final class DDLSemanticAnalyzerFactory {
  ...
  private static final Map<Integer, Class<? extends DDLSematnicAnalyzerCategory>> TYPE_TO_ANALYZERCATEGORY =
      new HashMap<>();
  ...
  static {
    ...
    Set<Class<? extends DDLSematnicAnalyzerCategory>> analyzerCategoryClasses =
        new Reflections(DDL_ROOT).getSubTypesOf(DDLSematnicAnalyzerCategory.class);
    for (Class<? extends DDLSematnicAnalyzerCategory> analyzerCategoryClass : analyzerCategoryClasses) {
  ...
  private static Class<? extends BaseSemanticAnalyzer> getAnalyzerClass(ASTNode root, QueryState queryState) {
    ...
    if (TYPE_TO_ANALYZERCATEGORY.containsKey(root.getType())) {
      Class<? extends DDLSematnicAnalyzerCategory> analyzerCategoryClass = TYPE_TO_ANALYZERCATEGORY.get(root.getType());
      try {
        DDLSematnicAnalyzerCategory analyzerCategory = analyzerCategoryClass.newInstance();
