...
@Description(name = "bitmap_or", value = "_FUNC_(x) - Compute union of two or more input bitmaps, returns the new bitmap."
        ,extended = "Example:\n >  select  _FUNC_(bitmap1, bitmap2, bitmap3, ...) \n"
        + "binary")
public class UDFBitmapOr extends GenericUDF {
  public final static String FUNC_NAME = "bitmap_or";
  private static final Logger LOG = LoggerFactory.getLogger(UDFBitmapOr.class.getName());
