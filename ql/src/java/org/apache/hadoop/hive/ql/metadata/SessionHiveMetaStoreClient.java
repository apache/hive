...
import org.apache.hadoop.hive.metastore.client.HiveMetaStoreClientWithHook;
import org.apache.hadoop.hive.metastore.client.NoopHiveMetaStoreClientDelegator;
import org.apache.hadoop.hive.metastore.client.ThriftHiveMetaStoreClient;
import org.apache.hadoop.hive.ql.metadata.client.HiveMetaStoreClientWithSessionFeature;
 ...
 */
public class SessionHiveMetaStoreClient extends NoopHiveMetaStoreClientDelegator implements IMetaStoreClient {
  ...
  SessionHiveMetaStoreClient(
    ...
    super(createUnderlyingClient(conf, hookLoader, allowEmbedded));
  }
  ...
  private static IMetaStoreClient createUnderlyingClient(Configuration conf, HiveMetaHookLoader hookLoader,
    ...
    IMetaStoreClient clientWithHook = new HiveMetaStoreClientWithHook(conf, hookLoader, clientWithTmpTable);
    return clientWithHook;
  }

  public static Map<String, Table> getTempTablesForDatabase(String dbName, String tblName) {
    return HiveMetaStoreClientWithTmpTable.getTempTablesForDatabase(dbName, tblName);
  }
}
