 ...
 */
public class VectorPTFEvaluatorStreamingDecimal64Avg extends VectorPTFEvaluatorBase {
  ...
  public VectorPTFEvaluatorStreamingDecimal64Avg(WindowFrameDef windowFrameDef, VectorExpression inputVecExpr,
      int outputColumnNum) {
