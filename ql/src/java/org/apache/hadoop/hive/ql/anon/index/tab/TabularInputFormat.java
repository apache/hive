...
public class TabularInputFormat implements InputFormat<NullWritable, KeyValueStruct> {

  private static final Logger LOG = LoggerFactory.getLogger(TabularInputFormat.class);
