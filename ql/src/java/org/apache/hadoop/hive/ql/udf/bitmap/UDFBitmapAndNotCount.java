...
@Description(name = "bitmap_and_not_count", value = "_FUNC_(x) - Calculate the set after x1 minus intersection of two input bitmaps and return the size of then result size."
    ,extended = "Example:\n > select _FUNC_(bitmap_from_string('1,2,3'),bitmap_from_string('2,3,4'));\n 1")
public class UDFBitmapAndNotCount extends GenericUDF {
  public final static String FUNC_NAME = "bitmap_and_not_count";
  private static final Logger LOG = LoggerFactory.getLogger(UDFBitmapAndNotCount.class.getName());
