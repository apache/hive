...
public abstract class BaseDoubleColDoubleColumn extends VectorExpression {
  private static final long serialVersionUID = 1L;

  public BaseDoubleColDoubleColumn(int colNum1, int colNum2, int outputColumnNum) {
    super(colNum1, colNum2, outputColumnNum);
  }

  public BaseDoubleColDoubleColumn() {
    super();
  }
  ...
  public static class Add extends BaseDoubleColDoubleColumn {
    ...
    @Override
    protected double func(double a, double b) {
      return a + b;
    }
  }

  public static class Multiply extends BaseDoubleColDoubleColumn {
  ...
  public static class Subtract extends BaseDoubleColDoubleColumn {
