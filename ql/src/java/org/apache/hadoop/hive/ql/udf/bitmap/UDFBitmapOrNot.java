...
@Description(name = "bitmap_or_not", value = "_FUNC_(x1,x2) - Calculate the set after x1 union new bitmap of  bitmap_range(0,bitmap_max(x2)) minus x2, return the new bitmap.\n",

    extended = "Example:\n >  select  bitmap_to_string(_FUNC_(bitmap_from_string('1,2,3'),bitmap_from_string('3,4,5')))\n" + "'1,2'")
public class UDFBitmapOrNot extends GenericUDF {
  public final static String FUNC_NAME = "bitmap_or_not";
  private static final Logger LOG = LoggerFactory.getLogger(UDFBitmapOrNot.class.getName());
