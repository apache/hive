...
public class ImpalaThriftBooleanInspector extends AbstractPrimitiveObjectInspector
        implements BooleanObjectInspector {

    ImpalaThriftBooleanInspector() {
    ...
    public boolean get(Object o) {
        ...
        return (Boolean) ImpalaResultInspector.toColumnValue(value);
    }
