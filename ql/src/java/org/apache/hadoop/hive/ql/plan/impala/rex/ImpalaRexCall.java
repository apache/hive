...
public class ImpalaRexCall {
  ...
  public static Expr getExpr(Analyzer analyzer, RexCall rexCall,
    ...
    ScalarFunctionDetails details = ScalarFunctionDetails.get(funcName, retType, args);
  ...
  public static RexNode removeRedundantCast(RexCall rexCall) {
    ...
    if (rexCall.getKind() == SqlKind.CAST && r1.getSqlTypeName().equals(r2.getSqlTypeName())) {
