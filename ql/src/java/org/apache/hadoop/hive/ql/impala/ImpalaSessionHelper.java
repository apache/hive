...
import org.apache.hadoop.hive.ql.impala.exec.ImpalaSessionManager;
...
public class ImpalaSessionHelper implements EngineSessionHelper {

  public void closeSession(EngineSession session) throws HiveException {
    ImpalaSessionManager.getInstance().closeSession(session);
  }
