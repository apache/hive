 ...
 */
public class VectorPTFEvaluatorStreamingDecimal64Max extends VectorPTFEvaluatorBase {

  protected boolean isNull;
  protected long max;

  public VectorPTFEvaluatorStreamingDecimal64Max(WindowFrameDef windowFrameDef, VectorExpression inputVecExpr,
      int outputColumnNum) {
