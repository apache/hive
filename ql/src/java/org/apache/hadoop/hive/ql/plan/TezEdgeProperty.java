...
public class TezEdgeProperty {
  ...
  public TezEdgeProperty(HiveConf hiveConf, EdgeType edgeType, boolean isAutoReduce,
    ...
    setAutoReduce(hiveConf, isAutoReduce, isSlowStart, minReducer, maxReducer, bytesPerReducer);
    this.isSlowStart = isSlowStart;
  }

  public void setAutoReduce(HiveConf hiveConf, boolean isAutoReduce, boolean isSlowStart, int minReducer, int maxReducer,
