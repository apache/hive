 ...
 */
public class HiveRowIsDeletedPropagator2 implements ReflectiveVisitor {

  protected final RelBuilder relBuilder;
  protected final Deque<RelNode> stack = new ArrayDeque<>();
  private final ReflectUtil.MethodDispatcher<RelNode> dispatcher;

  public HiveRowIsDeletedPropagator2(RelBuilder relBuilder) {
  ...
  private static class InputRefShifter extends RexShuttle {
    ...
    private InputRefShifter(int startIndex, int shift, RelBuilder relBuilder) {
