...
public abstract class BaseDoubleColLongColumn extends VectorExpression {
  private static final long serialVersionUID = 1L;

  public BaseDoubleColLongColumn(int colNum1, int colNum2, int outputColumnNum) {
    super(colNum1, colNum2, outputColumnNum);
  }

  public BaseDoubleColLongColumn() {
    super();
  }
  ...
  public void evaluate(VectorizedRowBatch batch) throws HiveException {
    ...
    DoubleColumnVector inputColVector1 = (DoubleColumnVector) batch.cols[inputColumnNum[0]];
  ...
  protected abstract double func(double a, long b);
  ...
  public static class Add extends BaseDoubleColLongColumn {
    ...
    @Override
    protected double func(double a, long b) {
      return a + b;
    }
  }

  public static class Multiply extends BaseDoubleColLongColumn {
  ...
  public static class Subtract extends BaseDoubleColLongColumn {
