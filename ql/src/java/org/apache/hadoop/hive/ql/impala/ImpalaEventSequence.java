...
public class ImpalaEventSequence implements EngineEventSequence {
  private final EventSequence eventSequence;

  public ImpalaEventSequence(String event) {
    eventSequence = new EventSequence(event);
  }

  public void markEvent(String event) {
    eventSequence.markEvent(event);
  }
