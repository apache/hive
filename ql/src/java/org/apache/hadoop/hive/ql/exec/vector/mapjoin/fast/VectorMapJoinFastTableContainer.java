...
public class VectorMapJoinFastTableContainer implements VectorMapJoinTableContainer, VectorMapJoinHashTable {
  ...
  public VectorMapJoinFastTableContainer(MapJoinDesc desc, Configuration hconf,
      long estimatedKeys, int numThreads) throws SerDeException {
    ...
    this.estimatedKeyCount = estimatedKeys > numThreads ? (estimatedKeys/numThreads) : estimatedKeys;
    ...
    case LONG:
      ...
      case HASH_MAP:
        htWrapper = new VectorMapJoinFastLongHashMapContainer(isFullOuter, minMaxEnabled,
            hashTableKeyType, newThreshold, loadFactor, writeBufferSize, estimatedKeyCount, desc.getKeyTblDesc(), numThreads);
        break;
      case HASH_MULTISET:
    ...
    case STRING:
      ...
      case HASH_MAP:
        htWrapper = new VectorMapJoinFastStringHashMapContainer(isFullOuter, newThreshold,
            loadFactor, writeBufferSize, estimatedKeyCount, desc.getKeyTblDesc(), numThreads);
        break;
      case HASH_MULTISET:
