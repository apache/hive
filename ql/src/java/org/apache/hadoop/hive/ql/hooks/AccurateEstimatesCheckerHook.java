 ...
 */
public class AccurateEstimatesCheckerHook implements ExecuteWithHookContext {
  ...
  private void ensureEstimateAcceptable(long numRows, long runTimeNumRows) throws HiveException {
    ...
    throw  new HiveException("Estimation error is unacceptable "+numRows+" / " +runTimeNumRows+" with absErr:"+currentDelta+", relErr:"+ relErr);
  }
