...
@DDLSemanticAnalyzerFactory.DDLType(types = HiveParser.TOK_ALTERTABLE_DROP_BRANCH)
public class AlterTableDropBranchAnalyzer extends AlterTableDropSnapshotRefAnalyzer {

  public AlterTableDropBranchAnalyzer(QueryState queryState) throws SemanticException {
    super(queryState);
    alterTableType = AlterTableType.DROP_BRANCH;
  }
}
