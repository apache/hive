...
public final class CommonTableExpressionSuggesterFactory {
  ...
  public static CommonTableExpressionSuggester create(HiveConf conf) {
    try {
      Class<?> suggesterClass = Class.forName(conf.getVar(HiveConf.ConfVars.HIVE_CTE_SUGGESTER_CLASS));
