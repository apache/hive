...
public class Constraints implements Serializable {
  ...
  public Constraints(List<SQLPrimaryKey> primaryKeys, List<SQLForeignKey> foreignKeys,
      List<SQLNotNullConstraint> notNullConstraints, List<SQLUniqueConstraint> uniqueConstraints,
