...
public class Schema {
  ...
  public enum Field implements SchemaField {
    ...
    QUERY_TYPE("query_type", "string",
        "The query type according to the semantic analyzer: QUERY, DDL, DML, STATS, empty otherwise"),
    DDL_TYPE("ddl_type", "string",
        "If the query is a DDL query, contains the DDL type (derived from ASTNode), empty otherwise"),
