...
public class ReplCopyTask extends Task<ReplCopyWork> implements Serializable {
  ...
  private int copyPaths(Path fromPath, Path toPath) throws MetaException, IOException, HiveException, LoginException {
  ...
  public static Task<?> getLoadCopyTask(ReplicationSpec replicationSpec, Path srcPath, Path dstPath,
    ...
    return getLoadCopyTask(replicationSpec, srcPath, dstPath, conf, isAutoPurge, needRecycle, copyToMigratedTxnTable,
  ...
  public static Task<?> getLoadCopyTask(ReplicationSpec replicationSpec, Path srcPath, Path dstPath,
    ...
    return getLoadCopyTask(replicationSpec, srcPath, dstPath, conf, false, false,
            false, readSourceAsFileList, false);
  }

  public static Task<?> getLoadCopyTask(ReplicationSpec replicationSpec, Path srcPath, Path dstPath,
                                        HiveConf conf, boolean readSourceAsFileList, boolean shouldCheckpoint) {
