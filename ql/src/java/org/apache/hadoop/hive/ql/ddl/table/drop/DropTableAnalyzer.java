...
public class DropTableAnalyzer extends BaseSemanticAnalyzer {
  ...
  public void analyzeInternal(ASTNode root) throws SemanticException {
    ...
    if (table != null) {
      ...
      boolean locklessReads = HiveConf.getBoolVar(conf, ConfVars.HIVE_TXN_LOCKLESS_READS_ENABLED)
          && AcidUtils.isTransactionalTable(table);
      outputs.add(new WriteEntity(table, locklessReads ? WriteType.DDL_EXCL_WRITE : WriteType.DDL_EXCLUSIVE));
    }
