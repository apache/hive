 ...
 */
public class VectorMapJoinFastStringHashMultiSetParallel extends VectorMapJoinFastHashTableWrapper implements
    VectorMapJoinBytesHashMultiSet {

  private VectorMapJoinFastStringHashMultiSet[] vectorMapJoinFastStringHashMultiSets;
  ...
  public void putRow(BytesWritable currentKey, BytesWritable currentValue, long hashCode, long key)
      throws HiveException, IOException {
    vectorMapJoinFastStringHashMultiSets[(int) (((1 << 2) - 1) & (hashCode >> 62 - 1))].putRow(currentKey, currentValue,
        hashCode, key);
  }
  ...
  public VectorMapJoinFastStringHashMultiSetParallel(
      boolean isFullOuter,
  ...
  @Override public JoinUtil.JoinResult contains(byte[] keyBytes, int keyStart, int keyLength,
    ...
    return vectorMapJoinFastStringHashMultiSets[(int) (((1 << 2) - 1) & (hashCode >> 62 - 1))].contains(keyBytes, keyStart, keyLength,
        hashMultiSetResult);
  }
