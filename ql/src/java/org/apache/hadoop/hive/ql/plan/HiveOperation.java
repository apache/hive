...
public enum HiveOperation {
  ...
  CREATE_SCHEDULED_QUERY("CREATE SCHEDULED QUERY", null, null, false, false),
  ALTER_SCHEDULED_QUERY("ALTER SCHEDULED QUERY", null, null, false, false),
  DROP_SCHEDULED_QUERY("DROP SCHEDULED QUERY", null, null, false, false)
  ;
