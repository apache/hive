...
public enum HiveOperation {
  ...
  ALTERTABLE_UPDATETABLESTATS("ALTERTABLE_UPDATETABLESTATS",
      ...
      new Privilege[]{Privilege.ALTER_METADATA}, null),
  ALTERTABLE_DELETEPARTSTATS("ALTERTABLE_DELETEPARTSTATS",
          new int[] {HiveParser.TOK_ALTERPARTITION_DROPSTATS, HiveParser.TOK_ALTERPARTITION_DROPCOLSTATS},
          new Privilege[]{Privilege.ALTER_METADATA}, null),
  ALTERTABLE_DELETETABLESTATS("ALTERTABLE_DELETETABLESTATS",
          new int[] {HiveParser.TOK_ALTERTABLE_DROPSTATS, HiveParser.TOK_ALTERTABLE_DROPCOLSTATS},
          new Privilege[]{Privilege.ALTER_METADATA}, null),
