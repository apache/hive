...
public enum HiveOperation {
  ...
  DESC_ERASURE_POLICY("DESC_ERAURE_POLICY", HiveParser.TOK_DESC_ERASURE_POLICY, null, null),
  ...
  ALTERTABLE_PROPERTIES("ALTERTABLE_PROPERTIES",
      ...
      new Privilege[]{Privilege.ALTER_METADATA}, null),
  ALTERTABLE_SET_WRITE_ORDER("ALTERTABLE_SET_WRITE_ORDER", HiveParser.TOK_ALTERTABLE_SET_WRITE_ORDER,
      new Privilege[]{Privilege.ALTER_METADATA}, null),
  ...
  ALTERPARTITION_BUCKETNUM("ALTERPARTITION_BUCKETNUM", HiveParser.TOK_ALTERPARTITION_BUCKETS,
      new Privilege[]{Privilege.ALTER_METADATA}, null),
  SHOWCATALOGS("SHOWCATALOGS", HiveParser.TOK_SHOWCATALOGS, new Privilege[]{Privilege.SHOW_CATALOG}, null, true,
      false),
  ALTERINDEX_REBUILD("ALTERINDEX_REBUILD", HiveParser.TOK_AIR, null, null),
  ...
  SHOWDATACONNECTORS("SHOWDATACONNECTORS", HiveParser.TOK_SHOWDATACONNECTORS, new Privilege[]{Privilege.SHOW_DATABASE}, null, true,
      false),
  SHOW_ERASURE_POLICIES("SHOW_ERASURE_POLICIES", HiveParser.TOK_SHOW_ERASURE_POLICIES, new Privilege[]{Privilege.SHOW_DATABASE}, null, true,
      false),
  SHOW_ERASURE_GRANTS("SHOW_ERASURE_GRANTS", HiveParser.TOK_SHOW_ERASURE_GRANTS, new Privilege[]{Privilege.SHOW_DATABASE}, null, true,
      false),
  SHOW_ERASURE_POLICY_HISTORY("SHOW_ERASURE_POLICY_HISTORY", HiveParser.TOK_SHOW_ERASURE_POLICY_HISTORY,
      new Privilege[]{Privilege.SHOW_DATABASE}, null, true, false),
  ...
  ALTER_MATERIALIZED_VIEW_REBUILD("ALTER_MATERIALIZED_VIEW_REBUILD", HiveParser.TOK_ALTER_MATERIALIZED_VIEW_REBUILD,
          new Privilege[]{Privilege.SELECT}, new Privilege[]{Privilege.CREATE, Privilege.DROP},true, false),
  ...
  ANON_TABLE("ERASE FROM TABLE", HiveParser.TOK_AT, null, null),
  ALTER_TABLE_ATTACH_POLICY("ALTER TABLE ATTACH POLICY", HiveParser.TOK_ATTACH_POLICY, null, null),
  ALTER_TABLE_DETACH_POLICY("ALTER TABLE DETACH POLICY", HiveParser.TOK_DETACH_POLICY, null, null),
  VALIDATE_ERASURE_POLICY("VALIDATE ERASURE POLICY", HiveParser.TOK_VEP, null, null),
  ACTIVATE_ERASURE_POLICY("ACTIVATE ERASURE POLICY", HiveParser.TOK_AEP, null, null),
  DEACTIVATE_ERASURE_POLICY("DEACTIVATE ERASURE POLICY", HiveParser.TOK_DEP, null, null),
  EXPLAIN_ATTACH_POLICY("EXPLAIN ATTACH POLICY", HiveParser.TOK_EXPLAIN_ATTACH, null, null),
  VALIDATE_ERASURE_BINDING("VALIDATE ERASURE BINDING", HiveParser.TOK_VALIDATE_BINDING, null, null),
  AUDIT_ERASURE_POLICY("AUDIT ERASURE POLICY", HiveParser.TOK_AUDIT_POLICY, null, null),
  AUDIT_ERASURE_BINDING("AUDIT ERASURE BINDING", HiveParser.TOK_AUDIT_BINDING, null, null),
  AUDIT_ERASURE_EXECUTIONS("AUDIT ERASURE EXECUTIONS", HiveParser.TOK_AUDIT_EXEC, null, null),
  AUDIT_ERASURE_CONFLICTS("AUDIT ERASURE CONFLICTS", HiveParser.TOK_AUDIT_CONFLICTS, null, null),
  AUDIT_ERASURE_COMPLIANCE("AUDIT ERASURE COMPLIANCE", HiveParser.TOK_AUDIT_COMPLIANCE, null, null),
  EXTRACT_FROM_TABLE("EXTRACT FROM TABLE", HiveParser.TOK_EXTRACT_FROM_TABLE, null, null),
  AUDIT_BY_IDENTITY("AUDIT BY IDENTITY VALUES", HiveParser.TOK_AUDIT_BY_IDENTITY, null, null)
  ;
