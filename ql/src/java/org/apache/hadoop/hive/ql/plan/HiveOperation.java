...
public enum HiveOperation {
  ...
  ALTERTABLE_DROPCOL("ALTERTABLE_DROPCOL", HiveParser.TOK_ALTERTABLE_DROPCOL, new Privilege[]{Privilege.ALTER_METADATA},
          null),
  ALTERTABLE_SETDEFAULTPARTITIONAME("ALTERTABLE_SETDEFAULTPARTITION", HiveParser.TOK_ALTERTABLE_SETDEFAULTPARTITIONNAME, new Privilege[]{Privilege.ALTER_METADATA},
          null),
