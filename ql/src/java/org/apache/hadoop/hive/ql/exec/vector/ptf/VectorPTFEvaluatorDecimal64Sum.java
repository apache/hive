 ...
 */
public class VectorPTFEvaluatorDecimal64Sum extends VectorPTFEvaluatorAbstractSum<Long> {

  public VectorPTFEvaluatorDecimal64Sum(WindowFrameDef windowFrameDef, VectorExpression inputVecExpr,
      int outputColumnNum) {
