 ...
 */
public class HiveMetaStoreClientWithLocalCache extends NoopHiveMetaStoreClientDelegator implements IMetaStoreClient {
  public static void init(Configuration conf) {
    org.apache.hadoop.hive.ql.metadata.client.HiveMetaStoreClientWithLocalCache.init(conf);
  }
  ...
  private static IMetaStoreClient createUnderlyingClient(Configuration conf, HiveMetaHookLoader hookLoader,
    ...
    IMetaStoreClient clientWithHook = new HiveMetaStoreClientWithHook(conf, hookLoader, clientWithLocalCache);
