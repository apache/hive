...
public class LateralViewPlan {
  ...
  public LateralViewPlan(ASTNode lateralView, RelOptCluster cluster, RelNode inputRel,
    ...
    TypeCheckCtx tcCtx = new TypeCheckCtx(inputRR, cluster.getRexBuilder(), false, false);
    tcCtx.setUnparseTranslator(unparseTranslator);
    RexCall valuesExpr = (RexCall) CalcitePlanner.genRexNode(valuesClause, inputRR, tcCtx, conf);
