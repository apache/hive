...
public class ImpalaThriftDateInspector extends AbstractPrimitiveObjectInspector
        implements DateObjectInspector {

    ImpalaThriftDateInspector() {
    ...
    public Date getPrimitiveJavaObject(Object o) {
        ...
        return ImpalaResultInspector.getDateValue(value.getStringVal());
    }
