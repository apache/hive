 ...
 */
public class VectorPTFEvaluatorDecimal64Min extends VectorPTFEvaluatorBase {

  protected boolean isGroupResultNull;
  protected long min;

  public VectorPTFEvaluatorDecimal64Min(WindowFrameDef windowFrameDef, VectorExpression inputVecExpr,
      int outputColumnNum) {
