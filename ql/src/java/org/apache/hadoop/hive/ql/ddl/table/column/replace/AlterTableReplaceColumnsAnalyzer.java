...
public class AlterTableReplaceColumnsAnalyzer extends AbstractAlterTableAnalyzer {
  ...
  protected void analyzeCommand(TableName tableName, Map<String, String> partitionSpec, ASTNode command)
    ...
    List<FieldSchema> newCols =
        getColumns((ASTNode) command.getChild(0), true, ctx.getTokenRewriteStream(), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), defaultConstraintsInfo, new ArrayList<>(), conf);
