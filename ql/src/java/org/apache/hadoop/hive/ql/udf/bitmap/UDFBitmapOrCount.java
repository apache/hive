...
@Description(name = "bitmap_or_count", value = "_FUNC_(x) - Compute union of two or more input bitmaps and return the size of the result set.",extended = "Example:\n > select _FUNC_(bitmap_from_string('1,2,3'),bitmap_from_string('2,3,4'));\n 4")
public class UDFBitmapOrCount extends GenericUDF {
  public final static String FUNC_NAME = "bitmap_or_count";
  private static final Logger LOG = LoggerFactory.getLogger(UDFBitmapOrCount.class.getName());
