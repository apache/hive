...
public class HiveLoptMultiJoin {
  //~ Instance fields --------------------------------------------------------
   ...
   * the self join.
   */
  Map<Integer, HiveLoptMultiJoin.RemovableSelfJoin> removableSelfJoinPairs;

  //~ Constructors -----------------------------------------------------------

  public HiveLoptMultiJoin(MultiJoin multiJoin) {
  ...
  ImmutableBitSet getJoinFilterFactorBitmap(
          @UnderInitialization HiveLoptMultiJoin this,
          RexNode joinFilter,
          boolean setFields) {
  ...
  private ImmutableBitSet factorBitmap(
          @UnknownInitialization HiveLoptMultiJoin this,
  ...
  public void getChildFactors(HiveLoptJoinTree joinTree,
  ...
  public void addRemovableSelfJoinPair(int factor1, int factor2) {
    ...
    HiveLoptMultiJoin.RemovableSelfJoin selfJoin =
            new HiveLoptMultiJoin.RemovableSelfJoin(leftFactor, rightFactor, columnMapping);
  ...
  public @Nullable Integer getOtherSelfJoinFactor(int factIdx) {
    HiveLoptMultiJoin.RemovableSelfJoin selfJoin = removableSelfJoinPairs.get(factIdx);
    if (selfJoin == null) {
      return null;
  ...
  public @Nullable Integer getRightColumnMapping(int rightFactor, int rightOffset) {
    HiveLoptMultiJoin.RemovableSelfJoin selfJoin = requireNonNull(removableSelfJoinPairs.get(rightFactor),
  ...
  public HiveLoptMultiJoin.Edge createEdge(RexNode condition) {
    ImmutableBitSet fieldRefBitmap = fieldBitmap(condition);
    ImmutableBitSet factorRefBitmap = factorBitmap(fieldRefBitmap);
    return new HiveLoptMultiJoin.Edge(condition, factorRefBitmap, fieldRefBitmap);
  }
