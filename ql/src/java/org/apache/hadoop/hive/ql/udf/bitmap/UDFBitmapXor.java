...
@Description(name = "bitmap_xor", value = "_FUNC_(x...) - XOR two or more bitmap sets and return the new bitmap.\n", extended = "Example:\n >  select  _FUNC_(bitmap1, bitmap2, bitmap3, ...) \n" + "binary")
public class UDFBitmapXor extends GenericUDF {
    public final static String FUNC_NAME = "bitmap_xor";
    private static final Logger LOG = LoggerFactory.getLogger(UDFBitmapXor.class.getName());
