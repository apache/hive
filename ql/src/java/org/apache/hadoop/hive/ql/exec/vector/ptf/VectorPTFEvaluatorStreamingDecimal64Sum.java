 ...
 */
public class VectorPTFEvaluatorStreamingDecimal64Sum extends VectorPTFEvaluatorBase {

  protected boolean isNull;
  protected long sum;

  public VectorPTFEvaluatorStreamingDecimal64Sum(WindowFrameDef windowFrameDef, VectorExpression inputVecExpr,
      int outputColumnNum) {
  ...
  public void evaluateGroupBatch(VectorizedRowBatch batch)
    ...
    Decimal64ColumnVector longColVector = ((Decimal64ColumnVector) batch.cols[inputColumnNum]);
