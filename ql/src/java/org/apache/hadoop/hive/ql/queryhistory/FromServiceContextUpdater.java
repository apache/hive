...
public class FromServiceContextUpdater {

  private static final FromServiceContextUpdater INSTANCE = new FromServiceContextUpdater();

  public static FromServiceContextUpdater getInstance() {
    return INSTANCE;
  }

  public void consume(ServiceContext serviceContext, QueryHistoryRecord record) {
