...
public class SessionState implements ISessionAuthState{
  ...
  private static final ConcurrentHashMap<String, Pair<String, Integer>> udfLocalResource = new ConcurrentHashMap<>();//<md5sum or etag, local path>
  /**
  ...
  public SessionState(HiveConf conf, String userName) {
    ...
    Map<String, Pair<String, Integer>> udfCacheMap = getUDFCacheMap();
  ...
  public static Map<String, Pair<String, Integer>> getUDFCacheMap(){
