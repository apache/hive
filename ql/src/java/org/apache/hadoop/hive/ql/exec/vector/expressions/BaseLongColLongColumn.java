...
public abstract class BaseLongColLongColumn extends VectorExpression {
  private static final long serialVersionUID = 1L;

  public BaseLongColLongColumn(int colNum1, int colNum2, int outputColumnNum) {
    super(colNum1, colNum2, outputColumnNum);
  }

  public BaseLongColLongColumn() {
    super();
  }
  ...
  protected abstract long func(long a, long b);
  ...
  public static class Add extends BaseLongColLongColumn {
    ...
    @Override
    protected long func(long a, long b) {
      return a + b;
    }
  }

  public static class Multiply extends BaseLongColLongColumn {
  ...
  public static class Subtract extends BaseLongColLongColumn {
