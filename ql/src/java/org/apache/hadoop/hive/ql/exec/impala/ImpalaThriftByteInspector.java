...
public class ImpalaThriftByteInspector extends AbstractPrimitiveObjectInspector implements ByteObjectInspector {

    ImpalaThriftByteInspector() {
    ...
    public byte get(Object o) {
        ...
        return (byte) ImpalaResultInspector.toColumnValue(v);
    }
}