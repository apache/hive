...
import org.apache.hadoop.hive.ql.exec.repl.NotWork;
import org.apache.hadoop.hive.ql.exec.repl.NotTask;
...
public final class TaskFactory {
  ...
  static {
    ...
    taskvec.add(new TaskTuple<NotWork>(NotWork.class, NotTask.class));
