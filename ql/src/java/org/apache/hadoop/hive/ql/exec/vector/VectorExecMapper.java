 ...
 *
 */
public class VectorExecMapper extends MapReduceBase implements Mapper {

  private VectorMapOperator mo;
  private Map<String, FetchOperator> fetchOperators;
  private OutputCollector oc;
  private JobConf jc;
  private boolean abort = false;
  private Reporter rp;
  public static final Log l4j = LogFactory.getLog("VectorExecMapper");
