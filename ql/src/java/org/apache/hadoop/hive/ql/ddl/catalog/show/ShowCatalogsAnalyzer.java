 ...
 */
@DDLSemanticAnalyzerFactory.DDLType(types = HiveParser.TOK_SHOWCATALOGS)
public class ShowCatalogsAnalyzer extends BaseSemanticAnalyzer {
  ...
  public void analyzeInternal(ASTNode root) throws SemanticException {
    ...
    String catalogPattern = root.getChildCount() == 1 ? unescapeSQLString(root.getChild(0).getText()) : null;
    ShowCatalogsDesc desc = new ShowCatalogsDesc(ctx.getResFile(), catalogPattern);
