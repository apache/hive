...
public class TestRangerRestClient implements RangerRestClient {
    ...
    @Override
    public Path saveRangerPoliciesToFile(RangerExportPolicyList rangerExportPolicyList,
                                         Path currentDumpPath, String fileName) throws Exception {
        return null;
    }
