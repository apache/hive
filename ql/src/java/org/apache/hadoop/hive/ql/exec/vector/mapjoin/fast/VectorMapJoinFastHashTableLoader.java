...
import static org.apache.hadoop.hive.ql.exec.HashTableLoader.keyCountForSizing;
...
public class VectorMapJoinFastHashTableLoader implements org.apache.hadoop.hive.ql.exec.HashTableLoader {
  ...
  private void initHTLoadingService(long keyCount) {
    if (keyCount < VectorMapJoinFastHashTable.FIRST_SIZE_UP) {
  ...
  static void rethrowDrainFailures(List<Future<?>> loadFutures) throws HiveException {
    ...
    throw new HiveException(failure);
  }
  ...
  public void load(MapJoinTableContainer[] mapJoinTables,
    ...
    for (int pos = 0; pos < mapJoinTables.length; pos++) {
      ...
      try {
        ...
        long keyCount = keyCountForSizing(estKeyCount, inputRecords);
