...
public class QueryHistorySchema {
  ...
  public enum Field implements QueryHistorySchemaField {
    ...
    QUERY_TYPE("query_type", "string",
        "The query type according to the semantic analyzer: QUERY, DDL, DML, EXPLAIN, STATS, OTHER"),
    DDL_TYPE("ddl_type", "string",
        "If the query is a DDL query, will contain the type (from ASTNode), otherwise will be empty"),
