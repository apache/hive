...
import org.apache.hadoop.hive.ql.anon.btree.BtreeSplit;
...
public class DirectoryInputFormat implements InputFormat<NullWritable, KeyValueStruct> {

  private static final Logger LOG = LoggerFactory.getLogger(DirectoryInputFormat.class);
