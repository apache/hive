      ...
      case TOK_REPL_DUMP: {
        ...
        try {
          ...
          ReplUtils.reportStatusInReplicationMetrics("REPL_DUMP", ReplUtils.isErrorRecoverable(e)
                  ? Status.FAILED_ADMIN : Status.FAILED, null, conf, false);
          throw e;
        }
        break;
      }
    ...
    try {
      ...
      if (ReplUtils.failedWithNonRecoverableError(latestDumpPath, conf)) {
        ...
        ReplUtils.reportStatusInReplicationMetrics("REPL_LOAD", Status.SKIPPED,
                nonRecoverableFile.toString(), conf, false);
      ...
      if (loadPath != null) {
        ...
        ReplUtils.reportStatusInReplicationMetrics("REPL_LOAD", Status.SKIPPED, null, conf, false);
