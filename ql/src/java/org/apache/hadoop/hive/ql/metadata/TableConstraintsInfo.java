...
public class TableConstraintsInfo {
  ...
  public boolean isTableConstraintsInfoNotEmpty() {
    return PrimaryKeyInfo.isNotEmpty(this.getPrimaryKeyInfo()) || ForeignKeyInfo
        .isNotEmpty(this.getForeignKeyInfo()) || UniqueConstraint
        .isNotEmpty(this.getUniqueConstraint()) || NotNullConstraint
        .isNotEmpty(this.getNotNullConstraint()) || CheckConstraint
        .isNotEmpty(this.getCheckConstraint()) || DefaultConstraint
        .isNotEmpty(this.getDefaultConstraint());
  }
}
