...
public class TableConstraintsInfo {
  ...
  public static boolean isTableConstraintsInfoNotEmpty(TableConstraintsInfo info) {
    return info != null && ((PrimaryKeyInfo.isPrimaryKeyInfoNotEmpty(info.getPrimaryKeyInfo())) || ForeignKeyInfo
        .isForeignKeyInfoNotEmpty(info.getForeignKeyInfo()) || UniqueConstraint
        .isUniqueConstraintNotEmpty(info.getUniqueConstraint()) || NotNullConstraint
        .isNotNullConstraintNotEmpty(info.getNotNullConstraint()) || CheckConstraint
        .isCheckConstraintNotEmpty(info.getCheckConstraint()) || DefaultConstraint
        .isCheckConstraintNotEmpty(info.getDefaultConstraint()));
  }
}
