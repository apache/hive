...
public class ImpalaThriftFloatInspector extends AbstractPrimitiveObjectInspector
        implements FloatObjectInspector {

    ImpalaThriftFloatInspector() {
    ...
    public float get(Object o) {
        ...
        return (float) ImpalaResultInspector.toColumnValue(value);
    }
