...
public class ShowTablesOperation extends DDLOperation<ShowTablesDesc> {
  ...
  private void showTables() throws HiveException {
    ...
    List<String> tableNames = new ArrayList<>(
        context.getDb().getTablesByType(desc.getDbName(), pattern, desc.getTypeFilter(), desc.ifIceberg()));
  ...
  private void showTablesExtended() throws HiveException {
    ...
    for (TableType tableType : tableTypes) {
      List<String> tables = context.getDb().getTablesByType(desc.getDbName(), pattern, tableType, desc.ifIceberg());
