...
public class DummyHiveAuthorizer extends FallbackHiveAuthorizer {
  ...
  public DummyHiveAuthorizer(HiveConf hiveConf, HiveAuthenticationProvider hiveAuthenticator,
  ...
  public void checkPrivileges(HiveOperationType hiveOpType, List<HivePrivilegeObject> inputHObjs,
    ...
    for( HivePrivilegeObject hpo: inputHObjs){
    ...
    for( HivePrivilegeObject hpo: outputHObjs){
      if ( hpo.getType() == HivePrivilegeObject.HivePrivilegeObjectType.DATABASE && hpo.getOwnerName() != null){
        containsDBOwnerName = true;
      }
      if ( hpo.getType() == HivePrivilegeObject.HivePrivilegeObjectType.TABLE_OR_VIEW && hpo.getOwnerName() != null){
    ...
    if (!containsDBOwnerName || !containsTblOwnerName){
