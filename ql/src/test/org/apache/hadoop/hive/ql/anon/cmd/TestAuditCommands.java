...
public class TestAuditCommands extends BaseTest {

  private static final String TABLE = "tac_t1";
  private static final String COLUMN = "b";
  private static final String POLICY = "tac_pol";
  ...
  @Test
  @Order(2)
  public void auditPolicy() throws CommandProcessorException {
    execute("AUDIT ERASURE POLICY " + POLICY);
  }

  @Test
  @Order(3)
  public void auditBinding() throws CommandProcessorException {
    execute("AUDIT ERASURE BINDING ON TABLE %s COLUMN %s".formatted(TABLE, COLUMN));
  }

  @Test
  @Order(4)
  public void auditExecutions() throws CommandProcessorException {
    execute("AUDIT ERASURE EXECUTIONS ON TABLE " + TABLE);
  }

  @Test
  @Order(5)
  public void auditExecutionsWithTimeRange() throws CommandProcessorException {
    execute("AUDIT ERASURE EXECUTIONS ON TABLE %s FROM '2020-01-01' UNTIL '2099-12-31'".formatted(TABLE));
  }

  @Test
  @Order(6)
  public void auditConflicts() {
    try {
  ...
  @Test
  @Order(7)
  public void auditCompliance() throws CommandProcessorException {
    execute("AUDIT ERASURE COMPLIANCE");
  }
