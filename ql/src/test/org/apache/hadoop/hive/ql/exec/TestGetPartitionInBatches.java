...
public class TestGetPartitionInBatches {
    ...
    public void before() throws Exception {
        TestMsckCreatePartitionsInBatches.createPartitionedTable(db, catName, dbName, tableName);
    ...
    public void after() throws Exception {
        TestMsckCreatePartitionsInBatches.cleanUpTableQuietly(db, catName, dbName, tableName);
    }
    ...
    public void testBatchingWhenException() throws Exception {
        ...
        Mockito.doThrow(new MetaException()).doCallRealMethod()
                .when(spyMSC).getPartitionsByNames(any());
        hive.getAllPartitionsInBatches(hive.getTable(dbName, tableName), 30, 2, 3);
        ArgumentCaptor<GetPartitionsByNamesRequest> req = ArgumentCaptor.forClass(GetPartitionsByNamesRequest.class);
