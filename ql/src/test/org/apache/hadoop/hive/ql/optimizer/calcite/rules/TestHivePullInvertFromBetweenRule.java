...
public class TestHivePullInvertFromBetweenRule {
  ...
  public void before() {
    ...
    programBuilder.addRuleInstance(HiveDruidPullInvertFromBetweenRule.INSTANCE);
  ...
  public void testSimpleCase() {
    ...
    assertEquals("NOT(BETWEEN(false, $0, 1, 10))", condition.toString());
  }

  @Test
  public void testSimpleNonInvertCase() {
  ...
  public void testBetweenWithOrCase() {
    ...
    HiveFilter filter = (HiveFilter) optimizedRelNode;
    RexNode condition = filter.getCondition();
    assertEquals("OR(NOT(BETWEEN(false, $0, 1, 10)), NOT(BETWEEN(false, $1, 2, 20)))", condition.toString());
  }

  @Test
  public void testBetweenWithAndCase() {
    ...
    HiveFilter filter = (HiveFilter) optimizedRelNode;
    RexNode condition = filter.getCondition();
    assertEquals("AND(NOT(BETWEEN(false, $0, 1, 10)), NOT(BETWEEN(false, $1, 2, 20)))", condition.toString());
  }
