...
public class DummyDenyAccessHiveMetaStoreAuthorizer extends HiveMetaStoreAuthorizer {
  ...
  @Override
  void checkPrivileges(HiveMetaStoreAuthzInfo authzContext, HiveAuthorizer authorizer) throws MetaException {
    String err = "Authorization denied for Operation Type->" + authzContext.getOperationType();
