...
*/
    ...
    checkResult(expected0, testQuery0, "TFlat pre-check", LOG);
    ...
    checkResult(expected, testQuery, "TAcid post-check", LOG);
    ...
    checkResult(expected2, testQuery, "TAcidPart post-check", LOG);
    ...
    checkResult(expectedData, testQuery, "TFlat post-check data", LOG);
    ...
    checkResult(expectedMetaData, testQuery, "TFlat post-check files", LOG);
  }
  @Test
