...
public class TestTezJobMonitorQueueMetrics {
  ...
  /**
   * Tests that TezJobMonitor handles edge cases gracefully when metrics collection
   ...
   * </ul>
   * <p>
   * All three cases share identical structure (metrics enabled with 10s interval,
   * one edge-case input), so they are expressed as a single test with an inline
   * parameter table.
   *
   * <pre>
