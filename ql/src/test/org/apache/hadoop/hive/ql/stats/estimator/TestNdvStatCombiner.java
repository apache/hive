...
public class TestNdvStatCombiner {
  ...
  @Test
  public void testSumsNdvMaxOthers() {
    ...
    assertEquals(35, result.getCountDistint()); // 10 + 20 + 5 = SUM
    assertEquals(8, (long) result.getAvgColLen()); // MAX
    assertEquals(100, result.getNumNulls()); // MAX
    assertEquals(80, result.getNumTrues()); // MAX
    assertEquals(70, result.getNumFalses()); // MAX
