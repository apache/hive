...
public class TestStruct extends BaseTest {
  ...
  public void create() throws CommandProcessorException {
    ...
    execute("create table if not exists %s(s struct<a:string, b:string>)");
  }

  public void insert() throws CommandProcessorException {
    execute("insert into table %s values (named_struct('a', 'v1', 'b', 'v2'))");
  }

  @Test
  public void testSelect() throws CommandProcessorException {
    List<Object> lst = execute("select s from %s as t");
