...
public class TestParquet extends BaseTest {
  ...
  public void create() throws CommandProcessorException {
    ...
    execute("create table if not exists %s (i int, j int) stored as parquet");
  }

  public void insert() throws CommandProcessorException {
    execute("insert into table %s values (11,111),(12,122)");
  }
