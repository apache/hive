...
public class TestParquetProbeFilter {
  ...
  public void compactHonoursBatchSize() {
    // When the last row group ends mid-batch the passed-in batch size is smaller than the
    // bitmap length, and entries beyond the batch size must not surface in the compacted output.
