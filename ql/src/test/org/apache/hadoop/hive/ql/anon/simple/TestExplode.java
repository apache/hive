...
public class TestExplode extends BaseTest {
  ...
  public void create() throws CommandProcessorException {
    ...
    execute("create table if not exists %s(a array<int>)");
  }

  public void insert() throws CommandProcessorException {
    execute("insert into table %s values (array(1,2,3))");
  }

  @Test
  public void testExplodeFunctionCall() throws CommandProcessorException {
    List<Object> lst = execute("select explode(a) from %s order by col desc");
