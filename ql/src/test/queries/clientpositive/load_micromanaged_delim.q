...
LOAD DATA INPATH '${system:test.tmp.dir}/delim_table/table1' OVERWRITE INTO TABLE delim_table_micro;
...
LOAD DATA INPATH '${system:test.tmp.dir}/delim_table_trans/table1' OVERWRITE INTO TABLE delim_table_trans;
