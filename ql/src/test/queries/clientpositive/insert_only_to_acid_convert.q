...
insert into ext values(1,'hi'),(2,'hello');
describe formatted ext;
ALTER TABLE ext SET TBLPROPERTIES ('EXTERNAL'='false');
ALTER TABLE ext SET TBLPROPERTIES ('transactional'='true');
describe formatted ext;
select * from ext;
