...
alter table orc_partition_clustered PARTITION (c='part1') compact 'MAJOR' and wait;
alter table orc_partition_clustered PARTITION (c='part2') compact 'MAJOR' and wait;
alter table orc_partition_clustered PARTITION (c='part3') compact 'MAJOR' and wait;
alter table orc_partition_clustered PARTITION (c='part4') compact 'MAJOR' and wait;
alter table orc_partition_clustered PARTITION (c='part5') compact 'MAJOR' and wait;
