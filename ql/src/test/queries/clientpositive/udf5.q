...
EXPLAIN
SELECT from_unixtime(to_unix_timestamp('2010-01-13 11:57:40', 'yyyy-MM-dd HH:mm:ss'), 'MM/dd/yy HH:mm:ss'), from_unixtime(to_unix_timestamp('2010-01-13 11:57:40')) from dest1_n14;
