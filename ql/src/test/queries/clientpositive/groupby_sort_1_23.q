...
LOAD DATA LOCAL INPATH '../../data/files/bucket_files/000000_0' INTO TABLE T1_n80;

-- perform an insert to make sure there are 2 files
INSERT OVERWRITE TABLE T1_n80 select key, val from T1_n80;

CREATE TABLE outputTbl1_n18(key int, cnt int);
...
SELECT * FROM outputTbl1_n18;

CREATE TABLE outputTbl2_n5(key1 int, key2 string, cnt int);
...
CREATE TABLE outputTbl3_n2(key1 int, key2 int, cnt int);
...
SELECT * FROM outputTbl3_n2;

CREATE TABLE outputTbl4_n2(key1 int, key2 int, key3 string, cnt int);
...
CREATE TABLE T2_n49(key STRING, val STRING)
CLUSTERED BY (key, val) SORTED BY (key, val) INTO 2 BUCKETS STORED AS TEXTFILE;

-- perform an insert to make sure there are 2 files
INSERT OVERWRITE TABLE T2_n49 select key, val from T1_n80;
...
CREATE TABLE outputTbl5_n2(key1 int, key2 int, key3 string, key4 int, cnt int);
...
CREATE TABLE DEST1_n80(key INT, cnt INT);
CREATE TABLE DEST2_n18(key INT, val STRING, cnt INT);
...
select * from DEST1_n80;
select * from DEST2_n18;
