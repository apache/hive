...
load data local inpath '../../data/files/bmj/000000_0' INTO TABLE test1;
load data local inpath '../../data/files/bmj/000001_0' INTO TABLE test1;
load data local inpath '../../data/files/bmj/000002_0' INTO TABLE test1;

load data local inpath '../../data/files/bmj/000000_0' INTO TABLE test2;
load data local inpath '../../data/files/bmj/000001_0' INTO TABLE test2;
load data local inpath '../../data/files/bmj/000002_0' INTO TABLE test2;
