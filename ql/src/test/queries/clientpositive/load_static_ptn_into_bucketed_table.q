...
-- Load with both static and dynamic partition spec
CREATE TABLE src_bucket_tbl(key int, value string) partitioned by (hr int, ds string) clustered by (key) into 1 buckets STORED AS TEXTFILE;
explain load data local inpath '../../data/files/bmj/000000_0' INTO TABLE src_bucket_tbl partition(hr=20, ds='2010-05-07');
load data local inpath '../../data/files/bmj/000000_0' INTO TABLE src_bucket_tbl partition(hr=20, ds='2010-05-07');
select * from src_bucket_tbl where hr=20 and ds='2010-05-07';
