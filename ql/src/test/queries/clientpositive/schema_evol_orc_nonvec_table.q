...
insert into table table_add_int_permute_select_n10 SELECT insert_num, int1, 'original' FROM schema_evolution_data_n36;

-- Table-Non-Cascade ADD COLUMNS ...
alter table table_add_int_permute_select_n10 add columns(c int);

insert into table table_add_int_permute_select_n10 VALUES (111, 80000, 'new', 80000);
...
--
--
CREATE TABLE table_add_int_string_permute_select_n10(insert_num int, a INT, b STRING);

insert into table table_add_int_string_permute_select_n10 SELECT insert_num, int1, 'original' FROM schema_evolution_data_n36;

-- Table-Non-Cascade ADD COLUMNS ...
alter table table_add_int_string_permute_select_n10 add columns(c int, d string);

insert into table table_add_int_string_permute_select_n10 VALUES (111, 80000, 'new', 80000, 'filler');
...
-- SELECT permutation columns to make sure NULL defaulting works right
select insert_num,a,b from table_add_int_string_permute_select_n10;
select insert_num,a,b,c from table_add_int_string_permute_select_n10;
select insert_num,a,b,c,d from table_add_int_string_permute_select_n10;
select insert_num,a,c,d from table_add_int_string_permute_select_n10;
select insert_num,a,d from table_add_int_string_permute_select_n10;
select insert_num,c from table_add_int_string_permute_select_n10;
select insert_num,d from table_add_int_string_permute_select_n10;

drop table table_add_int_string_permute_select_n10;
...
--
CREATE TABLE table_change_string_group_double_n10(insert_num int, c1 STRING, c2 CHAR(50), c3 VARCHAR(50), b STRING);
...
explain vectorization detail
select insert_num,c1,c2,c3,b from table_change_string_group_double_n10;

select insert_num,c1,c2,c3,b from table_change_string_group_double_n10;

drop table table_change_string_group_double_n10;
...
--
CREATE TABLE table_change_date_group_string_group_date_group_n10(insert_num int, c1 DATE, c2 DATE, c3 DATE, c4 DATE, c5 DATE, c6 TIMESTAMP, c7 TIMESTAMP, c8 TIMESTAMP, c9 TIMESTAMP, c10 TIMESTAMP, b STRING);

insert into table table_change_date_group_string_group_date_group_n10 SELECT insert_num, date1, date1, date1, date1, date1, timestamp1, timestamp1, timestamp1, timestamp1, timestamp1, 'original' FROM schema_evolution_data_n36;

-- Table-Non-Cascade CHANGE COLUMNS ...
alter table table_change_date_group_string_group_date_group_n10 replace columns(insert_num int, c1 STRING, c2 CHAR(50), c3 CHAR(15), c4 VARCHAR(50), c5 VARCHAR(15), c6 STRING, c7 CHAR(50), c8 CHAR(15), c9 VARCHAR(50), c10 VARCHAR(15), b STRING);

insert into table table_change_date_group_string_group_date_group_n10 VALUES (111, 'filler', 'filler', 'filler', 'filler', 'filler', 'filler', 'filler', 'filler', 'filler', 'filler', 'new');

select insert_num,c1,c2,c3,c4,c5,c6,c7,c8,c9,c10,b from table_change_date_group_string_group_date_group_n10;

drop table table_change_date_group_string_group_date_group_n10;
...
--
--
CREATE TABLE table_change_numeric_group_string_group_multi_ints_string_group_n10(insert_num int,
...
select insert_num,c1,c2,c3,c4,c5,c6,c7,c8,c9,c10,c11,c12,c13,c14,c15,c16,c17,c18,c19,c20,b from table_change_numeric_group_string_group_multi_ints_string_group_n10;

-- Table-Non-Cascade CHANGE COLUMNS ...
alter table table_change_numeric_group_string_group_multi_ints_string_group_n10 replace columns (insert_num int,
...
insert into table table_change_numeric_group_string_group_multi_ints_string_group_n10 VALUES (111,
...
drop table table_change_numeric_group_string_group_multi_ints_string_group_n10;
...
--
--
CREATE TABLE table_change_numeric_group_string_group_floating_string_group_n10(insert_num int,
...
select insert_num,c1,c2,c3,c4,c5,c6,c7,c8,c9,c10,c11,c12,c13,c14,c15,b from table_change_numeric_group_string_group_floating_string_group_n10;

-- Table-Non-Cascade CHANGE COLUMNS ...
alter table table_change_numeric_group_string_group_floating_string_group_n10 replace columns (insert_num int,
...
insert into table table_change_numeric_group_string_group_floating_string_group_n10 VALUES (111,
...
drop table table_change_numeric_group_string_group_floating_string_group_n10;
...
--
CREATE TABLE table_change_string_group_string_group_string_n10(insert_num int,
           c1 string, c2 string, c3 string, c4 string,
...
select insert_num,c1,c2,c3,c4,b from table_change_string_group_string_group_string_n10;

-- Table-Non-Cascade CHANGE COLUMNS ...
alter table table_change_string_group_string_group_string_n10 replace columns (insert_num int,
           c1 CHAR(50), c2 CHAR(9), c3 VARCHAR(50), c4 CHAR(9),
           c5 VARCHAR(50), c6 VARCHAR(9), c7 STRING,
           c8 CHAR(50), c9 CHAR(9), c10 STRING, b STRING) ;

insert into table table_change_string_group_string_group_string_n10 VALUES (111,
          'filler', 'filler', 'filler', 'filler',
          'filler', 'filler', 'filler',
          'filler', 'filler', 'filler',
          'new');

select insert_num,c1,c2,c3,c4,c5,c6,c7,c8,c9,c10,b from table_change_string_group_string_group_string_n10;

drop table table_change_string_group_string_group_string_n10;
...
--
CREATE TABLE table_change_lower_to_higher_numeric_group_tinyint_to_bigint_n10(insert_num int,
...
select insert_num,c1,c2,c3,c4,c5,c6,c7,c8,c9,c10,c11,c12,c13,c14,c15,c16,c17,c18,b from table_change_lower_to_higher_numeric_group_tinyint_to_bigint_n10;

-- Table-Non-Cascade CHANGE COLUMNS ...
alter table table_change_lower_to_higher_numeric_group_tinyint_to_bigint_n10 replace columns (insert_num int,
...
insert into table table_change_lower_to_higher_numeric_group_tinyint_to_bigint_n10 VALUES (111,
...
drop table table_change_lower_to_higher_numeric_group_tinyint_to_bigint_n10;
...
--          FLOAT, (DOUBLE)
--
CREATE TABLE table_change_lower_to_higher_numeric_group_decimal_to_float_n10(insert_num int,
...
select insert_num,c1,c2,c3,b from table_change_lower_to_higher_numeric_group_decimal_to_float_n10;

-- Table-Non-Cascade CHANGE COLUMNS ...
alter table table_change_lower_to_higher_numeric_group_decimal_to_float_n10 replace columns (insert_num int, c1 float, c2 double, c3 DOUBLE, b STRING) ;

insert into table table_change_lower_to_higher_numeric_group_decimal_to_float_n10 VALUES (111, 1234.5678, 9876.543, 1234.5678, 'new');

select insert_num,c1,c2,c3,b from table_change_lower_to_higher_numeric_group_decimal_to_float_n10;

drop table table_change_lower_to_higher_numeric_group_decimal_to_float_n10;
