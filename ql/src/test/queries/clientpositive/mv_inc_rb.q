...
(NULL, 'a row with null value', NULL),
(NULL, 'a row with null value will be deleted', NULL);
...
delete from t1 where b = 'a row with null value will be deleted';

insert into t1(a,b, c) values (2, 'two', 2.2), (2, 'two', 2.2), (5, 'five', 5.5),
(NULL, 'a row with null value inserted', NULL);
