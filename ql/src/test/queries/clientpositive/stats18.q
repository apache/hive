...
create table stats_part_n1 like srcpart;
...
desc formatted stats_part_n1 partition (ds='2010-04-08', hr='13');

load data local inpath '../../data/files/srcbucket20.txt' INTO TABLE stats_part_n1 partition (ds='2010-04-08', hr='13');

desc formatted stats_part_n1 partition (ds='2010-04-08', hr='13');

drop table stats_src;
drop table stats_part_n1;
