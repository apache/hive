 ...
 */public class TestInPlaceUpdate {
  ...
  private static ProgressMonitor makeMonitor(String queueMetrics) {
    return new ProgressMonitor() {
      ...
      @Override public List<List<String>> rows() {
        return Collections.emptyList();
      }
      @Override public String footerSummary() {
        return "VERTICES: 00/00";
      }
      @Override public long startTime() {
        return System.currentTimeMillis();
      }
      @Override public double progressedPercentage() {
        return 0.0;
      }
      @Override public String executionStatus() {
        return "RUNNING";
      }
      @Override public String queueMetrics() {
        return queueMetrics;
      }
    };
  }
  ...
  public void testSeparatorPrintedAfterQueueMetrics() {
    ...
    int count = countOccurrences(output, SEPARATOR);
