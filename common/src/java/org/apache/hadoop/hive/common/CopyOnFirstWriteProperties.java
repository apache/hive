...
public class CopyOnFirstWriteProperties extends Properties {
  ...
  @Override
  @SuppressFBWarnings(value = "INCONSISTENT_SYNC", justification = "Intended")
  ...
  @Override
  @SuppressFBWarnings(value = {"INCONSISTENT_SYNC", "UG_SYNC_SET_UNSYNC_GET"}, justification = "Intended")
