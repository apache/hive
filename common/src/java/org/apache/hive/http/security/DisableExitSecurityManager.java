...
public class DisableExitSecurityManager extends SecurityManager {

  private static final SecurityManager originSecurityManager = System.getSecurityManager();
  ...
  public static void disableExit() {
    System.setSecurityManager(new DisableExitSecurityManager());
  }
}
