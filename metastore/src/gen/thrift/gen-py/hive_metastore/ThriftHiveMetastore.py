      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i375 in xrange(_size371):
            ...
            self.tbl_names.append(_elem376)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i396 in xrange(_size392):
            _elem397 = Partition()
            _elem397.read(iprot)
            self.new_parts.append(_elem397)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class exchange_partition_args:
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i438 in xrange(_size434):
            ...
            self.partitionSpecs[_key439] = _val440
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.partitionSpecs is not None:
      ...
      for kiter441,viter442 in self.partitionSpecs.items():
...
class get_partition_with_auth_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i447 in xrange(_size443):
            ...
            self.part_vals.append(_elem448)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
        ...
        if ftype == TType.LIST:
          ...
          for _i453 in xrange(_size449):
            ...
            self.group_names.append(_elem454)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.group_names is not None:
      ...
      for iter456 in self.group_names:
...
class markPartitionForEvent_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i596 in xrange(_size592):
            ...
            self.part_vals[_key597] = _val598
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.part_vals is not None:
      ...
      for kiter599,viter600 in self.part_vals.items():
        oprot.writeString(kiter599)
...
class isPartitionMarkedForEvent_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i605 in xrange(_size601):
            ...
            self.part_vals[_key606] = _val607
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.part_vals is not None:
      oprot.writeFieldBegin('part_vals', TType.MAP, 3)
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.part_vals))
      for kiter608,viter609 in self.part_vals.items():
