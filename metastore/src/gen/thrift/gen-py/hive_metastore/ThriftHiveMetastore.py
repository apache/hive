      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i417 in xrange(_size413):
            ...
            self.tbl_names.append(_elem418)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i438 in xrange(_size434):
            _elem439 = Partition()
            _elem439.read(iprot)
            self.new_parts.append(_elem439)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i445 in xrange(_size441):
            ...
            self.part_vals.append(_elem446)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class exchange_partition_args:
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i480 in xrange(_size476):
            ...
            self.partitionSpecs[_key481] = _val482
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.partitionSpecs is not None:
      ...
      for kiter483,viter484 in self.partitionSpecs.items():
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i489 in xrange(_size485):
            ...
            self.part_vals.append(_elem490)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
        ...
        if ftype == TType.LIST:
          ...
          for _i495 in xrange(_size491):
            ...
            self.group_names.append(_elem496)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i510 in xrange(_size506):
            ...
            self.group_names.append(_elem511)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i551 in xrange(_size547):
            ...
            self.group_names.append(_elem552)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i601 in xrange(_size597):
            _elem602 = Partition()
            _elem602.read(iprot)
            self.new_parts.append(_elem602)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class partition_name_to_spec_result:
      ...
      if fid == 0:
        if ftype == TType.MAP:
          ...
          for _i629 in xrange(_size625):
            ...
            _val631 = iprot.readString();
            self.success[_key630] = _val631
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 1:
  ...
  def write(self, oprot):
    ...
    if self.success is not None:
      ...
      for kiter632,viter633 in self.success.items():
        oprot.writeString(kiter632)
        oprot.writeString(viter633)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.o1 is not None:
      oprot.writeFieldBegin('o1', TType.STRUCT, 1)
...
class markPartitionForEvent_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i638 in xrange(_size634):
            ...
            self.part_vals[_key639] = _val640
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.part_vals is not None:
      ...
      for kiter641,viter642 in self.part_vals.items():
...
class isPartitionMarkedForEvent_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i647 in xrange(_size643):
            ...
            self.part_vals[_key648] = _val649
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.part_vals is not None:
      oprot.writeFieldBegin('part_vals', TType.MAP, 3)
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.part_vals))
      for kiter650,viter651 in self.part_vals.items():
        oprot.writeString(kiter650)
        oprot.writeString(viter651)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.eventType is not None:
      oprot.writeFieldBegin('eventType', TType.I32, 4)
