...
public class Index implements org.apache.thrift.TBase<Index, Index._Fields>, java.io.Serializable, Cloneable, Comparable<Index> {
  ...
  public int compareTo(Index other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetIndexHandlerClass()).compareTo(other.isSetIndexHandlerClass());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIndexHandlerClass()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetOrigTableName()).compareTo(other.isSetOrigTableName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOrigTableName()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetIndexTableName()).compareTo(other.isSetIndexTableName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIndexTableName()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetDeferredRebuild()).compareTo(other.isSetDeferredRebuild());
    if (lastComparison != 0) {
      return lastComparison;
    }
