...
public class RolePrincipalGrant implements org.apache.thrift.TBase<RolePrincipalGrant, RolePrincipalGrant._Fields>, java.io.Serializable, Cloneable, Comparable<RolePrincipalGrant> {
  ...
  public int compareTo(RolePrincipalGrant other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetPrincipalName()).compareTo(other.isSetPrincipalName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPrincipalName()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetPrincipalType()).compareTo(other.isSetPrincipalType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPrincipalType()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetGrantOption()).compareTo(other.isSetGrantOption());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetGrantOption()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetGrantTime()).compareTo(other.isSetGrantTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetGrantTime()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetGrantorName()).compareTo(other.isSetGrantorName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetGrantorName()) {
