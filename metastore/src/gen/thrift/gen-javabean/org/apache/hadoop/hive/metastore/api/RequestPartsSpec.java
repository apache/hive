        ...
        case NAMES:
          if (field.type == NAMES_FIELD_DESC.type) {
            java.util.List<java.lang.String> names;
            {
              ...
              names = new java.util.ArrayList<java.lang.String>(_list436.size);
        ...
        case EXPRS:
          if (field.type == EXPRS_FIELD_DESC.type) {
            java.util.List<DropPartitionsExpr> exprs;
            {
              ...
              exprs = new java.util.ArrayList<DropPartitionsExpr>(_list439.size);
              @org.apache.thrift.annotation.Nullable DropPartitionsExpr _elem440;
    ...
    switch (setField_) {
      case NAMES:
        java.util.List<java.lang.String> names = (java.util.List<java.lang.String>)value_;
        {
          ...
          for (java.lang.String _iter442 : names)
          {
      ...
      switch (setField) {
        case NAMES:
          java.util.List<java.lang.String> names;
          {
            ...
            names = new java.util.ArrayList<java.lang.String>(_list444.size);
            @org.apache.thrift.annotation.Nullable java.lang.String _elem445;
        ...
        case EXPRS:
          java.util.List<DropPartitionsExpr> exprs;
          {
            ...
            exprs = new java.util.ArrayList<DropPartitionsExpr>(_list447.size);
            @org.apache.thrift.annotation.Nullable DropPartitionsExpr _elem448;
  ...
  protected void tupleSchemeWriteValue(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    switch (setField_) {
      case NAMES:
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, names.size()));
          for (java.lang.String _iter450 : names)
          {
