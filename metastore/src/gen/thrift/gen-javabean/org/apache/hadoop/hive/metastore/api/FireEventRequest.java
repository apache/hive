...
public class FireEventRequest implements org.apache.thrift.TBase<FireEventRequest, FireEventRequest._Fields>, java.io.Serializable, Cloneable, Comparable<FireEventRequest> {
  ...
  public int compareTo(FireEventRequest other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetPartitionVals()).compareTo(other.isSetPartitionVals());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPartitionVals()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitionVals = new java.util.ArrayList<java.lang.String>(_list606.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem607;
      ...
      if (struct.partitionVals != null) {
        if (struct.isSetPartitionVals()) {
          oprot.writeFieldBegin(PARTITION_VALS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter609 : struct.partitionVals)
            {
      ...
      if (struct.isSetPartitionVals()) {
        {
          ...
          for (java.lang.String _iter610 : struct.partitionVals)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.partitionVals = new java.util.ArrayList<java.lang.String>(_list611.size);
