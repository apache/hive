...
class ThriftHiveMetastoreClient extends FacebookServiceClient implements ThriftHiveMetastoreIf {
  ...
  {
    $args = new metastore_ThriftHiveMetastore_set_ugi_args();
    $args->user_name = $user_name;
    $args->group_names = $group_names;
    $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'metastore_ThriftHiveMetastore_set_ugi_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new metastore_ThriftHiveMetastore_set_ugi_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
...
class metastore_ThriftHiveMetastore_get_table_objects_by_name_args {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_get_table_names_by_filter_args {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_get_table_names_by_filter_result {
  static $_TSPEC;
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem251 = null;
              $elem251 = new metastore_Partition();
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem307 = null;
              $elem307 = new metastore_Partition();
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem328 = null;
              $elem328 = new metastore_Partition();
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem349 = null;
              $elem349 = new metastore_Partition();
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem384 = null;
              $elem384 = new metastore_Partition();
...
class metastore_ThriftHiveMetastore_rename_partition_args {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_rename_partition_result {
  static $_TSPEC;
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem467 = null;
              $elem467 = new metastore_HiveObjectPrivilege();
...
class metastore_ThriftHiveMetastore_set_ugi_args {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_set_ugi_result {
  static $_TSPEC;
