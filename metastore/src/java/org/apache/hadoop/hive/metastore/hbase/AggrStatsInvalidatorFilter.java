...
public class AggrStatsInvalidatorFilter extends FilterBase {
  ...
  /**
   * Extension of {@link org.apache.hive.common.util.BloomFilter} to support serializing it.
   */
  static class BloomFilter extends org.apache.hive.common.util.BloomFilter {
    BloomFilter(long expectedEntries, double fpp) {
      super(expectedEntries, fpp);
    }

    BloomFilter(List<Long> bits, int numBits, int numFuncs) {
      super();
