...
public class TestAggregateStatsCache {
  ...
  public void setUp() {
    ...
    hiveConf.setVar(HiveConf.ConfVars.METASTORE_HBASE_CACHE_MAX_WRITER_WAIT, MAX_WRITER_WAIT);
    hiveConf.setVar(HiveConf.ConfVars.METASTORE_HBASE_CACHE_MAX_READER_WAIT, MAX_READER_WAIT);
  ...
  public void testBasicAddAndGet() throws Exception {
    ...
    // Now get from cache
    AggrColStatsCached aggrStatsCached = cache.get(DB_NAME, tblName, colName, partNames);
