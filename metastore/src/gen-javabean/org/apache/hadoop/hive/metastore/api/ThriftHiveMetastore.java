            ...
            if (field.type == TType.MAP) {
              {
                ...
                this.success = new HashMap<String,Type>(2*_map65.size);
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Type> _iter69 : this.success.entrySet())          {
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.part_vals = new ArrayList<String>(_list90.size);
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.part_vals = new ArrayList<String>(_list94.size);
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new ArrayList<Partition>(_list98.size);
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new ArrayList<Partition>(_list110.size);
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.part_vals = new ArrayList<String>(_list114.size);
