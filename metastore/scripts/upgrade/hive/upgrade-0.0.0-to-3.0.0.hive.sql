...
<<<<<<<< HEAD:metastore/scripts/upgrade/hive/hive-schema-4.0.0-beta-1.hive.sql
...
========
>>>>>>>> ecc2ebeaf2 (HIVE-27032: Introduce liquibase for HMS schema evolution):metastore/scripts/upgrade/hive/upgrade-0.0.0-to-3.0.0.hive.sql
