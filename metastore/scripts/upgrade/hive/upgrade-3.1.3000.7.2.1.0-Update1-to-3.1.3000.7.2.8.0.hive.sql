SELECT 'Upgrading MetaStore schema from 3.1.3000.7.2.2.0-Update1 to 3.1.3000.7.2.8.0';
...
CREATE OR REPLACE VIEW SYS.CDH_VERSION AS SELECT 1 AS VER_ID, '3.1.3000.7.2.8.0' AS SCHEMA_VERSION,
  'Hive release version 3.1.3000 for CDH 7.2.2.0-Update1' AS VERSION_COMMENT;

SELECT 'Finished upgrading MetaStore schema from 3.1.3000.7.2.2.0-Update1 to 3.1.3000.7.2.8.0';
