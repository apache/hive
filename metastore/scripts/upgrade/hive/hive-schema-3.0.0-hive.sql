...
SELECT
  ...
  C.COLUMN_NAME,
  C.INTEGER_IDX,
  cast (null as string), -- default value
  'YES', -- nullable
  ...
  CASE WHEN lower(C.TYPE_NAME) = 'date' THEN 0
       ...
       ELSE null END,
  cast (null as string), -- No intevals types in tables yet
  cast (null as string), -- No intevals types in tables yet
  cast (null as string),
  cast (null as string),
  cast (null as string),
  ...
  cast (null as string),
  cast (null as string),
  cast (null as string), -- always null, arrays have unlimited cardinality
  C.CD_ID,
  'NO', -- self referencing
  'NO', -- identity col
  cast (null as string),
