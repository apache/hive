...
ALTER TABLE ONLY "SKEWED_COL_VALUE_LOCATION_MAPPING"
    ADD CONSTRAINT "SKEWED_COL_VALUE_LOCATION_MAPPING_pkey" PRIMARY KEY ("SD_ID", "STRING_LIST_ID_KID");
...
ALTER TABLE ONLY "SKEWED_COL_VALUE_LOCATION_MAPPING"
    ADD CONSTRAINT "SKEWED_COL_VALUE_LOCATION_MAPPING_fkey1" FOREIGN KEY ("SD_ID") REFERENCES "SDS"("SD_ID") DEFERRABLE;

ALTER TABLE ONLY "SKEWED_COL_VALUE_LOCATION_MAPPING"
    ADD CONSTRAINT "SKEWED_COL_VALUE_LOCATION_MAPPING_fkey2" FOREIGN KEY ("STRING_LIST_ID_KID") REFERENCES "SKEWED_STRING_LIST"("STRING_LIST_ID") DEFERRABLE;
