...
ALTER TABLE TBLS ADD CONSTRAINT TBLS_FK3 FOREIGN KEY (LINK_TARGET_ID) REFERENCES TBLS (TBL_ID) INITIALLY DEFERRED ;
...
CREATE INDEX TBLS_N48 ON TBLS (LINK_TARGET_ID);
