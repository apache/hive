 ...
 */
public class StructFunctionResolver extends ImpalaFunctionResolverImpl {

  public StructFunctionResolver(FunctionHelper helper, SqlOperator operator,
  ...
  public RelDataType getRetType(ImpalaFunctionSignature function, List<RexNode> inputs) {
    ...
    for (int i = 0; i < inputs.size(); ++i) {
      fieldNames.add(HiveConf.getColumnInternalName(i));
    }
    return rexBuilder.getTypeFactory().createStructType(RexUtil.types(inputs), fieldNames);
  }
