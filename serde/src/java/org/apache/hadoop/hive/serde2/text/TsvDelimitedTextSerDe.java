...
/**
 * A Hive Serializer-Deserializer (SerDe) that supports tab-separated values
 * (TSV) files.
 *
 * A TSV file is a simple, widely supported, text format for storing data in a
 * tabular structure. Each record in the table is one line of a text file. Each
 * field value of a record is separated from the next by a tab character.
 *
...
public class TsvDelimitedTextSerDe extends AbstractDelimitedTextSerDe {
