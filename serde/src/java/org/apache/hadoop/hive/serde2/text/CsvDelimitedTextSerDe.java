...
/**
 * A Hive Serializer-Deserializer (SerDe) that supports comma-separated values
 * (CSV) files.
 *
 * A CSV file is a simple, widely supported, text format for storing data in a
 * tabular structure. Each record in the table is one line of a text file. Each
 * field value of a record is separated from the next by a comma character.
 *
...
public class CsvDelimitedTextSerDe extends AbstractDelimitedTextSerDe {
