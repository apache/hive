...
public class MiniStruct implements org.apache.thrift.TBase<MiniStruct, MiniStruct._Fields>, java.io.Serializable, Cloneable, Comparable<MiniStruct> {
  ...
  public int compareTo(MiniStruct other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetMy_string()).compareTo(other.isSetMy_string());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetMy_enum()).compareTo(other.isSetMy_enum());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMy_enum()) {
