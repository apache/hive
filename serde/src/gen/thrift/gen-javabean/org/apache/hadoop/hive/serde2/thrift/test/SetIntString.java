...
public class SetIntString implements org.apache.thrift.TBase<SetIntString, SetIntString._Fields>, java.io.Serializable, Cloneable, Comparable<SetIntString> {
  ...
  public int compareTo(SetIntString other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSIntString()).compareTo(other.isSetSIntString());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAString()).compareTo(other.isSetAString());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAString()) {
