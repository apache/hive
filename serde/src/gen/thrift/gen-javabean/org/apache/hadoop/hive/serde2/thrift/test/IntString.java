...
public class IntString implements org.apache.thrift.TBase<IntString, IntString._Fields>, java.io.Serializable, Cloneable, Comparable<IntString> {
  ...
  public int compareTo(IntString other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetMyint()).compareTo(other.isSetMyint());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetMyString()).compareTo(other.isSetMyString());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMyString()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetUnderscore_int()).compareTo(other.isSetUnderscore_int());
    if (lastComparison != 0) {
      return lastComparison;
    }
