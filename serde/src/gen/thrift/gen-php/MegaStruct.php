...
class MegaStruct
{
    ...
    public ?bool $my_bool = null;
    public ?int $my_byte = null;
    public ?int $my_16bit_int = null;
    public ?int $my_32bit_int = null;
    public ?int $my_64bit_int = null;
    public ?float $my_double = null;
    public ?string $my_string = null;
    public ?string $my_binary = null;
    /**
     * @var array
     */
    public ?array $my_string_string_map = null;
    /**
     * @var array
     */
    public ?array $my_string_enum_map = null;
    /**
     * @var array
     */
    public ?array $my_enum_string_map = null;
    /**
     * @var array
     */
    public ?array $my_enum_struct_map = null;
    /**
     * @var array
     */
    public ?array $my_enum_stringlist_map = null;
    /**
     * @var array
     */
    public ?array $my_enum_structlist_map = null;
    /**
     * @var string[]
     */
    public ?array $my_stringlist = null;
    /**
     * @var \MiniStruct[]
     */
    public ?array $my_structlist = null;
    /**
     * @var int[]
     */
    public ?array $my_enumlist = null;
    /**
     * @var string[]
     */
    public ?array $my_stringset = null;
    /**
     * @var int[]
     */
    public ?array $my_enumset = null;
    /**
     * @var \MiniStruct[]
     */
    public ?array $my_structset = null;

    public function __construct(?array $vals = null)
    {
        if (is_array($vals)) {
            if (isset($vals['my_bool'])) {
                $this->my_bool = (bool)$vals['my_bool'];
            }
            if (isset($vals['my_byte'])) {
                $this->my_byte = (int)$vals['my_byte'];
            }
            if (isset($vals['my_16bit_int'])) {
                $this->my_16bit_int = (int)$vals['my_16bit_int'];
            }
            if (isset($vals['my_32bit_int'])) {
                $this->my_32bit_int = (int)$vals['my_32bit_int'];
            }
            if (isset($vals['my_64bit_int'])) {
                $this->my_64bit_int = (int)$vals['my_64bit_int'];
            }
            if (isset($vals['my_double'])) {
                $this->my_double = (float)$vals['my_double'];
            }
            if (isset($vals['my_string'])) {
                $this->my_string = (string)$vals['my_string'];
            }
            if (isset($vals['my_binary'])) {
                $this->my_binary = (string)$vals['my_binary'];
            }
