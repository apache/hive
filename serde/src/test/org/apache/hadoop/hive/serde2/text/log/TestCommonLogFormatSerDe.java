...
/**
 * Test suite for {@link CommonLogFormatSerDe}.
 */
public class TestCommonLogFormatSerDe {

  private CommonLogFormatSerDe serde;

  @Before
  public void setup() {
    this.serde = new CommonLogFormatSerDe();
  }
  ...
  public void testSerialize() throws SerDeException {
    ...
    props.setProperty(serdeConstants.LIST_COLUMNS, "c1,c2,c3,c4,c5,c6,c7");
  ...
  public void testColumnCount() throws SerDeException {
    Properties props = new Properties();
    props.setProperty(serdeConstants.LIST_COLUMNS, "c1,c2,c3,c4,c5,c6");
  ...
  public void testDeserializeDefault() throws SerDeException {
    ...
    final Text testText = new Text("127.0.0.1 - frank "
        + "[10/Oct/2000:13:55:36 -0700] \"GET /pb.gif HTTP/1.0\" 200 2326");
