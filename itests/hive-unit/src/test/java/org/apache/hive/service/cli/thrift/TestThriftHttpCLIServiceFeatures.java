...
public class TestThriftHttpCLIServiceFeatures extends AbstractThriftCLITest {
  ...
  public void testForwardedHeaders() throws Exception {
    verifyForwardedHeaders(new ArrayList<String>(Arrays.asList(IPUtils.getLoopbackAddress(), IPUtils.translateIPv4IPForActiveStack("202.101.101.101"))), "show tables");
    verifyForwardedHeaders(new ArrayList<String>(Arrays.asList(IPUtils.translateIPv4IPForActiveStack("202.101.101.101"))), "fs -ls /");
