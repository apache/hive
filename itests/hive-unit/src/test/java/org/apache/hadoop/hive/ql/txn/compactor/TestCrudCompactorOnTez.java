...
public class TestCrudCompactorOnTez extends CompactorOnTezTest {
  ...
  private void testRebalanceCompactionWithParallelDeleteAsSecond(boolean optimisticLock) throws Exception {
    ...
    String[][] expectedBuckets = new String[][] {
        ...
        },
        {
            ...
            "{\"writeid\":7,\"bucketid\":536936448,\"rowid\":7}\t5\t4",
            "{\"writeid\":7,\"bucketid\":536936448,\"rowid\":8}\t6\t4",
            "{\"writeid\":7,\"bucketid\":536936448,\"rowid\":9}\t4\t4",

        },
        {
            "{\"writeid\":7,\"bucketid\":537001984,\"rowid\":10}\t3\t4",
            "{\"writeid\":7,\"bucketid\":537001984,\"rowid\":11}\t5\t3",
            "{\"writeid\":7,\"bucketid\":537001984,\"rowid\":12}\t4\t3",
            "{\"writeid\":7,\"bucketid\":537001984,\"rowid\":13}\t2\t3",
            "{\"writeid\":7,\"bucketid\":537001984,\"rowid\":14}\t6\t3",

        },
        {
            "{\"writeid\":7,\"bucketid\":537067520,\"rowid\":15}\t3\t3",
  ...
  public void testRebalanceCompactionOfNotPartitionedImplicitlyBucketedTable() throws Exception {
    ...
    String[][] expectedBuckets = new String[][] {
        {
            "{\"writeid\":1,\"bucketid\":536870912,\"rowid\":0}\t4\t3",
            "{\"writeid\":1,\"bucketid\":536870912,\"rowid\":1}\t2\t3",
            "{\"writeid\":1,\"bucketid\":536870912,\"rowid\":2}\t5\t2",
            "{\"writeid\":1,\"bucketid\":536870912,\"rowid\":3}\t5\t3",
            "{\"writeid\":1,\"bucketid\":536870912,\"rowid\":4}\t5\t4",
        },
        {
            "{\"writeid\":1,\"bucketid\":536936448,\"rowid\":5}\t6\t2",
            "{\"writeid\":1,\"bucketid\":536936448,\"rowid\":6}\t6\t3",
            "{\"writeid\":1,\"bucketid\":536936448,\"rowid\":7}\t6\t4",
            "{\"writeid\":1,\"bucketid\":536936448,\"rowid\":8}\t3\t4",
            "{\"writeid\":1,\"bucketid\":536936448,\"rowid\":9}\t2\t4",
        },
        {
            "{\"writeid\":1,\"bucketid\":537001984,\"rowid\":10}\t3\t3",
            "{\"writeid\":1,\"bucketid\":537001984,\"rowid\":11}\t4\t4",
  ...
  private TestDataProvider prepareRebalanceTestData(String tableName) throws Exception {
    ...
    String[][] expectedBuckets = new String[][] {
        ...
        },
        {
            ...
            "{\"writeid\":1,\"bucketid\":536936448,\"rowid\":2}\t5\t4",
            "{\"writeid\":1,\"bucketid\":536936448,\"rowid\":3}\t6\t2",
            "{\"writeid\":1,\"bucketid\":536936448,\"rowid\":4}\t6\t3",
            "{\"writeid\":1,\"bucketid\":536936448,\"rowid\":5}\t6\t4",
        },
        {
            "{\"writeid\":1,\"bucketid\":537001984,\"rowid\":0}\t3\t4",
            "{\"writeid\":1,\"bucketid\":537001984,\"rowid\":1}\t2\t4",
        },
        {
            "{\"writeid\":1,\"bucketid\":537067520,\"rowid\":0}\t3\t3",
            "{\"writeid\":1,\"bucketid\":537067520,\"rowid\":1}\t4\t4",
        },
    };
    AcidOutputFormat.Options options = new AcidOutputFormat.Options(conf);
    for(int i = 0; i < 3; i++) {
