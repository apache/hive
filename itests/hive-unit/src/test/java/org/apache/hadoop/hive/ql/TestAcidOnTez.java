...
public class TestAcidOnTez {
  ...
  public void setUp() throws Exception {
    ...
    // leftover from old setupTez method: TODO move to HiveTestEnvSetup if applicable in general
    hiveConf.setVar(HiveConf.ConfVars.HIVE_USER_INSTALL_DIR, TEST_DATA_DIR);
    hiveConf.set("tez.staging-dir", TEST_DATA_DIR);
    hiveConf.setBoolean("tez.ignore.lib.uris", true);
    hiveConf.set("hive.tez.container.size", "128");
    hiveConf.setBoolean("hive.merge.tezfiles", false);
    hiveConf.setBoolean("hive.in.tez.test", true);
