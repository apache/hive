...
*/
    ...
    String[][] expected2 = {
       ...
       {"{\"writeid\":2,\"bucketid\":536936448,\"rowid\":1}\t5\t6", "warehouse/t/delta_0000002_0000002_0000/bucket_00001"},
       {"{\"writeid\":2,\"bucketid\":536870912,\"rowid\":1}\t6\t8", "warehouse/t/delta_0000002_0000002_0000/bucket_00000"},
       {"{\"writeid\":2,\"bucketid\":536936448,\"rowid\":2}\t9\t10", "warehouse/t/delta_0000002_0000002_0000/bucket_00001"}
    };
    Assert.assertEquals("Unexpected row count", expected2.length, rs.size());
    for(int i = 0; i < expected2.length; i++) {
      Assert.assertTrue("Actual line " + i + " ac: " + rs.get(i), rs.get(i).startsWith(expected2[i][0]));
