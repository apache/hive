...
public class TestReplicationScenariosAcrossInstances {
  ...
  private static WareHouse primary, replica;

  @BeforeClass
  public static void classLevelSetup() throws Exception {
    primary = new WareHouse();
    replica = new WareHouse();
  }
  ...
  public void testIncrementalFunctionReplication() throws Throwable {
    WareHouse.Tuple bootStrapDump = primary.dump(primaryDbName, null);
    ...
    WareHouse.Tuple incrementalDump = primary.dump(primaryDbName, bootStrapDump.lastReplicationId);
