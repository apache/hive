...
public class VectorFastHTMultiKeyBench {
  ...
  public static class HashMultiSetFastVectorBench extends MultiKeyBase {
    @Setup
  ...
  public static class HashSetFastVectorBench extends MultiKeyBase {
    @Setup
    public void setup() throws Exception {
      LOG.info("Do Setup");
  ...
  public static class HashMapFastVectorBench extends MultiKeyBase {
    @Setup
    public void setup() throws Exception {
      LOG.info("Do Setup");
