...
public class VectorFastHTBytesKeyBench {
  ...
  public static class HashMultiSetLargeFastVectorBench extends BytesKeyBase {
    ...
    public void setup() throws Exception {
      LOG.info("Do Setup");
      doSetup(VectorMapJoinVariation.INNER_BIG_ONLY, MapJoinTestImplementation.NATIVE_VECTOR_FAST, 50_000_000);
    }
  ...
  public static class HashSetLargeFastVectorBench extends BytesKeyBase {
    ...
    public void setup() throws Exception {
      LOG.info("Do Setup");
      doSetup(VectorMapJoinVariation.LEFT_SEMI, MapJoinTestImplementation.NATIVE_VECTOR_FAST, 50_000_000);
    }
  ...
  public static class HashMapLargeFastVectorBench extends BytesKeyBase {
    ...
    public void setup() throws Exception {
      LOG.info("Do Setup");
      doSetup(VectorMapJoinVariation.INNER, MapJoinTestImplementation.NATIVE_VECTOR_FAST, 50_000_000);
    }
