...
public class VectorFastHTLongKeyBench {
  ...
  public static class HashMultiSetFastVectorBench extends LongKeyBase {
    @Setup
  ...
  public static class HashSetFastVectorBench extends LongKeyBase {
    @Setup
    public void setup() throws Exception {
      LOG.info("Do Setup");
  ...
  public static class HashMapFastVectorBench extends LongKeyBase {
    @Setup
    public void setup() throws Exception {
      LOG.info("Do Setup");
