...
public class TestStreaming {
  ...
  public void testAutoRollTransactionBatch() throws Exception {
    ...
    Assert.assertTrue(rs.get(5), rs.get(5).startsWith("{\"writeid\":5,\"bucketid\":536870912,\"rowid\":0}\ta9\tb10"));
    Assert.assertTrue(rs.get(5), rs.get(5).endsWith("streamingnobuckets/delta_0000005_0000006/bucket_00000"));
    Assert.assertTrue(rs.get(6), rs.get(6).startsWith("{\"writeid\":5,\"bucketid\":536870912,\"rowid\":1}\ta11\tb12"));
    Assert.assertTrue(rs.get(6), rs.get(6).endsWith("streamingnobuckets/delta_0000005_0000006/bucket_00000"));
    Assert.assertTrue(rs.get(7), rs.get(7).startsWith("{\"writeid\":6,\"bucketid\":536870912,\"rowid\":0}\ta13\tb14"));
