...
public class TestReadWriteLockMetrics {
   ...
   * deal with any contention. The test shows that the locks are received rather quick and that
   ...
   * loop while the main thread holds a write lock for half of the text
