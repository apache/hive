...
public class TestRESTCatalogTestsAuthJwt extends BaseRESTCatalogTests {
  @RegisterExtension
  ...
  @Test
  public void testWithUnauthorizedKey() throws Exception {
    ...
    NotAuthorizedException error = Assertions.assertThrows(NotAuthorizedException.class,
        () -> RCKUtils.initCatalogClient(properties).close());
