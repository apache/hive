...
class MaxAllocatedTableWriteIdResponse:
  ...
  def validate(self):
    if self.maxWriteId is None:
      raise TProtocol.TProtocolException(message='Required field maxWriteId is unset!')
    return


  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.maxWriteId)
    return value
...
class SeedTableWriteIdsRequest:
  ...
  def validate(self):
    ...
    if self.seedWriteId is None:
      raise TProtocol.TProtocolException(message='Required field seedWriteId is unset!')
    return
...
class SeedTxnIdRequest:
  ...
  def validate(self):
    if self.seedTxnId is None:
      raise TProtocol.TProtocolException(message='Required field seedTxnId is unset!')
    return


  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.seedTxnId)
    return value
...
class GetOpenTxnsRequest:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'excludeTxnTypes', (TType.I32,None), None, ), # 1
  )
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i1135 in xrange(_size1131):
            _elem1136 = iprot.readI32()
            self.excludeTxnTypes.append(_elem1136)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.excludeTxnTypes)
    return value
