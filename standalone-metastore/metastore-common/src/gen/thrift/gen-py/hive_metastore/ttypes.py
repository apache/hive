...
class WMFullResourcePlan:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i880 in xrange(_size876):
            _elem881 = WMPoolTrigger()
            _elem881.read(iprot)
            self.poolTriggers.append(_elem881)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.poolTriggers is not None:
      ...
      for iter885 in self.poolTriggers:
        iter885.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class WMGetAllResourcePlanResponse:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i890 in xrange(_size886):
            _elem891 = WMResourcePlan()
            _elem891.read(iprot)
            self.resourcePlans.append(_elem891)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.resourcePlans is not None:
      ...
      for iter892 in self.resourcePlans:
        iter892.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i918 in xrange(_size914):
            _elem919 = FieldSchema()
            _elem919.read(iprot)
            self.cols.append(_elem919)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 5:
...
class FindSchemasByColsResp:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i925 in xrange(_size921):
            _elem926 = SchemaVersionDescriptor()
            _elem926.read(iprot)
            self.schemaVersions.append(_elem926)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.schemaVersions is not None:
      ...
      for iter927 in self.schemaVersions:
        iter927.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class AlterPartitionsRequest:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i981 in xrange(_size977):
            _elem982 = Partition()
            _elem982.read(iprot)
            self.partitions.append(_elem982)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 5:
  ...
  def write(self, oprot):
    ...
    if self.partitions is not None:
      ...
      oprot.writeListBegin(TType.STRUCT, len(self.partitions))
      for iter983 in self.partitions:
        iter983.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.environmentContext is not None:
...
class GetPartitionsProjectionSpec:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i1002 in xrange(_size998):
            ...
            self.fieldList.append(_elem1003)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.fieldList is not None:
      ...
      for iter1004 in self.fieldList:
...
class GetPartitionsResponse:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i1016 in xrange(_size1012):
            _elem1017 = PartitionSpec()
            _elem1017.read(iprot)
            self.partitionSpec.append(_elem1017)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.partitionSpec is not None:
      ...
      for iter1018 in self.partitionSpec:
...
class GetPartitionsRequest:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i1023 in xrange(_size1019):
            ...
            self.groupNames.append(_elem1024)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 7:
  ...
  def write(self, oprot):
    ...
    if self.groupNames is not None:
      ...
      for iter1031 in self.groupNames:
        oprot.writeString(iter1031)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
