...
class Table:
  ...
  def write(self, oprot):
    ...
    if self.parameters is not None:
      oprot.writeFieldBegin('parameters', TType.MAP, 10)
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.parameters))
      for kiter210,viter211 in self.parameters.items():
...
class Partition:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i222 in xrange(_size218):
            ...
            self.parameters[_key223] = _val224
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 8:
  ...
  def write(self, oprot):
    ...
    if self.parameters is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.parameters))
      for kiter226,viter227 in self.parameters.items():
...
class PartitionWithoutSD:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i238 in xrange(_size234):
            ...
            self.parameters[_key239] = _val240
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 6:
  ...
  def write(self, oprot):
    ...
    if self.parameters is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.parameters))
      for kiter242,viter243 in self.parameters.items():
...
class GetPartitionsByNamesResult:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i506 in xrange(_size502):
            _elem507 = Partition()
            _elem507.read(iprot)
            self.partitions.append(_elem507)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.partitions is not None:
      oprot.writeFieldBegin('partitions', TType.LIST, 1)
      oprot.writeListBegin(TType.STRUCT, len(self.partitions))
      for iter508 in self.partitions:
        iter508.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i513 in xrange(_size509):
            _elem514 = ResourceUri()
            _elem514.read(iprot)
            self.resourceUris.append(_elem514)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 9:
...
class OpenTxnRequest:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i534 in xrange(_size530):
            ...
            self.replSrcTxnIds.append(_elem535)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 7:
  ...
  def write(self, oprot):
    ...
    if self.replSrcTxnIds is not None:
      ...
      for iter536 in self.replSrcTxnIds:
...
class CommitTxnRequest:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i562 in xrange(_size558):
            _elem563 = WriteEventInfo()
            _elem563.read(iprot)
            self.writeEventInfos.append(_elem563)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.writeEventInfos is not None:
      ...
      for iter564 in self.writeEventInfos:
        iter564.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i569 in xrange(_size565):
            ...
            self.partNames.append(_elem570)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class GetValidWriteIdsRequest:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i576 in xrange(_size572):
            ...
            self.fullTableNames.append(_elem577)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.fullTableNames is not None:
      ...
      for iter578 in self.fullTableNames:
...
class TableValidWriteIds:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i583 in xrange(_size579):
            ...
            self.invalidWriteIds.append(_elem584)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.invalidWriteIds is not None:
      ...
      for iter585 in self.invalidWriteIds:
...
class GetValidWriteIdsResponse:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i590 in xrange(_size586):
            _elem591 = TableValidWriteIds()
            _elem591.read(iprot)
            self.tblValidWriteIds.append(_elem591)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.tblValidWriteIds is not None:
      ...
      for iter592 in self.tblValidWriteIds:
        iter592.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class AllocateTableWriteIdsRequest:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i603 in xrange(_size599):
            _elem604 = TxnToWriteId()
            _elem604.read(iprot)
            self.srcTxnToWriteIdList.append(_elem604)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.srcTxnToWriteIdList is not None:
      ...
      for iter606 in self.srcTxnToWriteIdList:
        iter606.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class AllocateTableWriteIdsResponse:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i611 in xrange(_size607):
            _elem612 = TxnToWriteId()
            _elem612.read(iprot)
            self.txnToWriteIds.append(_elem612)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.txnToWriteIds is not None:
      ...
      for iter613 in self.txnToWriteIds:
        iter613.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i618 in xrange(_size614):
            _elem619 = LockComponent()
            _elem619.read(iprot)
            self.component.append(_elem619)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i625 in xrange(_size621):
            _elem626 = ShowLocksResponseElement()
            _elem626.read(iprot)
            self.locks.append(_elem626)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.SET:
          self.aborted = set()
          (_etype631, _size628) = iprot.readSetBegin()
          for _i632 in xrange(_size628):
            _elem633 = iprot.readI64()
            self.aborted.add(_elem633)
          iprot.readSetEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.SET:
          self.nosuch = set()
          (_etype637, _size634) = iprot.readSetBegin()
          for _i638 in xrange(_size634):
            _elem639 = iprot.readI64()
            self.nosuch.add(_elem639)
          iprot.readSetEnd()
        else:
          iprot.skip(ftype)
      else:
...
class CompactionRequest:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i646 in xrange(_size642):
            ...
            self.properties[_key647] = _val648
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.properties is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.properties))
      for kiter649,viter650 in self.properties.items():
        oprot.writeString(kiter649)
        oprot.writeString(viter650)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i655 in xrange(_size651):
            _elem656 = ShowCompactResponseElement()
            _elem656.read(iprot)
            self.compacts.append(_elem656)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class AddDynamicPartitions:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i662 in xrange(_size658):
            ...
            self.partitionnames.append(_elem663)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 6:
  ...
  def write(self, oprot):
    ...
    if self.partitionnames is not None:
      ...
      for iter664 in self.partitionnames:
