...
class ThriftHiveMetastore_truncate_table_args
{
            ...
            switch ($fid) {
                ...
                case 3:
                    if ($ftype == TType::LST) {
                        ...
                        $_size1362 = 0;
                        $_etype1365 = 0;
                        $xfer += $input->readListBegin($_etype1365, $_size1362);
                        for ($_i1366 = 0; $_i1366 < $_size1362; ++$_i1366) {
                            $elem1367 = null;
                            $xfer += $input->readString($elem1367);
                            $this->partNames []= $elem1367;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->partNames !== null) {
            ...
            foreach ($this->partNames as $iter1368) {
                $xfer += $output->writeString($iter1368);
            }
            $output->writeListEnd();
            $xfer += $output->writeFieldEnd();
        }
