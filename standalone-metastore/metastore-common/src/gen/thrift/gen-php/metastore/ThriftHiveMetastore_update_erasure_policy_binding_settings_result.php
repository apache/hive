...
class ThriftHiveMetastore_update_erasure_policy_binding_settings_result
{
    ...
    {
        return 'ThriftHiveMetastore_update_erasure_policy_binding_settings_result';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('ThriftHiveMetastore_update_erasure_policy_binding_settings_result');
        if ($this->o1 !== null) {
