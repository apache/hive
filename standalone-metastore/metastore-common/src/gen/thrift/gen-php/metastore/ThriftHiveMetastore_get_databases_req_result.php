...
class ThriftHiveMetastore_get_databases_req_result
{
    ...
    public static array $tspec = [
        0 => [
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\metastore\GetDatabaseObjectsResponse',
        ],
        1 => [
            'var' => 'o1',
            'isRequired' => false,
    ...
    public ?GetDatabaseObjectsResponse $success = null;
    ...
    {
        return 'ThriftHiveMetastore_get_databases_req_result';
    }
                ...
                switch ($fid) {
                    case 0:
                        if ($ftype == TType::STRUCT) {
                            $this->success = new \metastore\GetDatabaseObjectsResponse();
    ...
    public function write(TProtocol $output): int
    {
        ...
        try {
            $xfer += $output->writeStructBegin('ThriftHiveMetastore_get_databases_req_result');
