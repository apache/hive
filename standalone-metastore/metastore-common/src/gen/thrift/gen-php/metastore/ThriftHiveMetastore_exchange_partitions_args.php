...
class ThriftHiveMetastore_exchange_partitions_args
{
            ...
            switch ($fid) {
                case 1:
                    if ($ftype == TType::MAP) {
                        ...
                        $_ktype1426 = 0;
                        $_vtype1427 = 0;
                        $xfer += $input->readMapBegin($_ktype1426, $_vtype1427, $_size1425);
                        for ($_i1429 = 0; $_i1429 < $_size1425; ++$_i1429) {
                            $key1430 = '';
                            $val1431 = '';
                            $xfer += $input->readString($key1430);
                            $xfer += $input->readString($val1431);
                            $this->partitionSpecs[$key1430] = $val1431;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->partitionSpecs !== null) {
            ...
            foreach ($this->partitionSpecs as $kiter1432 => $viter1433) {
                $xfer += $output->writeString($kiter1432);
                $xfer += $output->writeString($viter1433);
            }
            $output->writeMapEnd();
