...
class ThriftHiveMetastore_add_write_notification_log_in_batch_args
{
    ...
    public static array $tspec = [
        1 => [
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\metastore\WriteNotificationLogBatchRequest',
        ],
    ];

    public ?WriteNotificationLogBatchRequest $rqst = null;
    ...
    {
        return 'ThriftHiveMetastore_add_write_notification_log_in_batch_args';
    }
                ...
                switch ($fid) {
                    case 1:
                        if ($ftype == TType::STRUCT) {
                            $this->rqst = new \metastore\WriteNotificationLogBatchRequest();
    ...
    public function write(TProtocol $output): int
    {
        ...
        try {
            $xfer += $output->writeStructBegin('ThriftHiveMetastore_add_write_notification_log_in_batch_args');
            if ($this->rqst !== null) {
