...
class ThriftHiveMetastore_get_properties_args
{
    ...
    public static array $tspec = [
        1 => [
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\metastore\PropertyGetRequest',
        ],
    ];

    public ?PropertyGetRequest $req = null;
    ...
    {
        return 'ThriftHiveMetastore_get_properties_args';
    }
                ...
                switch ($fid) {
                    case 1:
                        if ($ftype == TType::STRUCT) {
                            $this->req = new \metastore\PropertyGetRequest();
    ...
    public function write(TProtocol $output): int
    {
        ...
        try {
            $xfer += $output->writeStructBegin('ThriftHiveMetastore_get_properties_args');
            if ($this->req !== null) {
