...
class ThriftHiveMetastore_get_partitions_ps_args
{
            ...
            switch ($fid) {
                ...
                case 3:
                    if ($ftype == TType::LST) {
                        ...
                        $_size1718 = 0;
                        $_etype1721 = 0;
                        $xfer += $input->readListBegin($_etype1721, $_size1718);
                        for ($_i1722 = 0; $_i1722 < $_size1718; ++$_i1722) {
                            $elem1723 = null;
                            $xfer += $input->readString($elem1723);
                            $this->part_vals []= $elem1723;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->part_vals !== null) {
            ...
            foreach ($this->part_vals as $iter1724) {
                $xfer += $output->writeString($iter1724);
            }
            $output->writeListEnd();
            $xfer += $output->writeFieldEnd();
        }
