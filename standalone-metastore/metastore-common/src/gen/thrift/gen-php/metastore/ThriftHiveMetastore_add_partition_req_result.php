...
class ThriftHiveMetastore_add_partition_req_result
{
    ...
    {
        return 'ThriftHiveMetastore_add_partition_req_result';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('ThriftHiveMetastore_add_partition_req_result');
