...
class ThriftHiveMetastore_get_part_specs_by_filter_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size1788 = 0;
                        $_etype1791 = 0;
                        $xfer += $input->readListBegin($_etype1791, $_size1788);
                        for ($_i1792 = 0; $_i1792 < $_size1788; ++$_i1792) {
                            $elem1793 = null;
                            $elem1793 = new \metastore\PartitionSpec();
                            $xfer += $elem1793->read($input);
                            $this->success []= $elem1793;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter1794) {
