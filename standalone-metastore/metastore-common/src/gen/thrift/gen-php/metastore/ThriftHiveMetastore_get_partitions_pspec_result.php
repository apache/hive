...
class ThriftHiveMetastore_get_partitions_pspec_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size1688 = 0;
                        $_etype1691 = 0;
                        $xfer += $input->readListBegin($_etype1691, $_size1688);
                        for ($_i1692 = 0; $_i1692 < $_size1688; ++$_i1692) {
                            $elem1693 = null;
                            $elem1693 = new \metastore\PartitionSpec();
                            $xfer += $elem1693->read($input);
                            $this->success []= $elem1693;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter1694) {
                $xfer += $iter1694->write($output);
            }
            $output->writeListEnd();
