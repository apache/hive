...
class ThriftHiveMetastore_get_partitions_pspec_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size1515 = 0;
                        $_etype1518 = 0;
                        $xfer += $input->readListBegin($_etype1518, $_size1515);
                        for ($_i1519 = 0; $_i1519 < $_size1515; ++$_i1519) {
                            $elem1520 = null;
                            $elem1520 = new \metastore\PartitionSpec();
                            $xfer += $elem1520->read($input);
                            $this->success []= $elem1520;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter1521) {
