...
class ThriftHiveMetastore_replace_binding_resolved_rules_result
{
    ...
    {
        return 'ThriftHiveMetastore_replace_binding_resolved_rules_result';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('ThriftHiveMetastore_replace_binding_resolved_rules_result');
        if ($this->o1 !== null) {
