...
class ThriftHiveMetastore_abort_Compactions_result
{
    ...
    public static array $tspec = [
        0 => [
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\metastore\AbortCompactResponse',
        ],
    ];

    public ?AbortCompactResponse $success = null;
    ...
    {
        return 'ThriftHiveMetastore_abort_Compactions_result';
    }
                ...
                switch ($fid) {
                    case 0:
                        if ($ftype == TType::STRUCT) {
                            $this->success = new \metastore\AbortCompactResponse();
    ...
    public function write(TProtocol $output): int
    {
        ...
        try {
            $xfer += $output->writeStructBegin('ThriftHiveMetastore_abort_Compactions_result');
