...
class ThriftHiveMetastore_update_erasure_policy_version_status_result
{
    ...
    {
        return 'ThriftHiveMetastore_update_erasure_policy_version_status_result';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('ThriftHiveMetastore_update_erasure_policy_version_status_result');
        if ($this->o1 !== null) {
