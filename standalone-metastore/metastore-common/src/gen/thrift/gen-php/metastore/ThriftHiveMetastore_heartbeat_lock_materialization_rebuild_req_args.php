...
class ThriftHiveMetastore_heartbeat_lock_materialization_rebuild_req_args
{
    ...
    public static array $tspec = [
        1 => [
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\metastore\LockMaterializationRebuildRequest',
        ],
    ];

    public ?LockMaterializationRebuildRequest $req = null;
    ...
    {
        return 'ThriftHiveMetastore_heartbeat_lock_materialization_rebuild_req_args';
    }
                ...
                switch ($fid) {
                    case 1:
                        if ($ftype == TType::STRUCT) {
                            $this->req = new \metastore\LockMaterializationRebuildRequest();
    ...
    public function write(TProtocol $output): int
    {
        ...
        try {
            $xfer += $output->writeStructBegin('ThriftHiveMetastore_heartbeat_lock_materialization_rebuild_req_args');
            if ($this->req !== null) {
