...
class ThriftHiveMetastore_append_partition_by_name_req_result
{
    ...
    {
        return 'ThriftHiveMetastore_append_partition_by_name_req_result';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('ThriftHiveMetastore_append_partition_by_name_req_result');
