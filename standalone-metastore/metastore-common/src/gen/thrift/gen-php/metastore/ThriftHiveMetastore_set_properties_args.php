...
class ThriftHiveMetastore_set_properties_args
{
    ...
    public static array $tspec = [
        1 => [
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\metastore\PropertySetRequest',
        ],
    ];

    public ?PropertySetRequest $req = null;
    ...
    {
        return 'ThriftHiveMetastore_set_properties_args';
    }
                ...
                switch ($fid) {
                    case 1:
                        if ($ftype == TType::STRUCT) {
                            $this->req = new \metastore\PropertySetRequest();
    ...
    public function write(TProtocol $output): int
    {
        ...
        try {
            $xfer += $output->writeStructBegin('ThriftHiveMetastore_set_properties_args');
            if ($this->req !== null) {
