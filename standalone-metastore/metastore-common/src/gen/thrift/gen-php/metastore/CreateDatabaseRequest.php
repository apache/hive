...
class CreateDatabaseRequest
{
                ...
                case 4:
                    if ($ftype == TType::MAP) {
                        ...
                        for ($_i1121 = 0; $_i1121 < $_size1117; ++$_i1121) {
                            ...
                            $this->parameters[$key1122] = $val1123;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->parameters !== null) {
            ...
            foreach ($this->parameters as $kiter1124 => $viter1125) {
        ...
        if ($this->database !== null) {
            ...
            $xfer += $output->writeFieldBegin('database', TType::STRUCT, 13);
            $xfer += $this->database->write($output);
            $xfer += $output->writeFieldEnd();
        }
        if ($this->skipFSWrites !== null) {
            $xfer += $output->writeFieldBegin('skipFSWrites', TType::BOOL, 14);
