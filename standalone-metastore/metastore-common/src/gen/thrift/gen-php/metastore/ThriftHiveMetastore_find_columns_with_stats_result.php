...
class ThriftHiveMetastore_find_columns_with_stats_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size1893 = 0;
                        $_etype1896 = 0;
                        $xfer += $input->readListBegin($_etype1896, $_size1893);
                        for ($_i1897 = 0; $_i1897 < $_size1893; ++$_i1897) {
                            $elem1898 = null;
                            $xfer += $input->readString($elem1898);
                            $this->success []= $elem1898;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter1899) {
                $xfer += $output->writeString($iter1899);
            }
            $output->writeListEnd();
