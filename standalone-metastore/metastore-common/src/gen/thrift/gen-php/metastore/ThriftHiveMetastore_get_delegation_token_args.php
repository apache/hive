...
class ThriftHiveMetastore_get_delegation_token_args
{
    ...
    public ?string $token_owner = null;
    public ?string $renewer_kerberos_principal_name = null;

    public function __construct(?array $vals = null)
    {
        if (is_array($vals)) {
            if (isset($vals['token_owner'])) {
                $this->token_owner = (string)$vals['token_owner'];
            }
            if (isset($vals['renewer_kerberos_principal_name'])) {
                $this->renewer_kerberos_principal_name = (string)$vals['renewer_kerberos_principal_name'];
            }
        }
    }
