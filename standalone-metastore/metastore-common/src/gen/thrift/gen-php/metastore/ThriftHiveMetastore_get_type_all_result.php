...
class ThriftHiveMetastore_get_type_all_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::MAP) {
                        ...
                        $_ktype1284 = 0;
                        $_vtype1285 = 0;
                        $xfer += $input->readMapBegin($_ktype1284, $_vtype1285, $_size1283);
                        for ($_i1287 = 0; $_i1287 < $_size1283; ++$_i1287) {
                            $key1288 = '';
                            $val1289 = new \metastore\Type();
                            $xfer += $input->readString($key1288);
                            $val1289 = new \metastore\Type();
                            $xfer += $val1289->read($input);
                            $this->success[$key1288] = $val1289;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $kiter1290 => $viter1291) {
                $xfer += $output->writeString($kiter1290);
                $xfer += $viter1291->write($output);
            }
            $output->writeMapEnd();
