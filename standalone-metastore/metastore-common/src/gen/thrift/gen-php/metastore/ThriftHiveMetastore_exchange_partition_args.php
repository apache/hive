...
class ThriftHiveMetastore_exchange_partition_args
{
            ...
            switch ($fid) {
                case 1:
                    if ($ftype == TType::MAP) {
                        ...
                        $_ktype1435 = 0;
                        $_vtype1436 = 0;
                        $xfer += $input->readMapBegin($_ktype1435, $_vtype1436, $_size1434);
                        for ($_i1438 = 0; $_i1438 < $_size1434; ++$_i1438) {
                            $key1439 = '';
                            $val1440 = '';
                            $xfer += $input->readString($key1439);
                            $xfer += $input->readString($val1440);
                            $this->partitionSpecs[$key1439] = $val1440;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->partitionSpecs !== null) {
            ...
            foreach ($this->partitionSpecs as $kiter1441 => $viter1442) {
                $xfer += $output->writeString($kiter1441);
                $xfer += $output->writeString($viter1442);
            }
            $output->writeMapEnd();
