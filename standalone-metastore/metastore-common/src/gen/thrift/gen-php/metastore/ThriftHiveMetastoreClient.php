...
class ThriftHiveMetastoreClient extends \FacebookServiceClient implements \metastore\ThriftHiveMetastoreIf
{
    ...
    public function send_update_table_params(array $updates)
    {
        ...
        if ($bin_accel) {
            ...
            $this->output_->writeMessageBegin('update_table_params', TMessageType::CALL, $this->seqid_);
            $args->write($this->output_);
            $this->output_->writeMessageEnd();
            $this->output_->getTransport()->flush();
        }
    ...
    public function recv_update_table_params()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
    ...
    public function send_get_lock_materialization_rebuild_req(\metastore\LockMaterializationRebuildRequest $req)
    {
        ...
        if ($bin_accel) {
            ...
            $this->output_->writeMessageBegin('get_lock_materialization_rebuild_req', TMessageType::CALL, $this->seqid_);
            $args->write($this->output_);
            $this->output_->writeMessageEnd();
            $this->output_->getTransport()->flush();
        }
    ...
    public function recv_get_lock_materialization_rebuild_req()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
    ...
    public function send_heartbeat_lock_materialization_rebuild_req(\metastore\LockMaterializationRebuildRequest $req)
    {
        ...
        if ($bin_accel) {
            ...
            $this->output_->writeMessageBegin('heartbeat_lock_materialization_rebuild_req', TMessageType::CALL, $this->seqid_);
            $args->write($this->output_);
            $this->output_->writeMessageEnd();
            $this->output_->getTransport()->flush();
        }
    ...
    public function recv_heartbeat_lock_materialization_rebuild_req()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
