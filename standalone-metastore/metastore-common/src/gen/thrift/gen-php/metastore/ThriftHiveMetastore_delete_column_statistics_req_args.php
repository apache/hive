...
class ThriftHiveMetastore_delete_column_statistics_req_args
{
    ...
    public static array $tspec = [
        1 => [
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\metastore\DeleteColumnStatisticsRequest',
        ],
    ];

    public ?DeleteColumnStatisticsRequest $req = null;
    ...
    {
        return 'ThriftHiveMetastore_delete_column_statistics_req_args';
    }
                ...
                switch ($fid) {
                    case 1:
                        if ($ftype == TType::STRUCT) {
                            $this->req = new \metastore\DeleteColumnStatisticsRequest();
    ...
    public function write(TProtocol $output): int
    {
        ...
        try {
            $xfer += $output->writeStructBegin('ThriftHiveMetastore_delete_column_statistics_req_args');
            if ($this->req !== null) {
