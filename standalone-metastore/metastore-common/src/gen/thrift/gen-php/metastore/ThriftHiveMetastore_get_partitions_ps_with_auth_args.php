...
class ThriftHiveMetastore_get_partitions_ps_with_auth_args
{
            ...
            switch ($fid) {
                ...
                case 3:
                    if ($ftype == TType::LST) {
                        ...
                        $_size1543 = 0;
                        $_etype1546 = 0;
                        $xfer += $input->readListBegin($_etype1546, $_size1543);
                        for ($_i1547 = 0; $_i1547 < $_size1543; ++$_i1547) {
                            $elem1548 = null;
                            $xfer += $input->readString($elem1548);
                            $this->part_vals []= $elem1548;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->group_names !== null) {
            ...
            foreach ($this->group_names as $iter1556) {
