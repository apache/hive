...
class ThriftHiveMetastore_get_table_meta_args
{
    ...
    public ?string $db_patterns = null;
    public ?string $tbl_patterns = null;
    /**
     * @var string[]
     */
    public ?array $tbl_types = null;

    public function __construct(?array $vals = null)
    {
        if (is_array($vals)) {
            if (isset($vals['db_patterns'])) {
                $this->db_patterns = (string)$vals['db_patterns'];
            }
            if (isset($vals['tbl_patterns'])) {
                $this->tbl_patterns = (string)$vals['tbl_patterns'];
            }
