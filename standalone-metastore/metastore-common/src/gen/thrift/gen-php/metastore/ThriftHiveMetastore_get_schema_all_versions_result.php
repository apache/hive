...
class ThriftHiveMetastore_get_schema_all_versions_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size1900 = 0;
                        $_etype1903 = 0;
                        $xfer += $input->readListBegin($_etype1903, $_size1900);
                        for ($_i1904 = 0; $_i1904 < $_size1900; ++$_i1904) {
                            $elem1905 = null;
                            $elem1905 = new \metastore\SchemaVersion();
                            $xfer += $elem1905->read($input);
                            $this->success []= $elem1905;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter1906) {
                $xfer += $iter1906->write($output);
            }
            $output->writeListEnd();
