...
class ThriftHiveMetastore_add_erasure_policy_binding_result
{
    ...
    {
        return 'ThriftHiveMetastore_add_erasure_policy_binding_result';
    }
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::STRUCT) {
                        $this->success = new \metastore\ErasurePolicyBinding();
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('ThriftHiveMetastore_add_erasure_policy_binding_result');
