...
class ThriftHiveMetastore_add_write_notification_log_in_batch_result
{
    ...
    public static array $tspec = [
        0 => [
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\metastore\WriteNotificationLogBatchResponse',
        ],
    ];

    public ?WriteNotificationLogBatchResponse $success = null;
    ...
    {
        return 'ThriftHiveMetastore_add_write_notification_log_in_batch_result';
    }
                ...
                switch ($fid) {
                    case 0:
                        if ($ftype == TType::STRUCT) {
                            $this->success = new \metastore\WriteNotificationLogBatchResponse();
    ...
    public function write(TProtocol $output): int
    {
        ...
        try {
            $xfer += $output->writeStructBegin('ThriftHiveMetastore_add_write_notification_log_in_batch_result');
