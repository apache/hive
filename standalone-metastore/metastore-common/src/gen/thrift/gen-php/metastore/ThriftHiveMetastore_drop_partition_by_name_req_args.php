...
class ThriftHiveMetastore_drop_partition_by_name_req_args
{
    ...
    {
        return 'ThriftHiveMetastore_drop_partition_by_name_req_args';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('ThriftHiveMetastore_drop_partition_by_name_req_args');
