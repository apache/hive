...
class ThriftHiveMetastore_isPartitionMarkedForEvent_args
{
            ...
            switch ($fid) {
                ...
                case 3:
                    if ($ftype == TType::MAP) {
                        ...
                        $_ktype1791 = 0;
                        $_vtype1792 = 0;
                        $xfer += $input->readMapBegin($_ktype1791, $_vtype1792, $_size1790);
                        for ($_i1794 = 0; $_i1794 < $_size1790; ++$_i1794) {
                            $key1795 = '';
                            $val1796 = '';
                            $xfer += $input->readString($key1795);
                            $xfer += $input->readString($val1796);
                            $this->part_vals[$key1795] = $val1796;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->part_vals !== null) {
            ...
            foreach ($this->part_vals as $kiter1797 => $viter1798) {
                $xfer += $output->writeString($kiter1797);
                $xfer += $output->writeString($viter1798);
            }
            $output->writeMapEnd();
            $xfer += $output->writeFieldEnd();
        }
