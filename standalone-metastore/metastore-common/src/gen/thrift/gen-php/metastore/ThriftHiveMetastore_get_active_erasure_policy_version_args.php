...
class ThriftHiveMetastore_get_active_erasure_policy_version_args
{
    ...
    {
        return 'ThriftHiveMetastore_get_active_erasure_policy_version_args';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('ThriftHiveMetastore_get_active_erasure_policy_version_args');
