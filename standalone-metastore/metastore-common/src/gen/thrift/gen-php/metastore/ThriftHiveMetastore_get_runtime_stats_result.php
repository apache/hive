...
class ThriftHiveMetastore_get_runtime_stats_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size1907 = 0;
                        $_etype1910 = 0;
                        $xfer += $input->readListBegin($_etype1910, $_size1907);
                        for ($_i1911 = 0; $_i1911 < $_size1907; ++$_i1911) {
                            $elem1912 = null;
                            $elem1912 = new \metastore\RuntimeStat();
                            $xfer += $elem1912->read($input);
                            $this->success []= $elem1912;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter1913) {
                $xfer += $iter1913->write($output);
            }
            $output->writeListEnd();
