...
class ThriftHiveMetastore_get_partition_with_auth_args
{
            ...
            switch ($fid) {
                ...
                case 5:
                    if ($ftype == TType::LST) {
                        ...
                        $_size1668 = 0;
                        $_etype1671 = 0;
                        $xfer += $input->readListBegin($_etype1671, $_size1668);
                        for ($_i1672 = 0; $_i1672 < $_size1668; ++$_i1672) {
                            $elem1673 = null;
                            $xfer += $input->readString($elem1673);
                            $this->group_names []= $elem1673;
                        }
                        $xfer += $input->readListEnd();
                    } else {
                        $xfer += $input->skip($ftype);
    ...
    public function write($output)
    {
        ...
        if ($this->part_vals !== null) {
            ...
            foreach ($this->part_vals as $iter1674) {
                $xfer += $output->writeString($iter1674);
            }
            $output->writeListEnd();
            $xfer += $output->writeFieldEnd();
        }
        ...
        if ($this->group_names !== null) {
            ...
            foreach ($this->group_names as $iter1675) {
                $xfer += $output->writeString($iter1675);
            }
            $output->writeListEnd();
            $xfer += $output->writeFieldEnd();
        }
