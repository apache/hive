...
class ThriftHiveMetastore_get_partition_with_auth_args
{
            ...
            switch ($fid) {
                ...
                case 3:
                    if ($ftype == TType::LST) {
                        ...
                        $_size1597 = 0;
                        $_etype1600 = 0;
                        $xfer += $input->readListBegin($_etype1600, $_size1597);
                        for ($_i1601 = 0; $_i1601 < $_size1597; ++$_i1601) {
                            $elem1602 = null;
                            $xfer += $input->readString($elem1602);
                            $this->part_vals []= $elem1602;
                        }
                ...
                case 5:
                    if ($ftype == TType::LST) {
                        ...
                        $_size1603 = 0;
                        $_etype1606 = 0;
                        $xfer += $input->readListBegin($_etype1606, $_size1603);
                        for ($_i1607 = 0; $_i1607 < $_size1603; ++$_i1607) {
                            $elem1608 = null;
                            $xfer += $input->readString($elem1608);
                            $this->group_names []= $elem1608;
                        }
                        $xfer += $input->readListEnd();
                    } else {
                        $xfer += $input->skip($ftype);
    ...
    public function write($output)
    {
        ...
        if ($this->part_vals !== null) {
            ...
            foreach ($this->part_vals as $iter1609) {
                $xfer += $output->writeString($iter1609);
            }
            $output->writeListEnd();
            $xfer += $output->writeFieldEnd();
        }
        ...
        if ($this->group_names !== null) {
            ...
            foreach ($this->group_names as $iter1610) {
                $xfer += $output->writeString($iter1610);
            }
            $output->writeListEnd();
            $xfer += $output->writeFieldEnd();
        }
