...
class GetPartitionsByNamesRequest
{
    ...
    public ?bool $get_col_stats = null;
    /**
     * @var string[]
     */
    ...
    public ?bool $getFileMetadata = null;
    public ?int $id = -1;
    ...
    public function __construct(?array $vals = null)
    {
        if (is_array($vals)) {
            ...
            if (isset($vals['get_col_stats'])) {
                $this->get_col_stats = (bool)$vals['get_col_stats'];
            }
            ...
            if (isset($vals['getFileMetadata'])) {
                $this->getFileMetadata = (bool)$vals['getFileMetadata'];
            }
            if (isset($vals['id'])) {
                $this->id = (int)$vals['id'];
            }
                    ...
                    case 5:
                        if ($ftype == TType::LST) {
                            ...
                            for ($_i670 = 0; $_i670 < $_size666; ++$_i670) {
                                ...
                                $this->processorCapabilities[] = $elem671;
                            }
                            $xfer += $input->readListEnd();
                        } else {
                            $xfer += $input->skip($ftype);
    ...
    public function write(TProtocol $output): int
    {
        ...
        try {
            ...
            if ($this->processorCapabilities !== null) {
                ...
                foreach ($this->processorCapabilities as $iter673) {
