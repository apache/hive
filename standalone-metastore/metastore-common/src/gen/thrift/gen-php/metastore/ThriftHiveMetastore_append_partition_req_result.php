...
class ThriftHiveMetastore_append_partition_req_result
{
    ...
    public ?Partition $success = null;
    public ?InvalidObjectException $o1 = null;
    public ?AlreadyExistsException $o2 = null;
    ...
    {
        return 'ThriftHiveMetastore_append_partition_req_result';
    }
    ...
    public function write(TProtocol $output): int
    {
        ...
        try {
            $xfer += $output->writeStructBegin('ThriftHiveMetastore_append_partition_req_result');
