...
class AlterTableRequest
{
    ...
    public ?string $expectedParameterKey = null;
    public ?string $expectedParameterValue = null;
    ...
    public function __construct(?array $vals = null)
    {
        if (is_array($vals)) {
            ...
            if (isset($vals['expectedParameterKey'])) {
                $this->expectedParameterKey = (string)$vals['expectedParameterKey'];
            }
            if (isset($vals['expectedParameterValue'])) {
                $this->expectedParameterValue = (string)$vals['expectedParameterValue'];
            }
        }
    }
                    ...
                    case 8:
                        if ($ftype == TType::LST) {
                            ...
                            for ($_i1303 = 0; $_i1303 < $_size1299; ++$_i1303) {
                                ...
                                $this->processorCapabilities[] = $elem1304;
                            }
    ...
    public function write(TProtocol $output): int
    {
        ...
        try {
            ...
            if ($this->processorCapabilities !== null) {
                ...
                foreach ($this->processorCapabilities as $iter1305) {
