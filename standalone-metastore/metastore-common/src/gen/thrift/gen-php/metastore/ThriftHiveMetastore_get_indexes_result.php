...
class ThriftHiveMetastore_get_indexes_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size2024 = 0;
                        $_etype2027 = 0;
                        $xfer += $input->readListBegin($_etype2027, $_size2024);
                        for ($_i2028 = 0; $_i2028 < $_size2024; ++$_i2028) {
                            $elem2029 = null;
                            $elem2029 = new \metastore\Index();
                            $xfer += $elem2029->read($input);
                            $this->success []= $elem2029;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter2030) {
                $xfer += $iter2030->write($output);
            }
            $output->writeListEnd();
