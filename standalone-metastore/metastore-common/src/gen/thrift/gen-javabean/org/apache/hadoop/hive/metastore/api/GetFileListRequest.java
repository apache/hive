...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class GetFileListRequest implements org.apache.thrift.TBase<GetFileListRequest, GetFileListRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetFileListRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetFileListRequest");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new GetFileListRequestStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new GetFileListRequestTupleSchemeFactory();
  ...
  private static final _Fields optionals[] = {_Fields.CAT_NAME,_Fields.DB_NAME,_Fields.TABLE_NAME,_Fields.PART_VALS,_Fields.VALID_WRITE_ID_LIST};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetFileListRequest.class, metaDataMap);
  }
   ...
   */
  public GetFileListRequest(GetFileListRequest other) {
  ...
  public GetFileListRequest deepCopy() {
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof GetFileListRequest)
      return this.equals((GetFileListRequest)that);
    return false;
  }

  public boolean equals(GetFileListRequest that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(GetFileListRequest other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetPartVals()).compareTo(other.isSetPartVals());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPartVals()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("GetFileListRequest(");
    boolean first = true;
  ...
  private static class GetFileListRequestStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public GetFileListRequestStandardScheme getScheme() {
      return new GetFileListRequestStandardScheme();
    }
  }

  private static class GetFileListRequestStandardScheme extends org.apache.thrift.scheme.StandardScheme<GetFileListRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetFileListRequest struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partVals = new java.util.ArrayList<java.lang.String>(_list1192.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetFileListRequest struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.partVals != null) {
        if (struct.isSetPartVals()) {
          oprot.writeFieldBegin(PART_VALS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter1195 : struct.partVals)
            {
              oprot.writeString(_iter1195);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class GetFileListRequestTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public GetFileListRequestTupleScheme getScheme() {
      return new GetFileListRequestTupleScheme();
    }
  }

  private static class GetFileListRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<GetFileListRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetFileListRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetPartVals()) {
        {
          ...
          for (java.lang.String _iter1196 : struct.partVals)
          {
            oprot.writeString(_iter1196);
          }
        }
      }
      if (struct.isSetValidWriteIdList()) {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetFileListRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.partVals = new java.util.ArrayList<java.lang.String>(_list1197.size);
