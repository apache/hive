...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class CreateDatabaseRequest implements org.apache.thrift.TBase<CreateDatabaseRequest, CreateDatabaseRequest._Fields>, java.io.Serializable, Cloneable, Comparable<CreateDatabaseRequest> {
        ...
        switch (schemeField.id) {
          ...
          case 4: // PARAMETERS
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                org.apache.thrift.protocol.TMap _map1278 = iprot.readMapBegin();
                struct.parameters = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map1278.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key1279;
                @org.apache.thrift.annotation.Nullable java.lang.String _val1280;
                for (int _i1281 = 0; _i1281 < _map1278.size; ++_i1281)
                {
                  _key1279 = iprot.readString();
                  _val1280 = iprot.readString();
                  struct.parameters.put(_key1279, _val1280);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.parameters != null) {
        if (struct.isSetParameters()) {
          oprot.writeFieldBegin(PARAMETERS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter1282 : struct.parameters.entrySet())
            {
              oprot.writeString(_iter1282.getKey());
              oprot.writeString(_iter1282.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class CreateDatabaseRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<CreateDatabaseRequest> {
      ...
      if (struct.isSetParameters()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter1283 : struct.parameters.entrySet())
          {
            oprot.writeString(_iter1283.getKey());
            oprot.writeString(_iter1283.getValue());
          }
        }
      }
      if (struct.isSetPrivileges()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, CreateDatabaseRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map1284 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING); 
          struct.parameters = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map1284.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _key1285;
          @org.apache.thrift.annotation.Nullable java.lang.String _val1286;
          for (int _i1287 = 0; _i1287 < _map1284.size; ++_i1287)
          {
            _key1285 = iprot.readString();
            _val1286 = iprot.readString();
            struct.parameters.put(_key1285, _val1286);
          }
        }
        struct.setParametersIsSet(true);
      }
