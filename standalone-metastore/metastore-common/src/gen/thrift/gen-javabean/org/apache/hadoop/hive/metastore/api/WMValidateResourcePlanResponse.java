      ...
      if (struct.errors != null) {
        if (struct.isSetErrors()) {
          oprot.writeFieldBegin(ERRORS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter1188 : struct.errors)
            {
      ...
      if (struct.warnings != null) {
        if (struct.isSetWarnings()) {
          oprot.writeFieldBegin(WARNINGS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter1189 : struct.warnings)
            {
      ...
      if (struct.isSetErrors()) {
        {
          ...
          for (java.lang.String _iter1190 : struct.errors)
          {
      ...
      if (struct.isSetWarnings()) {
        {
          ...
          for (java.lang.String _iter1191 : struct.warnings)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.errors = new java.util.ArrayList<java.lang.String>(_list1192.size);
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.warnings = new java.util.ArrayList<java.lang.String>(_list1195.size);
