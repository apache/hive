...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class HiveObjectPrivilege implements org.apache.thrift.TBase<HiveObjectPrivilege, HiveObjectPrivilege._Fields>, java.io.Serializable, Cloneable, Comparable<HiveObjectPrivilege> {
  ...
  public int compareTo(HiveObjectPrivilege other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetHiveObject()).compareTo(other.isSetHiveObject());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetGrantInfo()).compareTo(other.isSetGrantInfo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetGrantInfo()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAuthorizer()).compareTo(other.isSetAuthorizer());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAuthorizer()) {
