...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class TxnInfo implements org.apache.thrift.TBase<TxnInfo, TxnInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TxnInfo> {
  ...
  public int compareTo(TxnInfo other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetHeartbeatCount()).compareTo(other.isSetHeartbeatCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHeartbeatCount()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetStartedTime()).compareTo(other.isSetStartedTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStartedTime()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetLastHeartbeatTime()).compareTo(other.isSetLastHeartbeatTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLastHeartbeatTime()) {
