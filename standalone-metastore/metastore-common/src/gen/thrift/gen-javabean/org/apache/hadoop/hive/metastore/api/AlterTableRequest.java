            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.processorCapabilities = new java.util.ArrayList<java.lang.String>(_list1440.size);
                ...
                for (int _i1442 = 0; _i1442 < _list1440.size; ++_i1442)
                {
                  ...
                  struct.processorCapabilities.add(_elem1441);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.processorCapabilities != null) {
        if (struct.isSetProcessorCapabilities()) {
          oprot.writeFieldBegin(PROCESSOR_CAPABILITIES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter1443 : struct.processorCapabilities)
            {
      ...
      if (struct.isSetProcessorCapabilities()) {
        {
          ...
          for (java.lang.String _iter1444 : struct.processorCapabilities)
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.processorCapabilities = new java.util.ArrayList<java.lang.String>(_list1445.size);
          ...
          for (int _i1447 = 0; _i1447 < _list1445.size; ++_i1447)
          {
            ...
            struct.processorCapabilities.add(_elem1446);
          }
        }
        struct.setProcessorCapabilitiesIsSet(true);
      }
