            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.processorCapabilities = new java.util.ArrayList<java.lang.String>(_list1304.size);
                ...
                for (int _i1306 = 0; _i1306 < _list1304.size; ++_i1306)
                {
                  ...
                  struct.processorCapabilities.add(_elem1305);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.processorCapabilities != null) {
        if (struct.isSetProcessorCapabilities()) {
          oprot.writeFieldBegin(PROCESSOR_CAPABILITIES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter1307 : struct.processorCapabilities)
            {
      ...
      if (struct.isSetProcessorCapabilities()) {
        {
          ...
          for (java.lang.String _iter1308 : struct.processorCapabilities)
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.processorCapabilities = new java.util.ArrayList<java.lang.String>(_list1309.size);
          ...
          for (int _i1311 = 0; _i1311 < _list1309.size; ++_i1311)
          {
            ...
            struct.processorCapabilities.add(_elem1310);
          }
        }
        struct.setProcessorCapabilitiesIsSet(true);
      }
