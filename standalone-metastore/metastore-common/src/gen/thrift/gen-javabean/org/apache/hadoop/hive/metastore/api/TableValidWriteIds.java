...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class TableValidWriteIds implements org.apache.thrift.TBase<TableValidWriteIds, TableValidWriteIds._Fields>, java.io.Serializable, Cloneable, Comparable<TableValidWriteIds> {
  ...
  public int compareTo(TableValidWriteIds other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetFullTableName()).compareTo(other.isSetFullTableName());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetWriteIdHighWaterMark()).compareTo(other.isSetWriteIdHighWaterMark());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetMinOpenWriteId()).compareTo(other.isSetMinOpenWriteId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMinOpenWriteId()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.invalidWriteIds = new java.util.ArrayList<java.lang.Long>(_list690.size);
                long _elem691;
                for (int _i692 = 0; _i692 < _list690.size; ++_i692)
                {
                  _elem691 = iprot.readI64();
                  struct.invalidWriteIds.add(_elem691);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TableValidWriteIds struct) throws org.apache.thrift.TException {
      ...
      if (struct.invalidWriteIds != null) {
        oprot.writeFieldBegin(INVALID_WRITE_IDS_FIELD_DESC);
        {
          ...
          for (long _iter693 : struct.invalidWriteIds)
          {
            oprot.writeI64(_iter693);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TableValidWriteIdsTupleScheme extends org.apache.thrift.scheme.TupleScheme<TableValidWriteIds> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TableValidWriteIds struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.writeIdHighWaterMark);
      {
        ...
        for (long _iter694 : struct.invalidWriteIds)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TableValidWriteIds struct) throws org.apache.thrift.TException {
      ...
      struct.setWriteIdHighWaterMarkIsSet(true);
      {
        org.apache.thrift.protocol.TList _list695 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
        struct.invalidWriteIds = new java.util.ArrayList<java.lang.Long>(_list695.size);
        long _elem696;
        for (int _i697 = 0; _i697 < _list695.size; ++_i697)
        {
          _elem696 = iprot.readI64();
          struct.invalidWriteIds.add(_elem696);
        }
      }
      struct.setInvalidWriteIdsIsSet(true);
      struct.abortedBits = iprot.readBinary();
