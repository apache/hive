              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.cols = new java.util.ArrayList<FieldSchema>(_list286.size);
                  @org.apache.thrift.annotation.Nullable FieldSchema _elem287;
                  for (int _i288 = 0; _i288 < _list286.size; ++_i288)
                  {
                    _elem287 = new FieldSchema();
                    _elem287.read(iprot);
                    struct.cols.add(_elem287);
                  }
                  iprot.readListEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.bucketCols = new java.util.ArrayList<java.lang.String>(_list289.size);
                  ...
                  for (int _i291 = 0; _i291 < _list289.size; ++_i291)
                  {
                    ...
                    struct.bucketCols.add(_elem290);
                  }
                  iprot.readListEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.sortCols = new java.util.ArrayList<Order>(_list292.size);
                  @org.apache.thrift.annotation.Nullable Order _elem293;
                  for (int _i294 = 0; _i294 < _list292.size; ++_i294)
                  {
                    _elem293 = new Order();
                    _elem293.read(iprot);
                    struct.sortCols.add(_elem293);
                  }
                  iprot.readListEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.parameters = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map295.size);
                  @org.apache.thrift.annotation.Nullable java.lang.String _key296;
                  @org.apache.thrift.annotation.Nullable java.lang.String _val297;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StorageDescriptor struct) throws org.apache.thrift.TException {
      ...
      if (struct.bucketCols != null) {
        oprot.writeFieldBegin(BUCKET_COLS_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter300 : struct.bucketCols)
          {
      ...
      if (struct.sortCols != null) {
        oprot.writeFieldBegin(SORT_COLS_FIELD_DESC);
        {
          ...
          for (Order _iter301 : struct.sortCols)
          {
      ...
      if (struct.parameters != null) {
        oprot.writeFieldBegin(PARAMETERS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter302 : struct.parameters.entrySet())
          {
  ...
  private static class StorageDescriptorTupleScheme extends org.apache.thrift.scheme.TupleScheme<StorageDescriptor> {
      ...
      if (struct.isSetBucketCols()) {
        {
          ...
          for (java.lang.String _iter304 : struct.bucketCols)
          {
      ...
      if (struct.isSetSortCols()) {
        {
          ...
          for (Order _iter305 : struct.sortCols)
          {
      ...
      if (struct.isSetParameters()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter306 : struct.parameters.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, StorageDescriptor struct) throws org.apache.thrift.TException {
      ...
      try {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.cols = new java.util.ArrayList<FieldSchema>(_list307.size);
            @org.apache.thrift.annotation.Nullable FieldSchema _elem308;
            for (int _i309 = 0; _i309 < _list307.size; ++_i309)
            {
              _elem308 = new FieldSchema();
              _elem308.read(iprot);
              struct.cols.add(_elem308);
            }
          }
          struct.setColsIsSet(true);
        }
        ...
        if (incoming.get(7)) {
          {
            org.apache.thrift.protocol.TList _list310 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
            struct.bucketCols = new java.util.ArrayList<java.lang.String>(_list310.size);
            ...
            for (int _i312 = 0; _i312 < _list310.size; ++_i312)
            {
              ...
              struct.bucketCols.add(_elem311);
            }
          }
          struct.bucketCols = org.apache.hadoop.hive.metastore.utils.StringUtils.intern(struct.bucketCols); struct.setBucketColsIsSet(true);
        }
        if (incoming.get(8)) {
          {
            ...
            struct.sortCols = new java.util.ArrayList<Order>(_list313.size);
            @org.apache.thrift.annotation.Nullable Order _elem314;
            for (int _i315 = 0; _i315 < _list313.size; ++_i315)
            {
              _elem314 = new Order();
              _elem314.read(iprot);
              struct.sortCols.add(_elem314);
            }
          }
          struct.setSortColsIsSet(true);
        }
        if (incoming.get(9)) {
          {
            ...
            struct.parameters = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map316.size);
