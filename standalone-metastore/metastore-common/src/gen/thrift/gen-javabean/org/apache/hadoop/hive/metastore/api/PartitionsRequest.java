...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class PartitionsRequest implements org.apache.thrift.TBase<PartitionsRequest, PartitionsRequest._Fields>, java.io.Serializable, Cloneable, Comparable<PartitionsRequest> {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PartitionsRequest(");
    boolean first = true;
  ...
  private static class PartitionsRequestStandardSchemeFactory implements SchemeFactory {
    public PartitionsRequestStandardScheme getScheme() {
      return new PartitionsRequestStandardScheme();
    }
  }

  private static class PartitionsRequestStandardScheme extends StandardScheme<PartitionsRequest> {
  ...
  private static class PartitionsRequestTupleSchemeFactory implements SchemeFactory {
    public PartitionsRequestTupleScheme getScheme() {
      return new PartitionsRequestTupleScheme();
    }
  }

  private static class PartitionsRequestTupleScheme extends TupleScheme<PartitionsRequest> {
