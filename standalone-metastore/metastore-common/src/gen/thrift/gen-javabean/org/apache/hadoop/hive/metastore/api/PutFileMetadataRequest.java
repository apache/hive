      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fileIds = new java.util.ArrayList<java.lang.Long>(_list962.size);
                long _elem963;
                for (int _i964 = 0; _i964 < _list962.size; ++_i964)
                {
                  _elem963 = iprot.readI64();
                  struct.fileIds.add(_elem963);
                }
                iprot.readListEnd();
              }
          ...
          case 2: // METADATA
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list965 = iprot.readListBegin();
                struct.metadata = new java.util.ArrayList<java.nio.ByteBuffer>(_list965.size);
                @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer _elem966;
                for (int _i967 = 0; _i967 < _list965.size; ++_i967)
                {
                  _elem966 = iprot.readBinary();
                  struct.metadata.add(_elem966);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PutFileMetadataRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.fileIds != null) {
        oprot.writeFieldBegin(FILE_IDS_FIELD_DESC);
        {
          ...
          for (long _iter968 : struct.fileIds)
          {
            oprot.writeI64(_iter968);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.metadata != null) {
        oprot.writeFieldBegin(METADATA_FIELD_DESC);
        {
          ...
          for (java.nio.ByteBuffer _iter969 : struct.metadata)
          {
            oprot.writeBinary(_iter969);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class PutFileMetadataRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<PutFileMetadataRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, PutFileMetadataRequest struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (long _iter970 : struct.fileIds)
        {
          oprot.writeI64(_iter970);
        }
      }
      {
        oprot.writeI32(struct.metadata.size());
        for (java.nio.ByteBuffer _iter971 : struct.metadata)
        {
          oprot.writeBinary(_iter971);
        }
      }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, PutFileMetadataRequest struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TList _list972 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
        struct.fileIds = new java.util.ArrayList<java.lang.Long>(_list972.size);
        long _elem973;
        for (int _i974 = 0; _i974 < _list972.size; ++_i974)
        {
          _elem973 = iprot.readI64();
          struct.fileIds.add(_elem973);
        }
      }
      struct.setFileIdsIsSet(true);
      {
        ...
        struct.metadata = new java.util.ArrayList<java.nio.ByteBuffer>(_list975.size);
        @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer _elem976;
        for (int _i977 = 0; _i977 < _list975.size; ++_i977)
        {
          _elem976 = iprot.readBinary();
          struct.metadata.add(_elem976);
        }
      }
      struct.setMetadataIsSet(true);
