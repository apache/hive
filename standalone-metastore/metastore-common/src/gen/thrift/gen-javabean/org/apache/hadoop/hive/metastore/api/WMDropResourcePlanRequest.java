...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class WMDropResourcePlanRequest implements org.apache.thrift.TBase<WMDropResourcePlanRequest, WMDropResourcePlanRequest._Fields>, java.io.Serializable, Cloneable, Comparable<WMDropResourcePlanRequest> {
  ...
  static {
    schemes.put(StandardScheme.class, new WMDropResourcePlanRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new WMDropResourcePlanRequestTupleSchemeFactory());
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("WMDropResourcePlanRequest(");
    boolean first = true;
  ...
  private static class WMDropResourcePlanRequestStandardSchemeFactory implements SchemeFactory {
    public WMDropResourcePlanRequestStandardScheme getScheme() {
      return new WMDropResourcePlanRequestStandardScheme();
    }
  }

  private static class WMDropResourcePlanRequestStandardScheme extends StandardScheme<WMDropResourcePlanRequest> {
  ...
  private static class WMDropResourcePlanRequestTupleSchemeFactory implements SchemeFactory {
    public WMDropResourcePlanRequestTupleScheme getScheme() {
      return new WMDropResourcePlanRequestTupleScheme();
    }
  }

  private static class WMDropResourcePlanRequestTupleScheme extends TupleScheme<WMDropResourcePlanRequest> {
