...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class Type implements org.apache.thrift.TBase<Type, Type._Fields>, java.io.Serializable, Cloneable, Comparable<Type> {
  ...
  public int compareTo(Type other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetType1()).compareTo(other.isSetType1());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetType1()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetType2()).compareTo(other.isSetType2());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetType2()) {
