...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class UniqueConstraintsResponse implements org.apache.thrift.TBase<UniqueConstraintsResponse, UniqueConstraintsResponse._Fields>, java.io.Serializable, Cloneable, Comparable<UniqueConstraintsResponse> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new UniqueConstraintsResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new UniqueConstraintsResponseTupleSchemeFactory();

  private @org.apache.thrift.annotation.Nullable java.util.List<SQLUniqueConstraint> uniqueConstraints; // required
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("UniqueConstraintsResponse(");
    boolean first = true;
  ...
  private static class UniqueConstraintsResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public UniqueConstraintsResponseStandardScheme getScheme() {
      return new UniqueConstraintsResponseStandardScheme();
    }
  }

  private static class UniqueConstraintsResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<UniqueConstraintsResponse> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.uniqueConstraints = new java.util.ArrayList<SQLUniqueConstraint>(_list488.size);
                @org.apache.thrift.annotation.Nullable SQLUniqueConstraint _elem489;
                for (int _i490 = 0; _i490 < _list488.size; ++_i490)
                {
                  _elem489 = new SQLUniqueConstraint();
                  _elem489.read(iprot);
                  struct.uniqueConstraints.add(_elem489);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UniqueConstraintsResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.uniqueConstraints != null) {
        oprot.writeFieldBegin(UNIQUE_CONSTRAINTS_FIELD_DESC);
        {
          ...
          for (SQLUniqueConstraint _iter491 : struct.uniqueConstraints)
          {
  ...
  private static class UniqueConstraintsResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public UniqueConstraintsResponseTupleScheme getScheme() {
      return new UniqueConstraintsResponseTupleScheme();
    }
  }

  private static class UniqueConstraintsResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<UniqueConstraintsResponse> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, UniqueConstraintsResponse struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (SQLUniqueConstraint _iter492 : struct.uniqueConstraints)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, UniqueConstraintsResponse struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        struct.uniqueConstraints = new java.util.ArrayList<SQLUniqueConstraint>(_list493.size);
        @org.apache.thrift.annotation.Nullable SQLUniqueConstraint _elem494;
        for (int _i495 = 0; _i495 < _list493.size; ++_i495)
        {
          _elem494 = new SQLUniqueConstraint();
          _elem494.read(iprot);
          struct.uniqueConstraints.add(_elem494);
        }
      }
      struct.setUniqueConstraintsIsSet(true);
    }
