...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class GetPartitionsByNamesRequest implements org.apache.thrift.TBase<GetPartitionsByNamesRequest, GetPartitionsByNamesRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetPartitionsByNamesRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.names = new java.util.ArrayList<java.lang.String>(_list748.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem749;
                for (int _i750 = 0; _i750 < _list748.size; ++_i750)
                {
                  _elem749 = iprot.readString();
                  struct.names.add(_elem749);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.processorCapabilities = new java.util.ArrayList<java.lang.String>(_list751.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem752;
                for (int _i753 = 0; _i753 < _list751.size; ++_i753)
                {
                  _elem752 = iprot.readString();
                  struct.processorCapabilities.add(_elem752);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.names != null) {
        if (struct.isSetNames()) {
          oprot.writeFieldBegin(NAMES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter754 : struct.names)
            {
      ...
      if (struct.processorCapabilities != null) {
        if (struct.isSetProcessorCapabilities()) {
          oprot.writeFieldBegin(PROCESSOR_CAPABILITIES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter755 : struct.processorCapabilities)
            {
  ...
  private static class GetPartitionsByNamesRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<GetPartitionsByNamesRequest> {
      ...
      if (struct.isSetNames()) {
        {
          ...
          for (java.lang.String _iter756 : struct.names)
          {
      ...
      if (struct.isSetProcessorCapabilities()) {
        {
          ...
          for (java.lang.String _iter757 : struct.processorCapabilities)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, GetPartitionsByNamesRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list758 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
          struct.names = new java.util.ArrayList<java.lang.String>(_list758.size);
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list761 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
          struct.processorCapabilities = new java.util.ArrayList<java.lang.String>(_list761.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem762;
          for (int _i763 = 0; _i763 < _list761.size; ++_i763)
          {
            _elem762 = iprot.readString();
            struct.processorCapabilities.add(_elem762);
          }
        }
        struct.setProcessorCapabilitiesIsSet(true);
      }
