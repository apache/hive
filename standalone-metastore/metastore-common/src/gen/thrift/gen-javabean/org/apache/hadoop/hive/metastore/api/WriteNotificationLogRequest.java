...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class WriteNotificationLogRequest implements org.apache.thrift.TBase<WriteNotificationLogRequest, WriteNotificationLogRequest._Fields>, java.io.Serializable, Cloneable, Comparable<WriteNotificationLogRequest> {
  ...
  private static final org.apache.thrift.protocol.TField CAT_FIELD_DESC = new org.apache.thrift.protocol.TField("cat", org.apache.thrift.protocol.TType.STRING, (short)7);
  ...
  private @org.apache.thrift.annotation.Nullable java.lang.String cat; // optional
  ...
  private static final _Fields optionals[] = {_Fields.PARTITION_VALS,_Fields.CAT};
  ...
  public void setCat(@org.apache.thrift.annotation.Nullable java.lang.String cat) {
    this.cat = cat;
  }
  ...
  public int compareTo(WriteNotificationLogRequest other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetCat(), other.isSetCat());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCat()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitionVals = new java.util.ArrayList<java.lang.String>(_list1116.size);
                ...
                for (int _i1118 = 0; _i1118 < _list1116.size; ++_i1118)
                {
                  ...
                  struct.partitionVals.add(_elem1117);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.partitionVals != null) {
        if (struct.isSetPartitionVals()) {
          oprot.writeFieldBegin(PARTITION_VALS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter1119 : struct.partitionVals)
            {
      ...
      if (struct.isSetPartitionVals()) {
        {
          ...
          for (java.lang.String _iter1120 : struct.partitionVals)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.partitionVals = new java.util.ArrayList<java.lang.String>(_list1121.size);
          ...
          for (int _i1123 = 0; _i1123 < _list1121.size; ++_i1123)
          {
            ...
            struct.partitionVals.add(_elem1122);
          }
        }
        struct.setPartitionValsIsSet(true);
      }
