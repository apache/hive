            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitionVals = new java.util.ArrayList<java.lang.String>(_list924.size);
                ...
                for (int _i926 = 0; _i926 < _list924.size; ++_i926)
                {
                  ...
                  struct.partitionVals.add(_elem925);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.partitionVals != null) {
        if (struct.isSetPartitionVals()) {
          oprot.writeFieldBegin(PARTITION_VALS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter927 : struct.partitionVals)
            {
      ...
      if (struct.isSetPartitionVals()) {
        {
          ...
          for (java.lang.String _iter928 : struct.partitionVals)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.partitionVals = new java.util.ArrayList<java.lang.String>(_list929.size);
          ...
          for (int _i931 = 0; _i931 < _list929.size; ++_i931)
          {
            ...
            struct.partitionVals.add(_elem930);
          }
        }
        struct.setPartitionValsIsSet(true);
      }
