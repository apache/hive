...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class GetPartitionsPsWithAuthRequest implements org.apache.thrift.TBase<GetPartitionsPsWithAuthRequest, GetPartitionsPsWithAuthRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetPartitionsPsWithAuthRequest> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partVals = new java.util.ArrayList<java.lang.String>(_list1398.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem1399;
                for (int _i1400 = 0; _i1400 < _list1398.size; ++_i1400)
                {
                  _elem1399 = iprot.readString();
                  struct.partVals.add(_elem1399);
                }
                iprot.readListEnd();
              }
          ...
          case 7: // GROUP_NAMES
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1401 = iprot.readListBegin();
                struct.groupNames = new java.util.ArrayList<java.lang.String>(_list1401.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem1402;
                for (int _i1403 = 0; _i1403 < _list1401.size; ++_i1403)
                {
                  _elem1402 = iprot.readString();
                  struct.groupNames.add(_elem1402);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.groupNames != null) {
        if (struct.isSetGroupNames()) {
          oprot.writeFieldBegin(GROUP_NAMES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter1405 : struct.groupNames)
            {
  ...
  private static class GetPartitionsPsWithAuthRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<GetPartitionsPsWithAuthRequest> {
      ...
      if (struct.isSetPartVals()) {
        {
          ...
          for (java.lang.String _iter1406 : struct.partVals)
          {
      ...
      if (struct.isSetGroupNames()) {
        {
          ...
          for (java.lang.String _iter1407 : struct.groupNames)
          {
            oprot.writeString(_iter1407);
          }
        }
      }
      if (struct.isSetValidWriteIdList()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, GetPartitionsPsWithAuthRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list1408 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
          struct.partVals = new java.util.ArrayList<java.lang.String>(_list1408.size);
      ...
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TList _list1411 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
          struct.groupNames = new java.util.ArrayList<java.lang.String>(_list1411.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem1412;
          for (int _i1413 = 0; _i1413 < _list1411.size; ++_i1413)
          {
            _elem1412 = iprot.readString();
            struct.groupNames.add(_elem1412);
          }
        }
        struct.setGroupNamesIsSet(true);
      }
