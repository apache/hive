...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class GetPartitionsPsWithAuthRequest implements org.apache.thrift.TBase<GetPartitionsPsWithAuthRequest, GetPartitionsPsWithAuthRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetPartitionsPsWithAuthRequest> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partVals = new java.util.ArrayList<java.lang.String>(_list1272.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem1273;
                for (int _i1274 = 0; _i1274 < _list1272.size; ++_i1274)
                {
                  _elem1273 = iprot.readString();
                  struct.partVals.add(_elem1273);
                }
                iprot.readListEnd();
              }
          ...
          case 7: // GROUP_NAMES
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1275 = iprot.readListBegin();
                struct.groupNames = new java.util.ArrayList<java.lang.String>(_list1275.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem1276;
                for (int _i1277 = 0; _i1277 < _list1275.size; ++_i1277)
                {
                  _elem1276 = iprot.readString();
                  struct.groupNames.add(_elem1276);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.partVals != null) {
        if (struct.isSetPartVals()) {
          oprot.writeFieldBegin(PART_VALS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter1278 : struct.partVals)
            {
      ...
      if (struct.groupNames != null) {
        if (struct.isSetGroupNames()) {
          oprot.writeFieldBegin(GROUP_NAMES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter1279 : struct.groupNames)
            {
  ...
  private static class GetPartitionsPsWithAuthRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<GetPartitionsPsWithAuthRequest> {
      ...
      if (struct.isSetPartVals()) {
        {
          ...
          for (java.lang.String _iter1280 : struct.partVals)
          {
            oprot.writeString(_iter1280);
          }
        }
      }
      if (struct.isSetMaxParts()) {
      ...
      if (struct.isSetGroupNames()) {
        {
          ...
          for (java.lang.String _iter1281 : struct.groupNames)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, GetPartitionsPsWithAuthRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list1282 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.partVals = new java.util.ArrayList<java.lang.String>(_list1282.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem1283;
          for (int _i1284 = 0; _i1284 < _list1282.size; ++_i1284)
          {
            _elem1283 = iprot.readString();
            struct.partVals.add(_elem1283);
          }
        }
        struct.setPartValsIsSet(true);
      }
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.groupNames = new java.util.ArrayList<java.lang.String>(_list1285.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem1286;
          for (int _i1287 = 0; _i1287 < _list1285.size; ++_i1287)
          {
            _elem1286 = iprot.readString();
            struct.groupNames.add(_elem1286);
          }
        }
        struct.setGroupNamesIsSet(true);
      }
