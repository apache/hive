            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.schemaVersions = new ArrayList<ISchemaVersionDescriptor>(_list944.size);
                ISchemaVersionDescriptor _elem945;
                for (int _i946 = 0; _i946 < _list944.size; ++_i946)
                {
                  _elem945 = new ISchemaVersionDescriptor();
                  _elem945.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FindSchemasByColsResp struct) throws org.apache.thrift.TException {
      ...
      if (struct.schemaVersions != null) {
        oprot.writeFieldBegin(SCHEMA_VERSIONS_FIELD_DESC);
        {
          ...
          for (ISchemaVersionDescriptor _iter947 : struct.schemaVersions)
          {
      ...
      if (struct.isSetSchemaVersions()) {
        {
          ...
          for (ISchemaVersionDescriptor _iter948 : struct.schemaVersions)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.schemaVersions = new ArrayList<ISchemaVersionDescriptor>(_list949.size);
          ISchemaVersionDescriptor _elem950;
          for (int _i951 = 0; _i951 < _list949.size; ++_i951)
          {
            _elem950 = new ISchemaVersionDescriptor();
            _elem950.read(iprot);
