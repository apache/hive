...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class CreateTableRequest implements org.apache.thrift.TBase<CreateTableRequest, CreateTableRequest._Fields>, java.io.Serializable, Cloneable, Comparable<CreateTableRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.primaryKeys = new java.util.ArrayList<SQLPrimaryKey>(_list1222.size);
                @org.apache.thrift.annotation.Nullable SQLPrimaryKey _elem1223;
                for (int _i1224 = 0; _i1224 < _list1222.size; ++_i1224)
                {
                  _elem1223 = new SQLPrimaryKey();
                  _elem1223.read(iprot);
                  struct.primaryKeys.add(_elem1223);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.foreignKeys = new java.util.ArrayList<SQLForeignKey>(_list1225.size);
                @org.apache.thrift.annotation.Nullable SQLForeignKey _elem1226;
                for (int _i1227 = 0; _i1227 < _list1225.size; ++_i1227)
                {
                  _elem1226 = new SQLForeignKey();
                  _elem1226.read(iprot);
                  struct.foreignKeys.add(_elem1226);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.uniqueConstraints = new java.util.ArrayList<SQLUniqueConstraint>(_list1228.size);
                @org.apache.thrift.annotation.Nullable SQLUniqueConstraint _elem1229;
                for (int _i1230 = 0; _i1230 < _list1228.size; ++_i1230)
                {
                  _elem1229 = new SQLUniqueConstraint();
                  _elem1229.read(iprot);
                  struct.uniqueConstraints.add(_elem1229);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.notNullConstraints = new java.util.ArrayList<SQLNotNullConstraint>(_list1231.size);
                @org.apache.thrift.annotation.Nullable SQLNotNullConstraint _elem1232;
                for (int _i1233 = 0; _i1233 < _list1231.size; ++_i1233)
                {
                  _elem1232 = new SQLNotNullConstraint();
                  _elem1232.read(iprot);
                  struct.notNullConstraints.add(_elem1232);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.defaultConstraints = new java.util.ArrayList<SQLDefaultConstraint>(_list1234.size);
                @org.apache.thrift.annotation.Nullable SQLDefaultConstraint _elem1235;
                for (int _i1236 = 0; _i1236 < _list1234.size; ++_i1236)
                {
                  _elem1235 = new SQLDefaultConstraint();
                  _elem1235.read(iprot);
                  struct.defaultConstraints.add(_elem1235);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.checkConstraints = new java.util.ArrayList<SQLCheckConstraint>(_list1237.size);
                @org.apache.thrift.annotation.Nullable SQLCheckConstraint _elem1238;
                for (int _i1239 = 0; _i1239 < _list1237.size; ++_i1239)
                {
                  _elem1238 = new SQLCheckConstraint();
                  _elem1238.read(iprot);
                  struct.checkConstraints.add(_elem1238);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.processorCapabilities = new java.util.ArrayList<java.lang.String>(_list1240.size);
                ...
                for (int _i1242 = 0; _i1242 < _list1240.size; ++_i1242)
                {
                  ...
                  struct.processorCapabilities.add(_elem1241);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.primaryKeys != null) {
        if (struct.isSetPrimaryKeys()) {
          oprot.writeFieldBegin(PRIMARY_KEYS_FIELD_DESC);
          {
            ...
            for (SQLPrimaryKey _iter1243 : struct.primaryKeys)
            {
      ...
      if (struct.foreignKeys != null) {
        if (struct.isSetForeignKeys()) {
          oprot.writeFieldBegin(FOREIGN_KEYS_FIELD_DESC);
          {
            ...
            for (SQLForeignKey _iter1244 : struct.foreignKeys)
            {
      ...
      if (struct.uniqueConstraints != null) {
        if (struct.isSetUniqueConstraints()) {
          oprot.writeFieldBegin(UNIQUE_CONSTRAINTS_FIELD_DESC);
          {
            ...
            for (SQLUniqueConstraint _iter1245 : struct.uniqueConstraints)
            {
      ...
      if (struct.notNullConstraints != null) {
        if (struct.isSetNotNullConstraints()) {
          oprot.writeFieldBegin(NOT_NULL_CONSTRAINTS_FIELD_DESC);
          {
            ...
            for (SQLNotNullConstraint _iter1246 : struct.notNullConstraints)
            {
      ...
      if (struct.defaultConstraints != null) {
        if (struct.isSetDefaultConstraints()) {
          oprot.writeFieldBegin(DEFAULT_CONSTRAINTS_FIELD_DESC);
          {
            ...
            for (SQLDefaultConstraint _iter1247 : struct.defaultConstraints)
            {
      ...
      if (struct.checkConstraints != null) {
        if (struct.isSetCheckConstraints()) {
          oprot.writeFieldBegin(CHECK_CONSTRAINTS_FIELD_DESC);
          {
            ...
            for (SQLCheckConstraint _iter1248 : struct.checkConstraints)
            {
  ...
  private static class CreateTableRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<CreateTableRequest> {
      ...
      if (struct.isSetProcessorCapabilities()) {
        {
          ...
          for (java.lang.String _iter1256 : struct.processorCapabilities)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, CreateTableRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list1257 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.primaryKeys = new java.util.ArrayList<SQLPrimaryKey>(_list1257.size);
          @org.apache.thrift.annotation.Nullable SQLPrimaryKey _elem1258;
          for (int _i1259 = 0; _i1259 < _list1257.size; ++_i1259)
          {
            _elem1258 = new SQLPrimaryKey();
            _elem1258.read(iprot);
            struct.primaryKeys.add(_elem1258);
          }
        }
        struct.setPrimaryKeysIsSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list1260 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.foreignKeys = new java.util.ArrayList<SQLForeignKey>(_list1260.size);
          @org.apache.thrift.annotation.Nullable SQLForeignKey _elem1261;
          for (int _i1262 = 0; _i1262 < _list1260.size; ++_i1262)
          {
            _elem1261 = new SQLForeignKey();
            _elem1261.read(iprot);
            struct.foreignKeys.add(_elem1261);
          }
        }
        struct.setForeignKeysIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.uniqueConstraints = new java.util.ArrayList<SQLUniqueConstraint>(_list1263.size);
          @org.apache.thrift.annotation.Nullable SQLUniqueConstraint _elem1264;
          for (int _i1265 = 0; _i1265 < _list1263.size; ++_i1265)
          {
            _elem1264 = new SQLUniqueConstraint();
            _elem1264.read(iprot);
            struct.uniqueConstraints.add(_elem1264);
          }
        }
        struct.setUniqueConstraintsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.notNullConstraints = new java.util.ArrayList<SQLNotNullConstraint>(_list1266.size);
          @org.apache.thrift.annotation.Nullable SQLNotNullConstraint _elem1267;
          for (int _i1268 = 0; _i1268 < _list1266.size; ++_i1268)
          {
            _elem1267 = new SQLNotNullConstraint();
            _elem1267.read(iprot);
            struct.notNullConstraints.add(_elem1267);
          }
        }
        struct.setNotNullConstraintsIsSet(true);
      }
      if (incoming.get(5)) {
        {
          ...
          struct.defaultConstraints = new java.util.ArrayList<SQLDefaultConstraint>(_list1269.size);
          @org.apache.thrift.annotation.Nullable SQLDefaultConstraint _elem1270;
          for (int _i1271 = 0; _i1271 < _list1269.size; ++_i1271)
          {
            _elem1270 = new SQLDefaultConstraint();
            _elem1270.read(iprot);
            struct.defaultConstraints.add(_elem1270);
          }
        }
        struct.setDefaultConstraintsIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.checkConstraints = new java.util.ArrayList<SQLCheckConstraint>(_list1272.size);
          @org.apache.thrift.annotation.Nullable SQLCheckConstraint _elem1273;
          for (int _i1274 = 0; _i1274 < _list1272.size; ++_i1274)
          {
            _elem1273 = new SQLCheckConstraint();
            _elem1273.read(iprot);
            struct.checkConstraints.add(_elem1273);
          }
        }
        struct.setCheckConstraintsIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          struct.processorCapabilities = new java.util.ArrayList<java.lang.String>(_list1275.size);
          ...
          for (int _i1277 = 0; _i1277 < _list1275.size; ++_i1277)
          {
            ...
            struct.processorCapabilities.add(_elem1276);
          }
        }
        struct.setProcessorCapabilitiesIsSet(true);
      }
