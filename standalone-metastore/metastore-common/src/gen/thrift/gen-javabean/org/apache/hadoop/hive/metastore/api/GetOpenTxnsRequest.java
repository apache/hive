...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class GetOpenTxnsRequest implements org.apache.thrift.TBase<GetOpenTxnsRequest, GetOpenTxnsRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetOpenTxnsRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.excludeTxnTypes = new java.util.ArrayList<TxnType>(_list1512.size);
                @org.apache.thrift.annotation.Nullable TxnType _elem1513;
                for (int _i1514 = 0; _i1514 < _list1512.size; ++_i1514)
                {
                  _elem1513 = org.apache.hadoop.hive.metastore.api.TxnType.findByValue(iprot.readI32());
                  if (_elem1513 != null)
                  {
                    struct.excludeTxnTypes.add(_elem1513);
                  }
                }
                iprot.readListEnd();
              }
      ...
      if (struct.excludeTxnTypes != null) {
        if (struct.isSetExcludeTxnTypes()) {
          oprot.writeFieldBegin(EXCLUDE_TXN_TYPES_FIELD_DESC);
          {
            ...
            for (TxnType _iter1515 : struct.excludeTxnTypes)
            {
              oprot.writeI32(_iter1515.getValue());
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class GetOpenTxnsRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<GetOpenTxnsRequest> {
      ...
      if (struct.isSetExcludeTxnTypes()) {
        {
          ...
          for (TxnType _iter1516 : struct.excludeTxnTypes)
          {
            oprot.writeI32(_iter1516.getValue());
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, GetOpenTxnsRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list1517 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.excludeTxnTypes = new java.util.ArrayList<TxnType>(_list1517.size);
          @org.apache.thrift.annotation.Nullable TxnType _elem1518;
          for (int _i1519 = 0; _i1519 < _list1517.size; ++_i1519)
          {
            _elem1518 = org.apache.hadoop.hive.metastore.api.TxnType.findByValue(iprot.readI32());
            if (_elem1518 != null)
            {
              struct.excludeTxnTypes.add(_elem1518);
            }
          }
        }
        struct.setExcludeTxnTypesIsSet(true);
