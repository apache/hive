...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class GetOpenTxnsRequest implements org.apache.thrift.TBase<GetOpenTxnsRequest, GetOpenTxnsRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetOpenTxnsRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.excludeTxnTypes = new java.util.ArrayList<TxnType>(_list1352.size);
                @org.apache.thrift.annotation.Nullable TxnType _elem1353;
                for (int _i1354 = 0; _i1354 < _list1352.size; ++_i1354)
                {
                  _elem1353 = org.apache.hadoop.hive.metastore.api.TxnType.findByValue(iprot.readI32());
                  if (_elem1353 != null)
                  {
                    struct.excludeTxnTypes.add(_elem1353);
                  }
                }
                iprot.readListEnd();
              }
      ...
      if (struct.excludeTxnTypes != null) {
        if (struct.isSetExcludeTxnTypes()) {
          oprot.writeFieldBegin(EXCLUDE_TXN_TYPES_FIELD_DESC);
          {
            ...
            for (TxnType _iter1355 : struct.excludeTxnTypes)
            {
              oprot.writeI32(_iter1355.getValue());
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class GetOpenTxnsRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<GetOpenTxnsRequest> {
      ...
      if (struct.isSetExcludeTxnTypes()) {
        {
          ...
          for (TxnType _iter1356 : struct.excludeTxnTypes)
          {
            oprot.writeI32(_iter1356.getValue());
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, GetOpenTxnsRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list1357 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.excludeTxnTypes = new java.util.ArrayList<TxnType>(_list1357.size);
          @org.apache.thrift.annotation.Nullable TxnType _elem1358;
          for (int _i1359 = 0; _i1359 < _list1357.size; ++_i1359)
          {
            _elem1358 = org.apache.hadoop.hive.metastore.api.TxnType.findByValue(iprot.readI32());
            if (_elem1358 != null)
            {
              struct.excludeTxnTypes.add(_elem1358);
            }
          }
        }
        struct.setExcludeTxnTypesIsSet(true);
