            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.triggers = new java.util.ArrayList<WMTrigger>(_list1198.size);
                @org.apache.thrift.annotation.Nullable WMTrigger _elem1199;
                for (int _i1200 = 0; _i1200 < _list1198.size; ++_i1200)
                {
                  _elem1199 = new WMTrigger();
                  _elem1199.read(iprot);
                  struct.triggers.add(_elem1199);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.triggers != null) {
        if (struct.isSetTriggers()) {
          oprot.writeFieldBegin(TRIGGERS_FIELD_DESC);
          {
            ...
            for (WMTrigger _iter1201 : struct.triggers)
            {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.triggers = new java.util.ArrayList<WMTrigger>(_list1203.size);
          @org.apache.thrift.annotation.Nullable WMTrigger _elem1204;
          for (int _i1205 = 0; _i1205 < _list1203.size; ++_i1205)
          {
            _elem1204 = new WMTrigger();
            _elem1204.read(iprot);
            struct.triggers.add(_elem1204);
          }
        }
        struct.setTriggersIsSet(true);
      }
