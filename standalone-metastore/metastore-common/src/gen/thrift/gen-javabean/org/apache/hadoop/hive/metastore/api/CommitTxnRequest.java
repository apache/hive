            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.writeEventInfos = new java.util.ArrayList<WriteEventInfo>(_list838.size);
                @org.apache.thrift.annotation.Nullable WriteEventInfo _elem839;
                for (int _i840 = 0; _i840 < _list838.size; ++_i840)
                {
                  _elem839 = new WriteEventInfo();
                  _elem839.read(iprot);
                  struct.writeEventInfos.add(_elem839);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.writeEventInfos != null) {
        if (struct.isSetWriteEventInfos()) {
          oprot.writeFieldBegin(WRITE_EVENT_INFOS_FIELD_DESC);
          {
            ...
            for (WriteEventInfo _iter841 : struct.writeEventInfos)
            {
      ...
      if (struct.isSetWriteEventInfos()) {
        {
          ...
          for (WriteEventInfo _iter842 : struct.writeEventInfos)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.writeEventInfos = new java.util.ArrayList<WriteEventInfo>(_list843.size);
          @org.apache.thrift.annotation.Nullable WriteEventInfo _elem844;
          for (int _i845 = 0; _i845 < _list843.size; ++_i845)
          {
            _elem844 = new WriteEventInfo();
            _elem844.read(iprot);
            struct.writeEventInfos.add(_elem844);
          }
        }
        struct.setWriteEventInfosIsSet(true);
      }
