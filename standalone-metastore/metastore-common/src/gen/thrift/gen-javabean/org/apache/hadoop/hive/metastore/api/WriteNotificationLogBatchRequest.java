            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.requestList = new java.util.ArrayList<WriteNotificationLogRequest>(_list1032.size);
                @org.apache.thrift.annotation.Nullable WriteNotificationLogRequest _elem1033;
                for (int _i1034 = 0; _i1034 < _list1032.size; ++_i1034)
                {
                  _elem1033 = new WriteNotificationLogRequest();
                  _elem1033.read(iprot);
                  struct.requestList.add(_elem1033);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WriteNotificationLogBatchRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.requestList != null) {
        oprot.writeFieldBegin(REQUEST_LIST_FIELD_DESC);
        {
          ...
          for (WriteNotificationLogRequest _iter1035 : struct.requestList)
          {
  ...
  private static class WriteNotificationLogBatchRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<WriteNotificationLogBatchRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, WriteNotificationLogBatchRequest struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.table);
      {
        ...
        for (WriteNotificationLogRequest _iter1036 : struct.requestList)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, WriteNotificationLogBatchRequest struct) throws org.apache.thrift.TException {
      ...
      struct.setTableIsSet(true);
      {
        org.apache.thrift.protocol.TList _list1037 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
        struct.requestList = new java.util.ArrayList<WriteNotificationLogRequest>(_list1037.size);
        @org.apache.thrift.annotation.Nullable WriteNotificationLogRequest _elem1038;
        for (int _i1039 = 0; _i1039 < _list1037.size; ++_i1039)
        {
          _elem1038 = new WriteNotificationLogRequest();
          _elem1038.read(iprot);
          struct.requestList.add(_elem1038);
        }
      }
      struct.setRequestListIsSet(true);
    }
