...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class AddUniqueConstraintRequest implements org.apache.thrift.TBase<AddUniqueConstraintRequest, AddUniqueConstraintRequest._Fields>, java.io.Serializable, Cloneable, Comparable<AddUniqueConstraintRequest> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new AddUniqueConstraintRequestStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new AddUniqueConstraintRequestTupleSchemeFactory();

  private @org.apache.thrift.annotation.Nullable java.util.List<SQLUniqueConstraint> uniqueConstraintCols; // required
  ...
  public AddUniqueConstraintRequest(
    java.util.List<SQLUniqueConstraint> uniqueConstraintCols)
  {
    this();
  ...
  public AddUniqueConstraintRequest(AddUniqueConstraintRequest other) {
    if (other.isSetUniqueConstraintCols()) {
      java.util.List<SQLUniqueConstraint> __this__uniqueConstraintCols = new java.util.ArrayList<SQLUniqueConstraint>(other.uniqueConstraintCols.size());
  ...
  public void addToUniqueConstraintCols(SQLUniqueConstraint elem) {
    if (this.uniqueConstraintCols == null) {
      this.uniqueConstraintCols = new java.util.ArrayList<SQLUniqueConstraint>();
    }
    this.uniqueConstraintCols.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<SQLUniqueConstraint> getUniqueConstraintCols() {
    return this.uniqueConstraintCols;
  }

  public void setUniqueConstraintCols(@org.apache.thrift.annotation.Nullable java.util.List<SQLUniqueConstraint> uniqueConstraintCols) {
    this.uniqueConstraintCols = uniqueConstraintCols;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case UNIQUE_CONSTRAINT_COLS:
      if (value == null) {
        ...
        setUniqueConstraintCols((java.util.List<SQLUniqueConstraint>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetUniqueConstraintCols()) ? 131071 : 524287);
    if (isSetUniqueConstraintCols())
      hashCode = hashCode * 8191 + uniqueConstraintCols.hashCode();
  ...
  public int compareTo(AddUniqueConstraintRequest other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetUniqueConstraintCols()).compareTo(other.isSetUniqueConstraintCols());
    if (lastComparison != 0) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("AddUniqueConstraintRequest(");
    boolean first = true;
  ...
  private static class AddUniqueConstraintRequestStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public AddUniqueConstraintRequestStandardScheme getScheme() {
      return new AddUniqueConstraintRequestStandardScheme();
    }
  }

  private static class AddUniqueConstraintRequestStandardScheme extends org.apache.thrift.scheme.StandardScheme<AddUniqueConstraintRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.uniqueConstraintCols = new java.util.ArrayList<SQLUniqueConstraint>(_list464.size);
                @org.apache.thrift.annotation.Nullable SQLUniqueConstraint _elem465;
                for (int _i466 = 0; _i466 < _list464.size; ++_i466)
                {
                  _elem465 = new SQLUniqueConstraint();
                  _elem465.read(iprot);
                  struct.uniqueConstraintCols.add(_elem465);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AddUniqueConstraintRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.uniqueConstraintCols != null) {
        oprot.writeFieldBegin(UNIQUE_CONSTRAINT_COLS_FIELD_DESC);
        {
          ...
          for (SQLUniqueConstraint _iter467 : struct.uniqueConstraintCols)
          {
  ...
  private static class AddUniqueConstraintRequestTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public AddUniqueConstraintRequestTupleScheme getScheme() {
      return new AddUniqueConstraintRequestTupleScheme();
    }
  }

  private static class AddUniqueConstraintRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<AddUniqueConstraintRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, AddUniqueConstraintRequest struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (SQLUniqueConstraint _iter468 : struct.uniqueConstraintCols)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, AddUniqueConstraintRequest struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        struct.uniqueConstraintCols = new java.util.ArrayList<SQLUniqueConstraint>(_list469.size);
        @org.apache.thrift.annotation.Nullable SQLUniqueConstraint _elem470;
        for (int _i471 = 0; _i471 < _list469.size; ++_i471)
        {
          _elem470 = new SQLUniqueConstraint();
          _elem470.read(iprot);
          struct.uniqueConstraintCols.add(_elem470);
        }
      }
      struct.setUniqueConstraintColsIsSet(true);
    }
