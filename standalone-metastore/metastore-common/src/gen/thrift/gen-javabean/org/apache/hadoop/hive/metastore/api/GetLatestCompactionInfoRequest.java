...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class GetLatestCompactionInfoRequest implements org.apache.thrift.TBase<GetLatestCompactionInfoRequest, GetLatestCompactionInfoRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetLatestCompactionInfoRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetLatestCompactionInfoRequest");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new GetLatestCompactionInfoRequestStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new GetLatestCompactionInfoRequestTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetLatestCompactionInfoRequest.class, metaDataMap);
  }

  public GetLatestCompactionInfoRequest() {
  }
   ...
   */
  public GetLatestCompactionInfoRequest(GetLatestCompactionInfoRequest other) {
  ...
  public GetLatestCompactionInfoRequest deepCopy() {
    return new GetLatestCompactionInfoRequest(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof GetLatestCompactionInfoRequest)
      return this.equals((GetLatestCompactionInfoRequest)that);
    return false;
  }

  public boolean equals(GetLatestCompactionInfoRequest that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(GetLatestCompactionInfoRequest other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetPartitionnames()).compareTo(other.isSetPartitionnames());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPartitionnames()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("GetLatestCompactionInfoRequest(");
    boolean first = true;
  ...
  private static class GetLatestCompactionInfoRequestStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public GetLatestCompactionInfoRequestStandardScheme getScheme() {
      return new GetLatestCompactionInfoRequestStandardScheme();
    }
  }

  private static class GetLatestCompactionInfoRequestStandardScheme extends org.apache.thrift.scheme.StandardScheme<GetLatestCompactionInfoRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetLatestCompactionInfoRequest struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitionnames = new java.util.ArrayList<java.lang.String>(_list828.size);
                ...
                for (int _i830 = 0; _i830 < _list828.size; ++_i830)
                {
                  ...
                  struct.partitionnames.add(_elem829);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetLatestCompactionInfoRequest struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.partitionnames != null) {
        if (struct.isSetPartitionnames()) {
          oprot.writeFieldBegin(PARTITIONNAMES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter831 : struct.partitionnames)
            {
  ...
  private static class GetLatestCompactionInfoRequestTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public GetLatestCompactionInfoRequestTupleScheme getScheme() {
      return new GetLatestCompactionInfoRequestTupleScheme();
    }
  }

  private static class GetLatestCompactionInfoRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<GetLatestCompactionInfoRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetLatestCompactionInfoRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetPartitionnames()) {
        {
          ...
          for (java.lang.String _iter832 : struct.partitionnames)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetLatestCompactionInfoRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.partitionnames = new java.util.ArrayList<java.lang.String>(_list833.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem834;
          for (int _i835 = 0; _i835 < _list833.size; ++_i835)
          {
            _elem834 = iprot.readString();
            struct.partitionnames.add(_elem834);
          }
        }
        struct.setPartitionnamesIsSet(true);
      }
