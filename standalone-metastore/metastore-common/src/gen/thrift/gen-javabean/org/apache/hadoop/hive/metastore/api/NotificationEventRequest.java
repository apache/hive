...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class NotificationEventRequest implements org.apache.thrift.TBase<NotificationEventRequest, NotificationEventRequest._Fields>, java.io.Serializable, Cloneable, Comparable<NotificationEventRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.eventTypeList = new java.util.ArrayList<java.lang.String>(_list982.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem983;
                for (int _i984 = 0; _i984 < _list982.size; ++_i984)
                {
                  _elem983 = iprot.readString();
                  struct.eventTypeList.add(_elem983);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.eventTypeSkipList != null) {
        if (struct.isSetEventTypeSkipList()) {
          oprot.writeFieldBegin(EVENT_TYPE_SKIP_LIST_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter985 : struct.eventTypeSkipList)
            {
      ...
      if (struct.tableNames != null) {
        if (struct.isSetTableNames()) {
          oprot.writeFieldBegin(TABLE_NAMES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter986 : struct.tableNames)
            {
      ...
      if (struct.eventTypeList != null) {
        if (struct.isSetEventTypeList()) {
          oprot.writeFieldBegin(EVENT_TYPE_LIST_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter987 : struct.eventTypeList)
            {
  ...
  private static class NotificationEventRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<NotificationEventRequest> {
      ...
      if (struct.isSetEventTypeSkipList()) {
        {
          ...
          for (java.lang.String _iter988 : struct.eventTypeSkipList)
          {
      ...
      if (struct.isSetTableNames()) {
        {
          ...
          for (java.lang.String _iter989 : struct.tableNames)
          {
            oprot.writeString(_iter989);
          }
        }
      }
      if (struct.isSetEventTypeList()) {
        {
          ...
          for (java.lang.String _iter990 : struct.eventTypeList)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, NotificationEventRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list991 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
          struct.eventTypeSkipList = new java.util.ArrayList<java.lang.String>(_list991.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem992;
          for (int _i993 = 0; _i993 < _list991.size; ++_i993)
          {
            _elem992 = iprot.readString();
            struct.eventTypeSkipList.add(_elem992);
          }
        }
        struct.setEventTypeSkipListIsSet(true);
      }
      ...
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TList _list994 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
          struct.tableNames = new java.util.ArrayList<java.lang.String>(_list994.size);
          ...
          for (int _i996 = 0; _i996 < _list994.size; ++_i996)
          {
            ...
            struct.tableNames.add(_elem995);
          }
        }
        struct.setTableNamesIsSet(true);
      }
      if (incoming.get(5)) {
        {
          ...
          struct.eventTypeList = new java.util.ArrayList<java.lang.String>(_list997.size);
          ...
          for (int _i999 = 0; _i999 < _list997.size; ++_i999)
          {
            ...
            struct.eventTypeList.add(_elem998);
          }
        }
        struct.setEventTypeListIsSet(true);
      }
