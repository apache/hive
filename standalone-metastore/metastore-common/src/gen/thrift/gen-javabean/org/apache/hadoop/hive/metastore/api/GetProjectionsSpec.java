            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fieldList = new java.util.ArrayList<java.lang.String>(_list1076.size);
                ...
                for (int _i1078 = 0; _i1078 < _list1076.size; ++_i1078)
                {
                  ...
                  struct.fieldList.add(_elem1077);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetProjectionsSpec struct) throws org.apache.thrift.TException {
      ...
      if (struct.fieldList != null) {
        oprot.writeFieldBegin(FIELD_LIST_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter1079 : struct.fieldList)
          {
            oprot.writeString(_iter1079);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.isSetFieldList()) {
        {
          ...
          for (java.lang.String _iter1080 : struct.fieldList)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.fieldList = new java.util.ArrayList<java.lang.String>(_list1081.size);
          ...
          for (int _i1083 = 0; _i1083 < _list1081.size; ++_i1083)
          {
            ...
            struct.fieldList.add(_elem1082);
          }
        }
        struct.setFieldListIsSet(true);
      }
