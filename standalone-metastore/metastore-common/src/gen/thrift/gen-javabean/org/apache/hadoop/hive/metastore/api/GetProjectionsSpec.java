            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fieldList = new java.util.ArrayList<java.lang.String>(_list1116.size);
                ...
                for (int _i1118 = 0; _i1118 < _list1116.size; ++_i1118)
                {
                  ...
                  struct.fieldList.add(_elem1117);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetProjectionsSpec struct) throws org.apache.thrift.TException {
      ...
      if (struct.fieldList != null) {
        oprot.writeFieldBegin(FIELD_LIST_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter1119 : struct.fieldList)
          {
      ...
      if (struct.isSetFieldList()) {
        {
          ...
          for (java.lang.String _iter1120 : struct.fieldList)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.fieldList = new java.util.ArrayList<java.lang.String>(_list1121.size);
          ...
          for (int _i1123 = 0; _i1123 < _list1121.size; ++_i1123)
          {
            ...
            struct.fieldList.add(_elem1122);
          }
        }
        struct.setFieldListIsSet(true);
      }
