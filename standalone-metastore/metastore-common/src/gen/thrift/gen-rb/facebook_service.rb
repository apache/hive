...
module FacebookService
  ...
  class GetStatus_result
    ...
    FIELDS = {
      SUCCESS_FIELD_ID => {:type => ::Thrift::Types::I32, :name => 'success', :enum_class => ::Fb_status}
    }
  ...
  class GetCounters_result
    ...
    FIELDS = {
      SUCCESS_FIELD_ID => {:type => ::Thrift::Types::MAP, :name => 'success', :key => {:type => ::Thrift::Types::STRING}, :value => {:type => ::Thrift::Types::I64}}
    }
  ...
  class GetCpuProfile_args
    include ::Thrift::Struct, ::Thrift::Struct_Union
    PROFILEDURATIONINSEC_FIELD_ID = 1

    FIELDS = {
      PROFILEDURATIONINSEC_FIELD_ID => {:type => ::Thrift::Types::I32, :name => 'profileDurationInSec'}
    }
