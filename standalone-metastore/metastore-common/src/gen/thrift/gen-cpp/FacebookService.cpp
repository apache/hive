...
{
  send_reinitialize();
  oprot_->getTransport()->onewayComplete();
}
...
void FacebookServiceProcessor::process_reinitialize(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  (void) seqid;
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
...
void FacebookServiceProcessor::process_shutdown(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  (void) seqid;
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
