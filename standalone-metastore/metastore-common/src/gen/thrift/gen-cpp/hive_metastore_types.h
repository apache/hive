...
typedef struct _CreateDatabaseRequest__isset {
  _CreateDatabaseRequest__isset() : description(false), locationUri(false), parameters(false), privileges(false), ownerName(false), ownerType(false), catalogName(false), createTime(false), managedLocationUri(false), type(false), dataConnectorName(false), database(false), skipFSWrites(true) {}
  bool description :1;
  bool locationUri :1;
  bool parameters :1;
  bool privileges :1;
