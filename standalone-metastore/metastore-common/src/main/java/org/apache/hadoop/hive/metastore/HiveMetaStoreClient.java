...
public class HiveMetaStoreClient extends NoopHiveMetaStoreClientDelegator
  ...
  public HiveMetaStoreClient(Configuration conf, HiveMetaHookLoader hookLoader, Boolean allowEmbedded)
    ...
    // Hook -> Thrift
    super();
    this.thriftClient = new ThriftHiveMetaStoreClient(conf, allowEmbedded);
    IMetaStoreClient clientWithHook = new HiveMetaStoreClientWithHook(conf, hookLoader, thriftClient);
    setDelegate(clientWithHook);
  }
  ...
  public static ThriftHiveMetastore.Iface callEmbeddedMetastore(Configuration conf) throws MetaException {
    return ThriftHiveMetaStoreClient.callEmbeddedMetastore(conf);
  }
