 ...
 * @see MetastoreConf.ConfVars#METASTORE_PLAIN_LDAP_CUSTOMLDAPQUERY
 */
public class CustomQueryFilterFactory implements FilterFactory {
  ...
  public Filter getInstance(Configuration conf) {
    String customQuery = MetastoreConf.getVar(conf,
                    MetastoreConf.ConfVars.METASTORE_PLAIN_LDAP_CUSTOMLDAPQUERY);
