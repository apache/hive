...
"If there are multiple Thrift metastore services running, the hostname of Thrift metastore " +
    ...
    ICEBERG_TABLE_EXPIRY_CATALOG_PATTERN("metastore.iceberg.table.expiry.catalog.pattern",
        "hive.metastore.iceberg.table.expiry.catalog.pattern", "",
        "Iceberg table expiry service searches for tables using the specified catalog pattern. " +
