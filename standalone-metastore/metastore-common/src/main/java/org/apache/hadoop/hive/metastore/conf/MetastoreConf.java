...
"If there are multiple Thrift metastore services running, the hostname of Thrift metastore " +
    ...
    CONNECTION_POOLING_LIFETIME("datanucleus.connectionLifetime",
        "datanucleus.connectionLifetime", 1800,
        "The maximum lifetime, in seconds, of a connection in the pool, used in HikariCP only."),
