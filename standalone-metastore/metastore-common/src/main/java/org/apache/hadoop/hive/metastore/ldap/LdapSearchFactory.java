...
public final class LdapSearchFactory implements DirSearchFactory {
   ...
   */
  @Override
  public DirSearch getInstance(Configuration conf, String principal, String password)
  ...
  private static DirContext createDirContext(Configuration conf, String principal, String password)
