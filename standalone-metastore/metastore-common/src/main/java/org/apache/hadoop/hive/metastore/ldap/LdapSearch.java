...
public final class LdapSearch implements DirSearch {
   ...
   */
  public LdapSearch(Configuration conf, DirContext ctx) throws NamingException {
    baseDn = MetastoreConf.getVar(conf, MetastoreConf.ConfVars.METASTORE_PLAIN_LDAP_BASEDN);
    ...
    groupBases = LdapUtils.patternsToBaseDns(LdapUtils.parseDnPatterns(conf,
        MetastoreConf.ConfVars.METASTORE_PLAIN_LDAP_GROUPDNPATTERN));
