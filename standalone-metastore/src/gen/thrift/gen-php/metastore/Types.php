...
class FullTableName {
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('FullTableName');
    if ($this->catName !== null) {
      $xfer += $output->writeFieldBegin('catName', TType::STRING, 1);
      $xfer += $output->writeString($this->catName);
      $xfer += $output->writeFieldEnd();
...
class GetValidWriteIdsRequest2 {
  ...
  public function getName() {
    return 'GetValidWriteIdsRequest2';
  }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem542 = null;
              $elem542 = new \metastore\FullTableName();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('GetValidWriteIdsRequest2');
    if ($this->fullTableNames !== null) {
      if (!is_array($this->fullTableNames)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
      $xfer += $output->writeFieldBegin('fullTableNames', TType::LST, 1);
      {
        $output->writeListBegin(TType::STRUCT, count($this->fullTableNames));
        {
...
class TableValidWriteIds2 {
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->fullTableName = new \metastore\FullTableName();
            $xfer += $this->fullTableName->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('TableValidWriteIds2');
    if ($this->fullTableName !== null) {
      if (!is_object($this->fullTableName)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
      $xfer += $output->writeFieldBegin('fullTableName', TType::STRUCT, 1);
      $xfer += $this->fullTableName->write($output);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->writeIdHighWaterMark !== null) {
      $xfer += $output->writeFieldBegin('writeIdHighWaterMark', TType::I64, 2);
...
class GetValidWriteIdsResponse2 {
  ...
  /**
   * @var \metastore\TableValidWriteIds2[]
   */
  public $tblValidWriteIds = null;
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        1 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\metastore\TableValidWriteIds2',
            ),
          ),
        );
    }
  ...
  public function getName() {
    return 'GetValidWriteIdsResponse2';
  }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem570 = null;
              $elem570 = new \metastore\TableValidWriteIds2();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('GetValidWriteIdsResponse2');
    if ($this->tblValidWriteIds !== null) {
      if (!is_array($this->tblValidWriteIds)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
...
class ShowCompactResponseElement {
  ...
  public function write($output) {
    ...
    if ($this->catName !== null) {
      $xfer += $output->writeFieldBegin('catName', TType::STRING, 14);
      $xfer += $output->writeString($this->catName);
      $xfer += $output->writeFieldEnd();
    }
    $xfer += $output->writeFieldStop();
  ...
  public function write($output) {
    ...
    if ($this->filesAdded !== null) {
      ...
      $xfer += $output->writeFieldBegin('filesAdded', TType::LST, 2);
      {
        ...
        {
          foreach ($this->filesAdded as $iter673)
          {
    ...
    if ($this->filesAddedChecksum !== null) {
      ...
      $xfer += $output->writeFieldBegin('filesAddedChecksum', TType::LST, 3);
      {
        ...
        {
          foreach ($this->filesAddedChecksum as $iter674)
          {
