      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i773 in xrange(_size769):
            _elem774 = FieldSchema()
            _elem774.read(iprot)
            self.cols.append(_elem774)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 5:
...
class FindSchemasByColsResp:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i780 in xrange(_size776):
            _elem781 = SchemaVersionDescriptor()
            _elem781.read(iprot)
            self.schemaVersions.append(_elem781)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.schemaVersions is not None:
      ...
      for iter782 in self.schemaVersions:
        iter782.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
