...
class InsertEventRequestData:
  ...
  def write(self, oprot):
    ...
    if self.filesAdded is not None:
      ...
      for iter656 in self.filesAdded:
    ...
    if self.filesAddedChecksum is not None:
      ...
      for iter657 in self.filesAddedChecksum:
...
class FireEventRequest:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i662 in xrange(_size658):
            ...
            self.partitionVals.append(_elem663)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 6:
  ...
  def write(self, oprot):
    ...
    if self.partitionVals is not None:
      ...
      for iter664 in self.partitionVals:
...
class GetFileMetadataByExprResult:
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i669 in xrange(_size665):
            _key670 = iprot.readI64()
            _val671 = MetadataPpdResult()
            _val671.read(iprot)
            self.metadata[_key670] = _val671
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.metadata is not None:
      ...
      for kiter672,viter673 in self.metadata.items():
        oprot.writeI64(kiter672)
        viter673.write(oprot)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
...
class GetFileMetadataResult:
  ...
  def write(self, oprot):
    ...
    if self.metadata is not None:
      ...
      for kiter688,viter689 in self.metadata.items():
        oprot.writeI64(kiter688)
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i722 in xrange(_size718):
            _elem723 = Function()
            _elem723.read(iprot)
            self.functions.append(_elem723)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class ClientCapabilities:
  ...
  def write(self, oprot):
    ...
    if self.values is not None:
      ...
      for iter731 in self.values:
        oprot.writeI32(iter731)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
