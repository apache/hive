...
class GetValidWriteIdsRequest:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i501 in xrange(_size497):
            ...
            self.fullTableNames.append(_elem502)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.fullTableNames is not None:
      ...
      for iter503 in self.fullTableNames:
...
class TableValidWriteIds:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i508 in xrange(_size504):
            ...
            self.invalidWriteIds.append(_elem509)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.invalidWriteIds is not None:
      ...
      for iter510 in self.invalidWriteIds:
...
class AllocateTableWriteIdsResponse:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i529 in xrange(_size525):
            _elem530 = TxnToWriteId()
            _elem530.read(iprot)
            self.txnToWriteIds.append(_elem530)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.txnToWriteIds is not None:
      ...
      for iter531 in self.txnToWriteIds:
        iter531.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
