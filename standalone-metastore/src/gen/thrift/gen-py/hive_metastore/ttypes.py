...
class FindSchemasByColsResp:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i733 in xrange(_size729):
            _elem734 = FindSchemasByColsRespEntry()
            _elem734.read(iprot)
            self.schemaVersions.append(_elem734)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.schemaVersions is not None:
      ...
      for iter735 in self.schemaVersions:
        iter735.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
