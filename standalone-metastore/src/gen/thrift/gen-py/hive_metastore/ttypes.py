      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i480 in xrange(_size476):
            ...
            self.replSrcTxnId.append(_elem481)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i501 in xrange(_size497):
            _elem502 = LockComponent()
            _elem502.read(iprot)
            self.component.append(_elem502)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i508 in xrange(_size504):
            _elem509 = ShowLocksResponseElement()
            _elem509.read(iprot)
            self.locks.append(_elem509)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.SET:
          self.aborted = set()
          (_etype514, _size511) = iprot.readSetBegin()
          for _i515 in xrange(_size511):
            _elem516 = iprot.readI64()
            self.aborted.add(_elem516)
          iprot.readSetEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
...
class CompactionRequest:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i529 in xrange(_size525):
            ...
            self.properties[_key530] = _val531
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.properties is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.properties))
      for kiter532,viter533 in self.properties.items():
        oprot.writeString(kiter532)
        oprot.writeString(viter533)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i538 in xrange(_size534):
            _elem539 = ShowCompactResponseElement()
            _elem539.read(iprot)
            self.compacts.append(_elem539)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class AddDynamicPartitions:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i545 in xrange(_size541):
            ...
            self.partitionnames.append(_elem546)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 5:
  ...
  def write(self, oprot):
    ...
    if self.partitionnames is not None:
      ...
      for iter547 in self.partitionnames:
...
class CreationMetadata:
  ...
  def write(self, oprot):
    ...
    if self.tablesUsed is not None:
      ...
      for iter554 in self.tablesUsed:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i559 in xrange(_size555):
            _elem560 = NotificationEvent()
            _elem560.read(iprot)
            self.events.append(_elem560)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class InsertEventRequestData:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i566 in xrange(_size562):
            ...
            self.filesAdded.append(_elem567)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.LIST:
          ...
          for _i572 in xrange(_size568):
            ...
            self.filesAddedChecksum.append(_elem573)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.filesAdded is not None:
      ...
      for iter574 in self.filesAdded:
        oprot.writeString(iter574)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.filesAddedChecksum is not None:
      ...
      for iter575 in self.filesAddedChecksum:
...
class FireEventRequest:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i580 in xrange(_size576):
            ...
            self.partitionVals.append(_elem581)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.partitionVals is not None:
      ...
      for iter582 in self.partitionVals:
...
class GetFileMetadataByExprResult:
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i587 in xrange(_size583):
            _key588 = iprot.readI64()
            _val589 = MetadataPpdResult()
            _val589.read(iprot)
            self.metadata[_key588] = _val589
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.metadata is not None:
      ...
      for kiter590,viter591 in self.metadata.items():
        oprot.writeI64(kiter590)
...
class GetFileMetadataResult:
  ...
  def write(self, oprot):
    ...
    if self.metadata is not None:
      ...
      for kiter606,viter607 in self.metadata.items():
        oprot.writeI64(kiter606)
        oprot.writeString(viter607)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.isSupported is not None:
      oprot.writeFieldBegin('isSupported', TType.BOOL, 2)
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i619 in xrange(_size615):
            _elem620 = iprot.readI64()
            self.fileIds.append(_elem620)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i640 in xrange(_size636):
            _elem641 = Function()
            _elem641.read(iprot)
            self.functions.append(_elem641)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class Materialization:
  ...
  def write(self, oprot):
    ...
    if self.tablesUsed is not None:
      ...
      oprot.writeSetBegin(TType.STRING, len(self.tablesUsed))
      for iter670 in self.tablesUsed:
...
class WMFullResourcePlan:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i693 in xrange(_size689):
            _elem694 = WMPoolTrigger()
            _elem694.read(iprot)
            self.poolTriggers.append(_elem694)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.poolTriggers is not None:
      ...
      for iter698 in self.poolTriggers:
        iter698.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class WMGetAllResourcePlanResponse:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i703 in xrange(_size699):
            _elem704 = WMResourcePlan()
            _elem704.read(iprot)
            self.resourcePlans.append(_elem704)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.resourcePlans is not None:
      ...
      for iter705 in self.resourcePlans:
        iter705.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
