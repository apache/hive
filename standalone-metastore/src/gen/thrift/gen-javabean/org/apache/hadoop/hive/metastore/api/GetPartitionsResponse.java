            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitionSpec = new java.util.ArrayList<PartitionSpec>(_list1202.size);
                @org.apache.thrift.annotation.Nullable PartitionSpec _elem1203;
                for (int _i1204 = 0; _i1204 < _list1202.size; ++_i1204)
                {
                  _elem1203 = new PartitionSpec();
                  _elem1203.read(iprot);
                  struct.partitionSpec.add(_elem1203);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetPartitionsResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.partitionSpec != null) {
        oprot.writeFieldBegin(PARTITION_SPEC_FIELD_DESC);
        {
          ...
          for (PartitionSpec _iter1205 : struct.partitionSpec)
          {
      ...
      if (struct.isSetPartitionSpec()) {
        {
          ...
          for (PartitionSpec _iter1206 : struct.partitionSpec)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.partitionSpec = new java.util.ArrayList<PartitionSpec>(_list1207.size);
          @org.apache.thrift.annotation.Nullable PartitionSpec _elem1208;
          for (int _i1209 = 0; _i1209 < _list1207.size; ++_i1209)
          {
            _elem1208 = new PartitionSpec();
            _elem1208.read(iprot);
            struct.partitionSpec.add(_elem1208);
          }
        }
        struct.setPartitionSpecIsSet(true);
      }
