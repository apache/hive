...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class Partition implements org.apache.thrift.TBase<Partition, Partition._Fields>, java.io.Serializable, Cloneable, Comparable<Partition> {
  ...
  public int compareTo(Partition other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSd()).compareTo(other.isSetSd());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSd()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetFileMetadata()).compareTo(other.isSetFileMetadata());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFileMetadata()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.values = new java.util.ArrayList<java.lang.String>(_list282.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.parameters = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map285.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key286;
                @org.apache.thrift.annotation.Nullable java.lang.String _val287;
                for (int _i288 = 0; _i288 < _map285.size; ++_i288)
                {
                  _key286 = iprot.readString();
                  _val287 = iprot.readString();
                  struct.parameters.put(_key286, _val287);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Partition struct) throws org.apache.thrift.TException {
      ...
      if (struct.values != null) {
        oprot.writeFieldBegin(VALUES_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter289 : struct.values)
          {
      ...
      if (struct.parameters != null) {
        oprot.writeFieldBegin(PARAMETERS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter290 : struct.parameters.entrySet())
          {
      ...
      if (struct.isSetValues()) {
        {
          ...
          for (java.lang.String _iter291 : struct.values)
          {
      ...
      if (struct.isSetParameters()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter292 : struct.parameters.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.values = new java.util.ArrayList<java.lang.String>(_list293.size);
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.parameters = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map296.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _key297;
          @org.apache.thrift.annotation.Nullable java.lang.String _val298;
          for (int _i299 = 0; _i299 < _map296.size; ++_i299)
          {
            _key297 = iprot.readString();
            _val298 = iprot.readString();
            struct.parameters.put(_key297, _val298);
          }
        }
        struct.parameters = org.apache.hadoop.hive.metastore.utils.StringUtils.intern(struct.parameters); struct.setParametersIsSet(true);
      }
