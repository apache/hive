        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fieldSchemas = new java.util.ArrayList<FieldSchema>(_list350.size);
                @org.apache.thrift.annotation.Nullable FieldSchema _elem351;
                for (int _i352 = 0; _i352 < _list350.size; ++_i352)
                {
                  _elem351 = new FieldSchema();
                  _elem351.read(iprot);
                  struct.fieldSchemas.add(_elem351);
                }
                iprot.readListEnd();
              }
          ...
          case 2: // PROPERTIES
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                org.apache.thrift.protocol.TMap _map353 = iprot.readMapBegin();
                struct.properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map353.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key354;
                @org.apache.thrift.annotation.Nullable java.lang.String _val355;
                for (int _i356 = 0; _i356 < _map353.size; ++_i356)
                {
                  _key354 = iprot.readString();
                  _val355 = iprot.readString();
                  struct.properties.put(_key354, _val355);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Schema struct) throws org.apache.thrift.TException {
      ...
      if (struct.fieldSchemas != null) {
        oprot.writeFieldBegin(FIELD_SCHEMAS_FIELD_DESC);
        {
          ...
          for (FieldSchema _iter357 : struct.fieldSchemas)
          {
      ...
      if (struct.properties != null) {
        oprot.writeFieldBegin(PROPERTIES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter358 : struct.properties.entrySet())
          {
      ...
      if (struct.isSetProperties()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter360 : struct.properties.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.fieldSchemas = new java.util.ArrayList<FieldSchema>(_list361.size);
          @org.apache.thrift.annotation.Nullable FieldSchema _elem362;
          for (int _i363 = 0; _i363 < _list361.size; ++_i363)
          {
            _elem362 = new FieldSchema();
            _elem362.read(iprot);
            struct.fieldSchemas.add(_elem362);
          }
        }
        struct.setFieldSchemasIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map364.size);
          ...
          for (int _i367 = 0; _i367 < _map364.size; ++_i367)
          {
            ...
            struct.properties.put(_key365, _val366);
          }
        }
        struct.setPropertiesIsSet(true);
      }
