...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class GetValidWriteIdsRequest2 implements org.apache.thrift.TBase<GetValidWriteIdsRequest2, GetValidWriteIdsRequest2._Fields>, java.io.Serializable, Cloneable, Comparable<GetValidWriteIdsRequest2> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetValidWriteIdsRequest2");
  ...
  static {
    schemes.put(StandardScheme.class, new GetValidWriteIdsRequest2StandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetValidWriteIdsRequest2TupleSchemeFactory());
  }

  private List<FullTableName> fullTableNames; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.FULL_TABLE_NAMES, new org.apache.thrift.meta_data.FieldMetaData("fullTableNames", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, FullTableName.class))));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetValidWriteIdsRequest2.class, metaDataMap);
  }

  public GetValidWriteIdsRequest2() {
  }
   ...
   */
  public GetValidWriteIdsRequest2(GetValidWriteIdsRequest2 other) {
    if (other.isSetFullTableNames()) {
      List<FullTableName> __this__fullTableNames = new ArrayList<FullTableName>(other.fullTableNames.size());
      for (FullTableName other_element : other.fullTableNames) {
        __this__fullTableNames.add(new FullTableName(other_element));
      }
  ...
  public GetValidWriteIdsRequest2 deepCopy() {
    return new GetValidWriteIdsRequest2(this);
  }
  ...
  public java.util.Iterator<FullTableName> getFullTableNamesIterator() {
    return (this.fullTableNames == null) ? null : this.fullTableNames.iterator();
  }

  public void addToFullTableNames(FullTableName elem) {
    if (this.fullTableNames == null) {
      this.fullTableNames = new ArrayList<FullTableName>();
    }
    this.fullTableNames.add(elem);
  }

  public List<FullTableName> getFullTableNames() {
    return this.fullTableNames;
  }

  public void setFullTableNames(List<FullTableName> fullTableNames) {
    this.fullTableNames = fullTableNames;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case FULL_TABLE_NAMES:
      if (value == null) {
        ...
        setFullTableNames((List<FullTableName>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetValidWriteIdsRequest2)
      return this.equals((GetValidWriteIdsRequest2)that);
    return false;
  }

  public boolean equals(GetValidWriteIdsRequest2 that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetValidWriteIdsRequest2 other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetValidWriteIdsRequest2(");
    boolean first = true;
  ...
  private static class GetValidWriteIdsRequest2StandardSchemeFactory implements SchemeFactory {
    public GetValidWriteIdsRequest2StandardScheme getScheme() {
      return new GetValidWriteIdsRequest2StandardScheme();
    }
  }

  private static class GetValidWriteIdsRequest2StandardScheme extends StandardScheme<GetValidWriteIdsRequest2> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetValidWriteIdsRequest2 struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fullTableNames = new ArrayList<FullTableName>(_list610.size);
                FullTableName _elem611;
                for (int _i612 = 0; _i612 < _list610.size; ++_i612)
                {
                  _elem611 = new FullTableName();
                  _elem611.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetValidWriteIdsRequest2 struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.fullTableNames != null) {
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.fullTableNames.size()));
          for (FullTableName _iter613 : struct.fullTableNames)
          {
  ...
  private static class GetValidWriteIdsRequest2TupleSchemeFactory implements SchemeFactory {
    public GetValidWriteIdsRequest2TupleScheme getScheme() {
      return new GetValidWriteIdsRequest2TupleScheme();
    }
  }

  private static class GetValidWriteIdsRequest2TupleScheme extends TupleScheme<GetValidWriteIdsRequest2> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetValidWriteIdsRequest2 struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        oprot.writeI32(struct.fullTableNames.size());
        for (FullTableName _iter614 : struct.fullTableNames)
        {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetValidWriteIdsRequest2 struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.fullTableNames = new ArrayList<FullTableName>(_list615.size);
        FullTableName _elem616;
        for (int _i617 = 0; _i617 < _list615.size; ++_i617)
        {
          _elem616 = new FullTableName();
          _elem616.read(iprot);
