...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class DropPackageRequest implements org.apache.thrift.TBase<DropPackageRequest, DropPackageRequest._Fields>, java.io.Serializable, Cloneable, Comparable<DropPackageRequest> {
  ...
  static {
    schemes.put(StandardScheme.class, new DropPackageRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DropPackageRequestTupleSchemeFactory());
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DropPackageRequest(");
    boolean first = true;
  ...
  private static class DropPackageRequestStandardSchemeFactory implements SchemeFactory {
    public DropPackageRequestStandardScheme getScheme() {
      return new DropPackageRequestStandardScheme();
    }
  }

  private static class DropPackageRequestStandardScheme extends StandardScheme<DropPackageRequest> {
  ...
  private static class DropPackageRequestTupleSchemeFactory implements SchemeFactory {
    public DropPackageRequestTupleScheme getScheme() {
      return new DropPackageRequestTupleScheme();
    }
  }

  private static class DropPackageRequestTupleScheme extends TupleScheme<DropPackageRequest> {
