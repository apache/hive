            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.filters = new java.util.ArrayList<java.lang.String>(_list1194.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem1195;
                for (int _i1196 = 0; _i1196 < _list1194.size; ++_i1196)
                {
                  _elem1195 = iprot.readString();
                  struct.filters.add(_elem1195);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.filters != null) {
        if (struct.isSetFilters()) {
          oprot.writeFieldBegin(FILTERS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter1197 : struct.filters)
            {
      ...
      if (struct.isSetFilters()) {
        {
          ...
          for (java.lang.String _iter1198 : struct.filters)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.filters = new java.util.ArrayList<java.lang.String>(_list1199.size);
