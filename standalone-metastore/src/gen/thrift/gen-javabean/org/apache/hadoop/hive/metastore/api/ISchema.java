...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class ISchema implements org.apache.thrift.TBase<ISchema, ISchema._Fields>, java.io.Serializable, Cloneable, Comparable<ISchema> {
  ...
  public int compareTo(ISchema other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSchemaType()).compareTo(other.isSetSchemaType());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetCompatibility()).compareTo(other.isSetCompatibility());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCompatibility()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetValidationLevel()).compareTo(other.isSetValidationLevel());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetValidationLevel()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetCanEvolve()).compareTo(other.isSetCanEvolve());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCanEvolve()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSchemaGroup()).compareTo(other.isSetSchemaGroup());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSchemaGroup()) {
