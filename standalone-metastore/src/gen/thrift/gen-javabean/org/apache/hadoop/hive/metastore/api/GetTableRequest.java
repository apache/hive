...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class GetTableRequest implements org.apache.thrift.TBase<GetTableRequest, GetTableRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetTableRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.processorCapabilities = new java.util.ArrayList<java.lang.String>(_list970.size);
                ...
                for (int _i972 = 0; _i972 < _list970.size; ++_i972)
                {
                  ...
                  struct.processorCapabilities.add(_elem971);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.processorCapabilities != null) {
        if (struct.isSetProcessorCapabilities()) {
          oprot.writeFieldBegin(PROCESSOR_CAPABILITIES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter973 : struct.processorCapabilities)
            {
  ...
  private static class GetTableRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<GetTableRequest> {
      ...
      if (struct.isSetProcessorCapabilities()) {
        {
          ...
          for (java.lang.String _iter974 : struct.processorCapabilities)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, GetTableRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TList _list975 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.processorCapabilities = new java.util.ArrayList<java.lang.String>(_list975.size);
          ...
          for (int _i977 = 0; _i977 < _list975.size; ++_i977)
          {
            ...
            struct.processorCapabilities.add(_elem976);
          }
        }
        struct.setProcessorCapabilitiesIsSet(true);
      }
