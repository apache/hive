            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.data = new java.util.ArrayList<java.nio.ByteBuffer>(_list222.size);
                @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer _elem223;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FileMetadata struct) throws org.apache.thrift.TException {
      ...
      if (struct.data != null) {
        oprot.writeFieldBegin(DATA_FIELD_DESC);
        {
          ...
          for (java.nio.ByteBuffer _iter225 : struct.data)
          {
      ...
      if (struct.isSetData()) {
        {
          ...
          for (java.nio.ByteBuffer _iter226 : struct.data)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.data = new java.util.ArrayList<java.nio.ByteBuffer>(_list227.size);
