...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class GetPartitionsRequest implements org.apache.thrift.TBase<GetPartitionsRequest, GetPartitionsRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetPartitionsRequest> {
  ...
  public int compareTo(GetPartitionsRequest other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetWithAuth()).compareTo(other.isSetWithAuth());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWithAuth()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetFilterSpec()).compareTo(other.isSetFilterSpec());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFilterSpec()) {
      ...
      if (struct.groupNames != null) {
        if (struct.isSetGroupNames()) {
          oprot.writeFieldBegin(GROUP_NAMES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter1216 : struct.groupNames)
            {
      ...
      if (struct.processorCapabilities != null) {
        if (struct.isSetProcessorCapabilities()) {
          oprot.writeFieldBegin(PROCESSOR_CAPABILITIES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter1217 : struct.processorCapabilities)
            {
  ...
  private static class GetPartitionsRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<GetPartitionsRequest> {
      ...
      if (struct.isSetGroupNames()) {
        {
          ...
          for (java.lang.String _iter1218 : struct.groupNames)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, GetPartitionsRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TList _list1220 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.groupNames = new java.util.ArrayList<java.lang.String>(_list1220.size);
          ...
          for (int _i1222 = 0; _i1222 < _list1220.size; ++_i1222)
          {
            ...
            struct.groupNames.add(_elem1221);
          }
        }
        struct.setGroupNamesIsSet(true);
      }
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.processorCapabilities = new java.util.ArrayList<java.lang.String>(_list1223.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem1224;
          for (int _i1225 = 0; _i1225 < _list1223.size; ++_i1225)
          {
            _elem1224 = iprot.readString();
            struct.processorCapabilities.add(_elem1224);
          }
        }
        struct.setProcessorCapabilitiesIsSet(true);
      }
