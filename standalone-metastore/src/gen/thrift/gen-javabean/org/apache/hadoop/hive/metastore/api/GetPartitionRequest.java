            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partVals = new ArrayList<String>(_list1258.size);
                String _elem1259;
                for (int _i1260 = 0; _i1260 < _list1258.size; ++_i1260)
                {
                  _elem1259 = iprot.readString();
                  struct.partVals.add(_elem1259);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetPartitionRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.partVals != null) {
        oprot.writeFieldBegin(PART_VALS_FIELD_DESC);
        {
          ...
          for (String _iter1261 : struct.partVals)
          {
  ...
  private static class GetPartitionRequestTupleScheme extends TupleScheme<GetPartitionRequest> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, GetPartitionRequest struct) throws org.apache.thrift.TException {
      ...
      struct.setTblNameIsSet(true);
      {
        ...
        struct.partVals = new ArrayList<String>(_list1263.size);
        String _elem1264;
        for (int _i1265 = 0; _i1265 < _list1263.size; ++_i1265)
        {
          _elem1264 = iprot.readString();
          struct.partVals.add(_elem1264);
        }
      }
      struct.setPartValsIsSet(true);
