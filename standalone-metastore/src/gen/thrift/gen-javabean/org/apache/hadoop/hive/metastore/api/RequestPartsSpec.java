        ...
        case NAMES:
          if (field.type == NAMES_FIELD_DESC.type) {
            java.util.List<java.lang.String> names;
            {
              ...
              names = new java.util.ArrayList<java.lang.String>(_list556.size);
        ...
        case EXPRS:
          if (field.type == EXPRS_FIELD_DESC.type) {
            java.util.List<DropPartitionsExpr> exprs;
            {
              ...
              exprs = new java.util.ArrayList<DropPartitionsExpr>(_list559.size);
              @org.apache.thrift.annotation.Nullable DropPartitionsExpr _elem560;
              for (int _i561 = 0; _i561 < _list559.size; ++_i561)
              {
                _elem560 = new DropPartitionsExpr();
                _elem560.read(iprot);
                exprs.add(_elem560);
              }
              iprot.readListEnd();
    ...
    switch (setField_) {
      case NAMES:
        java.util.List<java.lang.String> names = (java.util.List<java.lang.String>)value_;
        {
          ...
          for (java.lang.String _iter562 : names)
          {
      ...
      case EXPRS:
        java.util.List<DropPartitionsExpr> exprs = (java.util.List<DropPartitionsExpr>)value_;
        {
          ...
          for (DropPartitionsExpr _iter563 : exprs)
          {
      ...
      switch (setField) {
        case NAMES:
          java.util.List<java.lang.String> names;
          {
            ...
            names = new java.util.ArrayList<java.lang.String>(_list564.size);
        ...
        case EXPRS:
          java.util.List<DropPartitionsExpr> exprs;
          {
            ...
            exprs = new java.util.ArrayList<DropPartitionsExpr>(_list567.size);
            @org.apache.thrift.annotation.Nullable DropPartitionsExpr _elem568;
            for (int _i569 = 0; _i569 < _list567.size; ++_i569)
            {
              _elem568 = new DropPartitionsExpr();
              _elem568.read(iprot);
              exprs.add(_elem568);
            }
            iprot.readListEnd();
  ...
  protected void tupleSchemeWriteValue(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    switch (setField_) {
      case NAMES:
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, names.size()));
          for (java.lang.String _iter570 : names)
          {
      ...
      case EXPRS:
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, exprs.size()));
          for (DropPartitionsExpr _iter571 : exprs)
          {
