...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class WMGetResourcePlanResponse implements org.apache.thrift.TBase<WMGetResourcePlanResponse, WMGetResourcePlanResponse._Fields>, java.io.Serializable, Cloneable, Comparable<WMGetResourcePlanResponse> {
  ...
  static {
    schemes.put(StandardScheme.class, new WMGetResourcePlanResponseStandardSchemeFactory());
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("WMGetResourcePlanResponse(");
    boolean first = true;
  ...
  private static class WMGetResourcePlanResponseStandardSchemeFactory implements SchemeFactory {
    public WMGetResourcePlanResponseStandardScheme getScheme() {
      return new WMGetResourcePlanResponseStandardScheme();
    }
  }

  private static class WMGetResourcePlanResponseStandardScheme extends StandardScheme<WMGetResourcePlanResponse> {
  ...
  private static class WMGetResourcePlanResponseTupleSchemeFactory implements SchemeFactory {
    public WMGetResourcePlanResponseTupleScheme getScheme() {
      return new WMGetResourcePlanResponseTupleScheme();
    }
  }

  private static class WMGetResourcePlanResponseTupleScheme extends TupleScheme<WMGetResourcePlanResponse> {
