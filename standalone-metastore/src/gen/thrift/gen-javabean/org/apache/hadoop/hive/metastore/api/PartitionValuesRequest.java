            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitionKeys = new java.util.ArrayList<FieldSchema>(_list522.size);
                @org.apache.thrift.annotation.Nullable FieldSchema _elem523;
                for (int _i524 = 0; _i524 < _list522.size; ++_i524)
                {
                  _elem523 = new FieldSchema();
                  _elem523.read(iprot);
                  struct.partitionKeys.add(_elem523);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitionOrder = new java.util.ArrayList<FieldSchema>(_list525.size);
                ...
                for (int _i527 = 0; _i527 < _list525.size; ++_i527)
                {
                  ...
                  _elem526.read(iprot);
                  struct.partitionOrder.add(_elem526);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PartitionValuesRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.partitionKeys != null) {
        oprot.writeFieldBegin(PARTITION_KEYS_FIELD_DESC);
        {
          ...
          for (FieldSchema _iter528 : struct.partitionKeys)
          {
      ...
      if (struct.partitionOrder != null) {
        if (struct.isSetPartitionOrder()) {
          oprot.writeFieldBegin(PARTITION_ORDER_FIELD_DESC);
          {
            ...
            for (FieldSchema _iter529 : struct.partitionOrder)
            {
  ...
  private static class PartitionValuesRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<PartitionValuesRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, PartitionValuesRequest struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.tblName);
      {
        ...
        for (FieldSchema _iter530 : struct.partitionKeys)
        {
      ...
      if (struct.isSetPartitionOrder()) {
        {
          ...
          for (FieldSchema _iter531 : struct.partitionOrder)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, PartitionValuesRequest struct) throws org.apache.thrift.TException {
      ...
      struct.setTblNameIsSet(true);
      {
        ...
        struct.partitionKeys = new java.util.ArrayList<FieldSchema>(_list532.size);
        @org.apache.thrift.annotation.Nullable FieldSchema _elem533;
        for (int _i534 = 0; _i534 < _list532.size; ++_i534)
        {
          _elem533 = new FieldSchema();
          _elem533.read(iprot);
          struct.partitionKeys.add(_elem533);
        }
      }
      struct.setPartitionKeysIsSet(true);
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.partitionOrder = new java.util.ArrayList<FieldSchema>(_list535.size);
          ...
          for (int _i537 = 0; _i537 < _list535.size; ++_i537)
          {
            ...
            _elem536.read(iprot);
            struct.partitionOrder.add(_elem536);
          }
        }
        struct.setPartitionOrderIsSet(true);
      }
