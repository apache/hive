            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitionKeys = new java.util.ArrayList<FieldSchema>(_list530.size);
                @org.apache.thrift.annotation.Nullable FieldSchema _elem531;
                for (int _i532 = 0; _i532 < _list530.size; ++_i532)
                {
                  _elem531 = new FieldSchema();
                  _elem531.read(iprot);
                  struct.partitionKeys.add(_elem531);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitionOrder = new java.util.ArrayList<FieldSchema>(_list533.size);
                @org.apache.thrift.annotation.Nullable FieldSchema _elem534;
                for (int _i535 = 0; _i535 < _list533.size; ++_i535)
                {
                  _elem534 = new FieldSchema();
                  _elem534.read(iprot);
                  struct.partitionOrder.add(_elem534);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PartitionValuesRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.partitionKeys != null) {
        oprot.writeFieldBegin(PARTITION_KEYS_FIELD_DESC);
        {
          ...
          for (FieldSchema _iter536 : struct.partitionKeys)
          {
      ...
      if (struct.partitionOrder != null) {
        if (struct.isSetPartitionOrder()) {
          oprot.writeFieldBegin(PARTITION_ORDER_FIELD_DESC);
          {
            ...
            for (FieldSchema _iter537 : struct.partitionOrder)
            {
  ...
  private static class PartitionValuesRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<PartitionValuesRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, PartitionValuesRequest struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.tblName);
      {
        ...
        for (FieldSchema _iter538 : struct.partitionKeys)
        {
      ...
      if (struct.isSetPartitionOrder()) {
        {
          ...
          for (FieldSchema _iter539 : struct.partitionOrder)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, PartitionValuesRequest struct) throws org.apache.thrift.TException {
      ...
      struct.setTblNameIsSet(true);
      {
        org.apache.thrift.protocol.TList _list540 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.partitionKeys = new java.util.ArrayList<FieldSchema>(_list540.size);
        @org.apache.thrift.annotation.Nullable FieldSchema _elem541;
        for (int _i542 = 0; _i542 < _list540.size; ++_i542)
        {
          _elem541 = new FieldSchema();
          _elem541.read(iprot);
          struct.partitionKeys.add(_elem541);
        }
      }
      struct.setPartitionKeysIsSet(true);
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.partitionOrder = new java.util.ArrayList<FieldSchema>(_list543.size);
          @org.apache.thrift.annotation.Nullable FieldSchema _elem544;
          for (int _i545 = 0; _i545 < _list543.size; ++_i545)
          {
            _elem544 = new FieldSchema();
            _elem544.read(iprot);
            struct.partitionOrder.add(_elem544);
          }
        }
        struct.setPartitionOrderIsSet(true);
      }
