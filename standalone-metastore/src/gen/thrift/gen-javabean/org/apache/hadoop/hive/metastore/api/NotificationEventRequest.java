            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.eventTypeSkipList = new java.util.ArrayList<java.lang.String>(_list806.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem807;
                for (int _i808 = 0; _i808 < _list806.size; ++_i808)
                {
                  _elem807 = iprot.readString();
                  struct.eventTypeSkipList.add(_elem807);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.eventTypeSkipList != null) {
        if (struct.isSetEventTypeSkipList()) {
          oprot.writeFieldBegin(EVENT_TYPE_SKIP_LIST_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter809 : struct.eventTypeSkipList)
            {
      ...
      if (struct.isSetEventTypeSkipList()) {
        {
          ...
          for (java.lang.String _iter810 : struct.eventTypeSkipList)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.eventTypeSkipList = new java.util.ArrayList<java.lang.String>(_list811.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem812;
          for (int _i813 = 0; _i813 < _list811.size; ++_i813)
          {
            _elem812 = iprot.readString();
            struct.eventTypeSkipList.add(_elem812);
          }
        }
        struct.setEventTypeSkipListIsSet(true);
      }
