            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.schemaVersions = new ArrayList<SchemaVersionDescriptor>(_list882.size);
                SchemaVersionDescriptor _elem883;
                for (int _i884 = 0; _i884 < _list882.size; ++_i884)
                {
                  _elem883 = new SchemaVersionDescriptor();
                  _elem883.read(iprot);
                  struct.schemaVersions.add(_elem883);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FindSchemasByColsResp struct) throws org.apache.thrift.TException {
      ...
      if (struct.schemaVersions != null) {
        oprot.writeFieldBegin(SCHEMA_VERSIONS_FIELD_DESC);
        {
          ...
          for (SchemaVersionDescriptor _iter885 : struct.schemaVersions)
          {
      ...
      if (struct.isSetSchemaVersions()) {
        {
          ...
          for (SchemaVersionDescriptor _iter886 : struct.schemaVersions)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.schemaVersions = new ArrayList<SchemaVersionDescriptor>(_list887.size);
          SchemaVersionDescriptor _elem888;
          for (int _i889 = 0; _i889 < _list887.size; ++_i889)
          {
            _elem888 = new SchemaVersionDescriptor();
            _elem888.read(iprot);
            struct.schemaVersions.add(_elem888);
          }
        }
        struct.setSchemaVersionsIsSet(true);
      }
