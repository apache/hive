...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class FindSchemasByColsResp implements org.apache.thrift.TBase<FindSchemasByColsResp, FindSchemasByColsResp._Fields>, java.io.Serializable, Cloneable, Comparable<FindSchemasByColsResp> {
  ...
  public int compareTo(FindSchemasByColsResp other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSchemaVersions()).compareTo(other.isSetSchemaVersions());
    if (lastComparison != 0) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.schemaVersions = new java.util.ArrayList<SchemaVersionDescriptor>(_list1106.size);
                @org.apache.thrift.annotation.Nullable SchemaVersionDescriptor _elem1107;
                for (int _i1108 = 0; _i1108 < _list1106.size; ++_i1108)
                {
                  _elem1107 = new SchemaVersionDescriptor();
                  _elem1107.read(iprot);
                  struct.schemaVersions.add(_elem1107);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FindSchemasByColsResp struct) throws org.apache.thrift.TException {
      ...
      if (struct.schemaVersions != null) {
        oprot.writeFieldBegin(SCHEMA_VERSIONS_FIELD_DESC);
        {
          ...
          for (SchemaVersionDescriptor _iter1109 : struct.schemaVersions)
          {
      ...
      if (struct.isSetSchemaVersions()) {
        {
          ...
          for (SchemaVersionDescriptor _iter1110 : struct.schemaVersions)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.schemaVersions = new java.util.ArrayList<SchemaVersionDescriptor>(_list1111.size);
          @org.apache.thrift.annotation.Nullable SchemaVersionDescriptor _elem1112;
          for (int _i1113 = 0; _i1113 < _list1111.size; ++_i1113)
          {
            _elem1112 = new SchemaVersionDescriptor();
            _elem1112.read(iprot);
            struct.schemaVersions.add(_elem1112);
          }
        }
        struct.setSchemaVersionsIsSet(true);
      }
