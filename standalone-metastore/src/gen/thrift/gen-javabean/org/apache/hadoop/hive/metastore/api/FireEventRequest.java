            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitionVals = new java.util.ArrayList<java.lang.String>(_list862.size);
                ...
                for (int _i864 = 0; _i864 < _list862.size; ++_i864)
                {
                  ...
                  struct.partitionVals.add(_elem863);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.partitionVals != null) {
        if (struct.isSetPartitionVals()) {
          oprot.writeFieldBegin(PARTITION_VALS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter865 : struct.partitionVals)
            {
      ...
      if (struct.isSetPartitionVals()) {
        {
          ...
          for (java.lang.String _iter866 : struct.partitionVals)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.partitionVals = new java.util.ArrayList<java.lang.String>(_list867.size);
          ...
          for (int _i869 = 0; _i869 < _list867.size; ++_i869)
          {
            ...
            struct.partitionVals.add(_elem868);
          }
        }
        struct.setPartitionValsIsSet(true);
      }
