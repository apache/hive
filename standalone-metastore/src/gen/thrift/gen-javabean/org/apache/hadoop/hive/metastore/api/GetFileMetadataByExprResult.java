...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class GetFileMetadataByExprResult implements org.apache.thrift.TBase<GetFileMetadataByExprResult, GetFileMetadataByExprResult._Fields>, java.io.Serializable, Cloneable, Comparable<GetFileMetadataByExprResult> {
  ...
  public int compareTo(GetFileMetadataByExprResult other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetIsSupported()).compareTo(other.isSetIsSupported());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIsSupported()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.metadata = new java.util.HashMap<java.lang.Long,MetadataPpdResult>(2*_map804.size);
                long _key805;
                @org.apache.thrift.annotation.Nullable MetadataPpdResult _val806;
                for (int _i807 = 0; _i807 < _map804.size; ++_i807)
                {
                  _key805 = iprot.readI64();
                  _val806 = new MetadataPpdResult();
                  _val806.read(iprot);
                  struct.metadata.put(_key805, _val806);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetFileMetadataByExprResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.metadata != null) {
        oprot.writeFieldBegin(METADATA_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, MetadataPpdResult> _iter808 : struct.metadata.entrySet())
          {
            oprot.writeI64(_iter808.getKey());
            _iter808.getValue().write(oprot);
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class GetFileMetadataByExprResultTupleScheme extends org.apache.thrift.scheme.TupleScheme<GetFileMetadataByExprResult> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, GetFileMetadataByExprResult struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (java.util.Map.Entry<java.lang.Long, MetadataPpdResult> _iter809 : struct.metadata.entrySet())
        {
          oprot.writeI64(_iter809.getKey());
          _iter809.getValue().write(oprot);
        }
      }
      oprot.writeBool(struct.isSupported);
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, GetFileMetadataByExprResult struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TMap _map810 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.metadata = new java.util.HashMap<java.lang.Long,MetadataPpdResult>(2*_map810.size);
        long _key811;
        @org.apache.thrift.annotation.Nullable MetadataPpdResult _val812;
        for (int _i813 = 0; _i813 < _map810.size; ++_i813)
        {
          _key811 = iprot.readI64();
          _val812 = new MetadataPpdResult();
          _val812.read(iprot);
          struct.metadata.put(_key811, _val812);
        }
      }
      struct.setMetadataIsSet(true);
      struct.isSupported = iprot.readBool();
