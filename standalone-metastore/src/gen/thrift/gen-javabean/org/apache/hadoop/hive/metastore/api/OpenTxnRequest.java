...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class OpenTxnRequest implements org.apache.thrift.TBase<OpenTxnRequest, OpenTxnRequest._Fields>, java.io.Serializable, Cloneable, Comparable<OpenTxnRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.replSrcTxnIds = new java.util.ArrayList<java.lang.Long>(_list652.size);
                long _elem653;
                for (int _i654 = 0; _i654 < _list652.size; ++_i654)
                {
                  _elem653 = iprot.readI64();
                  struct.replSrcTxnIds.add(_elem653);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.replSrcTxnIds != null) {
        if (struct.isSetReplSrcTxnIds()) {
          oprot.writeFieldBegin(REPL_SRC_TXN_IDS_FIELD_DESC);
          {
            ...
            for (long _iter655 : struct.replSrcTxnIds)
            {
              oprot.writeI64(_iter655);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class OpenTxnRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<OpenTxnRequest> {
      ...
      if (struct.isSetReplSrcTxnIds()) {
        {
          ...
          for (long _iter656 : struct.replSrcTxnIds)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, OpenTxnRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list657 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.replSrcTxnIds = new java.util.ArrayList<java.lang.Long>(_list657.size);
          long _elem658;
          for (int _i659 = 0; _i659 < _list657.size; ++_i659)
          {
            _elem658 = iprot.readI64();
            struct.replSrcTxnIds.add(_elem658);
          }
        }
        struct.setReplSrcTxnIdsIsSet(true);
      }
