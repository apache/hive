            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.processorCapabilities = new java.util.ArrayList<java.lang.String>(_list1186.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem1187;
                for (int _i1188 = 0; _i1188 < _list1186.size; ++_i1188)
                {
                  _elem1187 = iprot.readString();
                  struct.processorCapabilities.add(_elem1187);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.isSetProcessorCapabilities()) {
        {
          ...
          for (java.lang.String _iter1190 : struct.processorCapabilities)
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.processorCapabilities = new java.util.ArrayList<java.lang.String>(_list1191.size);
          ...
          for (int _i1193 = 0; _i1193 < _list1191.size; ++_i1193)
          {
            ...
            struct.processorCapabilities.add(_elem1192);
          }
        }
        struct.setProcessorCapabilitiesIsSet(true);
      }
