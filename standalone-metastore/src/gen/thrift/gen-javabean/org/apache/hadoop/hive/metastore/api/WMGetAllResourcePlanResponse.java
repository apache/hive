...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class WMGetAllResourcePlanResponse implements org.apache.thrift.TBase<WMGetAllResourcePlanResponse, WMGetAllResourcePlanResponse._Fields>, java.io.Serializable, Cloneable, Comparable<WMGetAllResourcePlanResponse> {
  ...
  public int compareTo(WMGetAllResourcePlanResponse other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetResourcePlans()).compareTo(other.isSetResourcePlans());
    if (lastComparison != 0) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resourcePlans = new java.util.ArrayList<WMResourcePlan>(_list1066.size);
                @org.apache.thrift.annotation.Nullable WMResourcePlan _elem1067;
                for (int _i1068 = 0; _i1068 < _list1066.size; ++_i1068)
                {
                  _elem1067 = new WMResourcePlan();
                  _elem1067.read(iprot);
                  struct.resourcePlans.add(_elem1067);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.resourcePlans != null) {
        if (struct.isSetResourcePlans()) {
          oprot.writeFieldBegin(RESOURCE_PLANS_FIELD_DESC);
          {
            ...
            for (WMResourcePlan _iter1069 : struct.resourcePlans)
            {
      ...
      if (struct.isSetResourcePlans()) {
        {
          ...
          for (WMResourcePlan _iter1070 : struct.resourcePlans)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.resourcePlans = new java.util.ArrayList<WMResourcePlan>(_list1071.size);
          @org.apache.thrift.annotation.Nullable WMResourcePlan _elem1072;
          for (int _i1073 = 0; _i1073 < _list1071.size; ++_i1073)
          {
            _elem1072 = new WMResourcePlan();
            _elem1072.read(iprot);
            struct.resourcePlans.add(_elem1072);
          }
        }
        struct.setResourcePlansIsSet(true);
      }
