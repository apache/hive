            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitions = new java.util.ArrayList<PartitionWithoutSD>(_list318.size);
                @org.apache.thrift.annotation.Nullable PartitionWithoutSD _elem319;
                for (int _i320 = 0; _i320 < _list318.size; ++_i320)
                {
                  _elem319 = new PartitionWithoutSD();
                  _elem319.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PartitionSpecWithSharedSD struct) throws org.apache.thrift.TException {
      ...
      if (struct.partitions != null) {
        oprot.writeFieldBegin(PARTITIONS_FIELD_DESC);
        {
          ...
          for (PartitionWithoutSD _iter321 : struct.partitions)
          {
      ...
      if (struct.isSetPartitions()) {
        {
          ...
          for (PartitionWithoutSD _iter322 : struct.partitions)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.partitions = new java.util.ArrayList<PartitionWithoutSD>(_list323.size);
          @org.apache.thrift.annotation.Nullable PartitionWithoutSD _elem324;
          for (int _i325 = 0; _i325 < _list323.size; ++_i325)
          {
            _elem324 = new PartitionWithoutSD();
            _elem324.read(iprot);
