            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitionList = new java.util.ArrayList<java.lang.String>(_list676.size);
                ...
                for (int _i678 = 0; _i678 < _list676.size; ++_i678)
                {
                  ...
                  struct.partitionList.add(_elem677);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.partitionList != null) {
        if (struct.isSetPartitionList()) {
          oprot.writeFieldBegin(PARTITION_LIST_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter679 : struct.partitionList)
            {
      ...
      if (struct.isSetPartitionList()) {
        {
          ...
          for (java.lang.String _iter680 : struct.partitionList)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.partitionList = new java.util.ArrayList<java.lang.String>(_list681.size);
          ...
          for (int _i683 = 0; _i683 < _list681.size; ++_i683)
          {
            ...
            struct.partitionList.add(_elem682);
          }
        }
        struct.setPartitionListIsSet(true);
      }
