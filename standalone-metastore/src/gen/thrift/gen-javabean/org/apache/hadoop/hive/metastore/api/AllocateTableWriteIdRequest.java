...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class AllocateTableWriteIdRequest implements org.apache.thrift.TBase<AllocateTableWriteIdRequest, AllocateTableWriteIdRequest._Fields>, java.io.Serializable, Cloneable, Comparable<AllocateTableWriteIdRequest> {
  ...
  static {
    schemes.put(StandardScheme.class, new AllocateTableWriteIdRequestStandardSchemeFactory());
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AllocateTableWriteIdRequest.class, metaDataMap);
  }
  ...
  public AllocateTableWriteIdRequest deepCopy() {
    return new AllocateTableWriteIdRequest(this);
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AllocateTableWriteIdRequest)
      return this.equals((AllocateTableWriteIdRequest)that);
    return false;
  }

  public boolean equals(AllocateTableWriteIdRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(AllocateTableWriteIdRequest other) {
  ...
  private static class AllocateTableWriteIdRequestStandardSchemeFactory implements SchemeFactory {
    public AllocateTableWriteIdRequestStandardScheme getScheme() {
      return new AllocateTableWriteIdRequestStandardScheme();
    }
  }

  private static class AllocateTableWriteIdRequestStandardScheme extends StandardScheme<AllocateTableWriteIdRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AllocateTableWriteIdRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AllocateTableWriteIdRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class AllocateTableWriteIdRequestTupleSchemeFactory implements SchemeFactory {
    public AllocateTableWriteIdRequestTupleScheme getScheme() {
      return new AllocateTableWriteIdRequestTupleScheme();
    }
  }

  private static class AllocateTableWriteIdRequestTupleScheme extends TupleScheme<AllocateTableWriteIdRequest> {
