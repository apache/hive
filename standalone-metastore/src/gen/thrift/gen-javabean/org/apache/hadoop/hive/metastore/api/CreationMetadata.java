        ...
        switch (schemeField.id) {
          ...
          case 4: // TABLES_USED
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set724 = iprot.readSetBegin();
                struct.tablesUsed = new HashSet<String>(2*_set724.size);
                String _elem725;
                for (int _i726 = 0; _i726 < _set724.size; ++_i726)
                {
                  _elem725 = iprot.readString();
                  struct.tablesUsed.add(_elem725);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CreationMetadata struct) throws org.apache.thrift.TException {
      ...
      if (struct.tablesUsed != null) {
        oprot.writeFieldBegin(TABLES_USED_FIELD_DESC);
        {
          ...
          for (String _iter727 : struct.tablesUsed)
          {
  ...
  private static class CreationMetadataTupleScheme extends TupleScheme<CreationMetadata> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, CreationMetadata struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.tblName);
      {
        ...
        for (String _iter728 : struct.tablesUsed)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, CreationMetadata struct) throws org.apache.thrift.TException {
      ...
      struct.setTblNameIsSet(true);
      {
        org.apache.thrift.protocol.TSet _set729 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
        struct.tablesUsed = new HashSet<String>(2*_set729.size);
        String _elem730;
        for (int _i731 = 0; _i731 < _set729.size; ++_i731)
        {
          _elem730 = iprot.readString();
          struct.tablesUsed.add(_elem730);
        }
      }
      struct.setTablesUsedIsSet(true);
