            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.functions = new java.util.ArrayList<Function>(_list946.size);
                @org.apache.thrift.annotation.Nullable Function _elem947;
                for (int _i948 = 0; _i948 < _list946.size; ++_i948)
                {
                  _elem947 = new Function();
                  _elem947.read(iprot);
                  struct.functions.add(_elem947);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.functions != null) {
        if (struct.isSetFunctions()) {
          oprot.writeFieldBegin(FUNCTIONS_FIELD_DESC);
          {
            ...
            for (Function _iter949 : struct.functions)
            {
      ...
      if (struct.isSetFunctions()) {
        {
          ...
          for (Function _iter950 : struct.functions)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.functions = new java.util.ArrayList<Function>(_list951.size);
          @org.apache.thrift.annotation.Nullable Function _elem952;
          for (int _i953 = 0; _i953 < _list951.size; ++_i953)
          {
            _elem952 = new Function();
            _elem952.read(iprot);
            struct.functions.add(_elem952);
          }
        }
        struct.setFunctionsIsSet(true);
      }
