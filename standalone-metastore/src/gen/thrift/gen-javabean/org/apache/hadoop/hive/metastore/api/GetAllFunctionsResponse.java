            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.functions = new java.util.ArrayList<Function>(_list864.size);
                @org.apache.thrift.annotation.Nullable Function _elem865;
                for (int _i866 = 0; _i866 < _list864.size; ++_i866)
                {
                  _elem865 = new Function();
                  _elem865.read(iprot);
                  struct.functions.add(_elem865);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.functions = new java.util.ArrayList<Function>(_list869.size);
          @org.apache.thrift.annotation.Nullable Function _elem870;
          for (int _i871 = 0; _i871 < _list869.size; ++_i871)
          {
            _elem870 = new Function();
            _elem870.read(iprot);
            struct.functions.add(_elem870);
          }
        }
        struct.setFunctionsIsSet(true);
      }
