...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class Table implements org.apache.thrift.TBase<Table, Table._Fields>, java.io.Serializable, Cloneable, Comparable<Table> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitionKeys = new java.util.ArrayList<FieldSchema>(_list248.size);
                @org.apache.thrift.annotation.Nullable FieldSchema _elem249;
                for (int _i250 = 0; _i250 < _list248.size; ++_i250)
                {
                  _elem249 = new FieldSchema();
                  _elem249.read(iprot);
                  struct.partitionKeys.add(_elem249);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.parameters = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map251.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key252;
                @org.apache.thrift.annotation.Nullable java.lang.String _val253;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.requiredReadCapabilities = new java.util.ArrayList<java.lang.String>(_list255.size);
                ...
                for (int _i257 = 0; _i257 < _list255.size; ++_i257)
                {
                  ...
                  struct.requiredReadCapabilities.add(_elem256);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.requiredWriteCapabilities = new java.util.ArrayList<java.lang.String>(_list258.size);
                ...
                for (int _i260 = 0; _i260 < _list258.size; ++_i260)
                {
                  ...
                  struct.requiredWriteCapabilities.add(_elem259);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Table struct) throws org.apache.thrift.TException {
      ...
      if (struct.partitionKeys != null) {
        oprot.writeFieldBegin(PARTITION_KEYS_FIELD_DESC);
        {
          ...
          for (FieldSchema _iter261 : struct.partitionKeys)
          {
      ...
      if (struct.parameters != null) {
        oprot.writeFieldBegin(PARAMETERS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter262 : struct.parameters.entrySet())
          {
      ...
      if (struct.requiredReadCapabilities != null) {
        if (struct.isSetRequiredReadCapabilities()) {
          oprot.writeFieldBegin(REQUIRED_READ_CAPABILITIES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter263 : struct.requiredReadCapabilities)
            {
      ...
      if (struct.requiredWriteCapabilities != null) {
        if (struct.isSetRequiredWriteCapabilities()) {
          oprot.writeFieldBegin(REQUIRED_WRITE_CAPABILITIES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter264 : struct.requiredWriteCapabilities)
            {
  ...
  private static class TableTupleScheme extends org.apache.thrift.scheme.TupleScheme<Table> {
      ...
      if (struct.isSetPartitionKeys()) {
        {
          ...
          for (FieldSchema _iter265 : struct.partitionKeys)
          {
      ...
      if (struct.isSetRequiredReadCapabilities()) {
        {
          ...
          for (java.lang.String _iter267 : struct.requiredReadCapabilities)
          {
      ...
      if (struct.isSetRequiredWriteCapabilities()) {
        {
          ...
          for (java.lang.String _iter268 : struct.requiredWriteCapabilities)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Table struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.partitionKeys = new java.util.ArrayList<FieldSchema>(_list269.size);
          @org.apache.thrift.annotation.Nullable FieldSchema _elem270;
          for (int _i271 = 0; _i271 < _list269.size; ++_i271)
          {
            _elem270 = new FieldSchema();
            _elem270.read(iprot);
            struct.partitionKeys.add(_elem270);
          }
        }
        struct.setPartitionKeysIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.parameters = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map272.size);
          ...
          for (int _i275 = 0; _i275 < _map272.size; ++_i275)
          {
            ...
            struct.parameters.put(_key273, _val274);
          }
        }
        struct.setParametersIsSet(true);
      }
      ...
      if (incoming.get(22)) {
        {
          org.apache.thrift.protocol.TList _list276 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.requiredReadCapabilities = new java.util.ArrayList<java.lang.String>(_list276.size);
          ...
          for (int _i278 = 0; _i278 < _list276.size; ++_i278)
          {
            ...
            struct.requiredReadCapabilities.add(_elem277);
          }
        }
        struct.setRequiredReadCapabilitiesIsSet(true);
      }
      if (incoming.get(23)) {
        {
          ...
          struct.requiredWriteCapabilities = new java.util.ArrayList<java.lang.String>(_list279.size);
          ...
          for (int _i281 = 0; _i281 < _list279.size; ++_i281)
          {
            ...
            struct.requiredWriteCapabilities.add(_elem280);
          }
        }
        struct.setRequiredWriteCapabilitiesIsSet(true);
      }
