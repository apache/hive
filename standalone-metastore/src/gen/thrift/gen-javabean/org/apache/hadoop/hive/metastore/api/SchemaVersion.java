            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.cols = new java.util.ArrayList<FieldSchema>(_list1098.size);
                @org.apache.thrift.annotation.Nullable FieldSchema _elem1099;
                for (int _i1100 = 0; _i1100 < _list1098.size; ++_i1100)
                {
                  _elem1099 = new FieldSchema();
                  _elem1099.read(iprot);
                  struct.cols.add(_elem1099);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SchemaVersion struct) throws org.apache.thrift.TException {
      ...
      if (struct.cols != null) {
        oprot.writeFieldBegin(COLS_FIELD_DESC);
        {
          ...
          for (FieldSchema _iter1101 : struct.cols)
          {
      ...
      if (struct.isSetCols()) {
        {
          ...
          for (FieldSchema _iter1102 : struct.cols)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.cols = new java.util.ArrayList<FieldSchema>(_list1103.size);
          @org.apache.thrift.annotation.Nullable FieldSchema _elem1104;
          for (int _i1105 = 0; _i1105 < _list1103.size; ++_i1105)
          {
            _elem1104 = new FieldSchema();
            _elem1104.read(iprot);
            struct.cols.add(_elem1104);
          }
        }
        struct.setColsIsSet(true);
      }
