            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.cols = new ArrayList<FieldSchema>(_list874.size);
                FieldSchema _elem875;
                for (int _i876 = 0; _i876 < _list874.size; ++_i876)
                {
                  _elem875 = new FieldSchema();
                  _elem875.read(iprot);
                  struct.cols.add(_elem875);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SchemaVersion struct) throws org.apache.thrift.TException {
      ...
      if (struct.cols != null) {
        oprot.writeFieldBegin(COLS_FIELD_DESC);
        {
          ...
          for (FieldSchema _iter877 : struct.cols)
          {
      ...
      if (struct.isSetCols()) {
        {
          ...
          for (FieldSchema _iter878 : struct.cols)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.cols = new ArrayList<FieldSchema>(_list879.size);
          FieldSchema _elem880;
          for (int _i881 = 0; _i881 < _list879.size; ++_i881)
          {
            _elem880 = new FieldSchema();
            _elem880.read(iprot);
            struct.cols.add(_elem880);
          }
        }
        struct.setColsIsSet(true);
      }
