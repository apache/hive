...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class SQLForeignKey implements org.apache.thrift.TBase<SQLForeignKey, SQLForeignKey._Fields>, java.io.Serializable, Cloneable, Comparable<SQLForeignKey> {
  ...
  public int compareTo(SQLForeignKey other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetPktable_db()).compareTo(other.isSetPktable_db());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetPktable_name()).compareTo(other.isSetPktable_name());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPktable_name()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetPkcolumn_name()).compareTo(other.isSetPkcolumn_name());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPkcolumn_name()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetFktable_db()).compareTo(other.isSetFktable_db());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFktable_db()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetFktable_name()).compareTo(other.isSetFktable_name());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFktable_name()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetFkcolumn_name()).compareTo(other.isSetFkcolumn_name());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFkcolumn_name()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetDelete_rule()).compareTo(other.isSetDelete_rule());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDelete_rule()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetFk_name()).compareTo(other.isSetFk_name());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFk_name()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetPk_name()).compareTo(other.isSetPk_name());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPk_name()) {
