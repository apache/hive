            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resourceUris = new java.util.ArrayList<ResourceUri>(_list628.size);
                @org.apache.thrift.annotation.Nullable ResourceUri _elem629;
                for (int _i630 = 0; _i630 < _list628.size; ++_i630)
                {
                  _elem629 = new ResourceUri();
                  _elem629.read(iprot);
                  struct.resourceUris.add(_elem629);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Function struct) throws org.apache.thrift.TException {
      ...
      if (struct.resourceUris != null) {
        oprot.writeFieldBegin(RESOURCE_URIS_FIELD_DESC);
        {
          ...
          for (ResourceUri _iter631 : struct.resourceUris)
          {
      ...
      if (struct.isSetResourceUris()) {
        {
          ...
          for (ResourceUri _iter632 : struct.resourceUris)
          {
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.resourceUris = new java.util.ArrayList<ResourceUri>(_list633.size);
          @org.apache.thrift.annotation.Nullable ResourceUri _elem634;
          for (int _i635 = 0; _i635 < _list633.size; ++_i635)
          {
            _elem634 = new ResourceUri();
            _elem634.read(iprot);
            struct.resourceUris.add(_elem634);
          }
        }
        struct.setResourceUrisIsSet(true);
      }
