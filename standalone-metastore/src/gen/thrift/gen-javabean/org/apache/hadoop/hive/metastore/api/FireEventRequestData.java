        ...
        case INSERT_DATAS:
          if (field.type == INSERT_DATAS_FIELD_DESC.type) {
            java.util.List<InsertEventRequestData> insertDatas;
            {
              ...
              insertDatas = new java.util.ArrayList<InsertEventRequestData>(_list854.size);
              @org.apache.thrift.annotation.Nullable InsertEventRequestData _elem855;
              for (int _i856 = 0; _i856 < _list854.size; ++_i856)
              {
                _elem855 = new InsertEventRequestData();
                _elem855.read(iprot);
                insertDatas.add(_elem855);
              }
              iprot.readListEnd();
            }
            return insertDatas;
    ...
    switch (setField_) {
      ...
      case INSERT_DATAS:
        java.util.List<InsertEventRequestData> insertDatas = (java.util.List<InsertEventRequestData>)value_;
        {
          ...
          for (InsertEventRequestData _iter857 : insertDatas)
          {
      ...
      switch (setField) {
        ...
        case INSERT_DATAS:
          java.util.List<InsertEventRequestData> insertDatas;
          {
            ...
            insertDatas = new java.util.ArrayList<InsertEventRequestData>(_list858.size);
            @org.apache.thrift.annotation.Nullable InsertEventRequestData _elem859;
            for (int _i860 = 0; _i860 < _list858.size; ++_i860)
            {
              _elem859 = new InsertEventRequestData();
              _elem859.read(iprot);
              insertDatas.add(_elem859);
            }
            iprot.readListEnd();
          }
          return insertDatas;
  ...
  protected void tupleSchemeWriteValue(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    switch (setField_) {
      ...
      case INSERT_DATAS:
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, insertDatas.size()));
          for (InsertEventRequestData _iter861 : insertDatas)
          {
