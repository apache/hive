            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pools = new java.util.ArrayList<WMPool>(_list1034.size);
                @org.apache.thrift.annotation.Nullable WMPool _elem1035;
                for (int _i1036 = 0; _i1036 < _list1034.size; ++_i1036)
                {
                  _elem1035 = new WMPool();
                  _elem1035.read(iprot);
                  struct.pools.add(_elem1035);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.mappings = new java.util.ArrayList<WMMapping>(_list1037.size);
                @org.apache.thrift.annotation.Nullable WMMapping _elem1038;
                for (int _i1039 = 0; _i1039 < _list1037.size; ++_i1039)
                {
                  _elem1038 = new WMMapping();
                  _elem1038.read(iprot);
                  struct.mappings.add(_elem1038);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.triggers = new java.util.ArrayList<WMTrigger>(_list1040.size);
                @org.apache.thrift.annotation.Nullable WMTrigger _elem1041;
                for (int _i1042 = 0; _i1042 < _list1040.size; ++_i1042)
                {
                  _elem1041 = new WMTrigger();
                  _elem1041.read(iprot);
                  struct.triggers.add(_elem1041);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.poolTriggers = new java.util.ArrayList<WMPoolTrigger>(_list1043.size);
                @org.apache.thrift.annotation.Nullable WMPoolTrigger _elem1044;
                for (int _i1045 = 0; _i1045 < _list1043.size; ++_i1045)
                {
                  _elem1044 = new WMPoolTrigger();
                  _elem1044.read(iprot);
                  struct.poolTriggers.add(_elem1044);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WMFullResourcePlan struct) throws org.apache.thrift.TException {
      ...
      if (struct.pools != null) {
        oprot.writeFieldBegin(POOLS_FIELD_DESC);
        {
          ...
          for (WMPool _iter1046 : struct.pools)
          {
      ...
      if (struct.mappings != null) {
        if (struct.isSetMappings()) {
          oprot.writeFieldBegin(MAPPINGS_FIELD_DESC);
          {
            ...
            for (WMMapping _iter1047 : struct.mappings)
            {
      ...
      if (struct.triggers != null) {
        if (struct.isSetTriggers()) {
          oprot.writeFieldBegin(TRIGGERS_FIELD_DESC);
          {
            ...
            for (WMTrigger _iter1048 : struct.triggers)
            {
      ...
      if (struct.poolTriggers != null) {
        if (struct.isSetPoolTriggers()) {
          oprot.writeFieldBegin(POOL_TRIGGERS_FIELD_DESC);
          {
            ...
            for (WMPoolTrigger _iter1049 : struct.poolTriggers)
            {
  ...
  private static class WMFullResourcePlanTupleScheme extends org.apache.thrift.scheme.TupleScheme<WMFullResourcePlan> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, WMFullResourcePlan struct) throws org.apache.thrift.TException {
      ...
      struct.plan.write(oprot);
      {
        ...
        for (WMPool _iter1050 : struct.pools)
        {
      ...
      if (struct.isSetMappings()) {
        {
          ...
          for (WMMapping _iter1051 : struct.mappings)
          {
      ...
      if (struct.isSetTriggers()) {
        {
          ...
          for (WMTrigger _iter1052 : struct.triggers)
          {
      ...
      if (struct.isSetPoolTriggers()) {
        {
          ...
          for (WMPoolTrigger _iter1053 : struct.poolTriggers)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, WMFullResourcePlan struct) throws org.apache.thrift.TException {
      ...
      struct.setPlanIsSet(true);
      {
        ...
        struct.pools = new java.util.ArrayList<WMPool>(_list1054.size);
        @org.apache.thrift.annotation.Nullable WMPool _elem1055;
        for (int _i1056 = 0; _i1056 < _list1054.size; ++_i1056)
        {
          _elem1055 = new WMPool();
          _elem1055.read(iprot);
          struct.pools.add(_elem1055);
        }
      }
      struct.setPoolsIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.mappings = new java.util.ArrayList<WMMapping>(_list1057.size);
          @org.apache.thrift.annotation.Nullable WMMapping _elem1058;
          for (int _i1059 = 0; _i1059 < _list1057.size; ++_i1059)
          {
            _elem1058 = new WMMapping();
            _elem1058.read(iprot);
            struct.mappings.add(_elem1058);
          }
        }
        struct.setMappingsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.triggers = new java.util.ArrayList<WMTrigger>(_list1060.size);
          @org.apache.thrift.annotation.Nullable WMTrigger _elem1061;
          for (int _i1062 = 0; _i1062 < _list1060.size; ++_i1062)
          {
            _elem1061 = new WMTrigger();
            _elem1061.read(iprot);
            struct.triggers.add(_elem1061);
          }
        }
        struct.setTriggersIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.poolTriggers = new java.util.ArrayList<WMPoolTrigger>(_list1063.size);
          @org.apache.thrift.annotation.Nullable WMPoolTrigger _elem1064;
          for (int _i1065 = 0; _i1065 < _list1063.size; ++_i1065)
          {
            _elem1064 = new WMPoolTrigger();
            _elem1064.read(iprot);
            struct.poolTriggers.add(_elem1064);
          }
        }
        struct.setPoolTriggersIsSet(true);
      }
