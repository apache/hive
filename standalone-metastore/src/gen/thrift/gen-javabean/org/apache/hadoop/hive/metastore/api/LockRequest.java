            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.component = new ArrayList<LockComponent>(_list706.size);
                LockComponent _elem707;
                for (int _i708 = 0; _i708 < _list706.size; ++_i708)
                {
                  _elem707 = new LockComponent();
                  _elem707.read(iprot);
                  struct.component.add(_elem707);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LockRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.component != null) {
        oprot.writeFieldBegin(COMPONENT_FIELD_DESC);
        {
          ...
          for (LockComponent _iter709 : struct.component)
          {
  ...
  private static class LockRequestTupleScheme extends TupleScheme<LockRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LockRequest struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (LockComponent _iter710 : struct.component)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LockRequest struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.component = new ArrayList<LockComponent>(_list711.size);
        LockComponent _elem712;
        for (int _i713 = 0; _i713 < _list711.size; ++_i713)
        {
          _elem712 = new LockComponent();
          _elem712.read(iprot);
          struct.component.add(_elem712);
        }
      }
      struct.setComponentIsSet(true);
      struct.user = iprot.readString();
