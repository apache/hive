            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.foreignKeys = new java.util.ArrayList<SQLForeignKey>(_list386.size);
                @org.apache.thrift.annotation.Nullable SQLForeignKey _elem387;
                for (int _i388 = 0; _i388 < _list386.size; ++_i388)
                {
                  _elem387 = new SQLForeignKey();
                  _elem387.read(iprot);
                  struct.foreignKeys.add(_elem387);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ForeignKeysResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.foreignKeys != null) {
        oprot.writeFieldBegin(FOREIGN_KEYS_FIELD_DESC);
        {
          ...
          for (SQLForeignKey _iter389 : struct.foreignKeys)
          {
  ...
  private static class ForeignKeysResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<ForeignKeysResponse> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ForeignKeysResponse struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (SQLForeignKey _iter390 : struct.foreignKeys)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ForeignKeysResponse struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        struct.foreignKeys = new java.util.ArrayList<SQLForeignKey>(_list391.size);
        @org.apache.thrift.annotation.Nullable SQLForeignKey _elem392;
        for (int _i393 = 0; _i393 < _list391.size; ++_i393)
        {
          _elem392 = new SQLForeignKey();
          _elem392.read(iprot);
          struct.foreignKeys.add(_elem392);
        }
      }
      struct.setForeignKeysIsSet(true);
    }
