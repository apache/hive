...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class GetPartitionsByNamesRequest implements org.apache.thrift.TBase<GetPartitionsByNamesRequest, GetPartitionsByNamesRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetPartitionsByNamesRequest> {
  ...
  private static final _Fields optionals[] = {_Fields.NAMES,_Fields.GET_COL_STATS,_Fields.PROCESSOR_CAPABILITIES,_Fields.PROCESSOR_IDENTIFIER,_Fields.ENGINE,_Fields.VALID_WRITE_ID_LIST,_Fields.GET_FILE_METADATA};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.names = new ArrayList<String>(_list604.size);
                String _elem605;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.processorCapabilities = new ArrayList<String>(_list607.size);
                String _elem608;
      ...
      if (struct.names != null) {
        if (struct.isSetNames()) {
          oprot.writeFieldBegin(NAMES_FIELD_DESC);
          {
            ...
            for (String _iter610 : struct.names)
            {
      ...
      if (struct.processorCapabilities != null) {
        if (struct.isSetProcessorCapabilities()) {
          oprot.writeFieldBegin(PROCESSOR_CAPABILITIES_FIELD_DESC);
          {
            ...
            for (String _iter611 : struct.processorCapabilities)
            {
  ...
  private static class GetPartitionsByNamesRequestTupleScheme extends TupleScheme<GetPartitionsByNamesRequest> {
      ...
      if (struct.isSetNames()) {
        {
          ...
          for (String _iter612 : struct.names)
          {
      ...
      if (struct.isSetProcessorCapabilities()) {
        {
          ...
          for (String _iter613 : struct.processorCapabilities)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, GetPartitionsByNamesRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list614 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.names = new ArrayList<String>(_list614.size);
          String _elem615;
          for (int _i616 = 0; _i616 < _list614.size; ++_i616)
          {
            _elem615 = iprot.readString();
            struct.names.add(_elem615);
          }
        }
        struct.setNamesIsSet(true);
      }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.processorCapabilities = new ArrayList<String>(_list617.size);
          String _elem618;
          for (int _i619 = 0; _i619 < _list617.size; ++_i619)
          {
            _elem618 = iprot.readString();
            struct.processorCapabilities.add(_elem618);
          }
        }
        struct.setProcessorCapabilitiesIsSet(true);
      }
