      ...
      if (struct.names != null) {
        if (struct.isSetNames()) {
          oprot.writeFieldBegin(NAMES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter610 : struct.names)
            {
      ...
      if (struct.processorCapabilities != null) {
        if (struct.isSetProcessorCapabilities()) {
          oprot.writeFieldBegin(PROCESSOR_CAPABILITIES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter611 : struct.processorCapabilities)
            {
      ...
      if (struct.isSetNames()) {
        {
          ...
          for (java.lang.String _iter612 : struct.names)
          {
      ...
      if (struct.isSetProcessorCapabilities()) {
        {
          ...
          for (java.lang.String _iter613 : struct.processorCapabilities)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.names = new java.util.ArrayList<java.lang.String>(_list614.size);
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.processorCapabilities = new java.util.ArrayList<java.lang.String>(_list617.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem618;
