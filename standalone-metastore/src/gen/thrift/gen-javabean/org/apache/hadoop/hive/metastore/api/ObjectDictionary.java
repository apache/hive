            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.values = new java.util.HashMap<java.lang.String,java.util.List<java.nio.ByteBuffer>>(2*_map230.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key231;
                @org.apache.thrift.annotation.Nullable java.util.List<java.nio.ByteBuffer> _val232;
                for (int _i233 = 0; _i233 < _map230.size; ++_i233)
                {
                  _key231 = iprot.readString();
                  {
                    ...
                    _val232 = new java.util.ArrayList<java.nio.ByteBuffer>(_list234.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ObjectDictionary struct) throws org.apache.thrift.TException {
      ...
      if (struct.values != null) {
        oprot.writeFieldBegin(VALUES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.util.List<java.nio.ByteBuffer>> _iter237 : struct.values.entrySet())
          {
            oprot.writeString(_iter237.getKey());
            {
              ...
              for (java.nio.ByteBuffer _iter238 : _iter237.getValue())
              {
  ...
  private static class ObjectDictionaryTupleScheme extends org.apache.thrift.scheme.TupleScheme<ObjectDictionary> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ObjectDictionary struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (java.util.Map.Entry<java.lang.String, java.util.List<java.nio.ByteBuffer>> _iter239 : struct.values.entrySet())
        {
          oprot.writeString(_iter239.getKey());
          {
            oprot.writeI32(_iter239.getValue().size());
            for (java.nio.ByteBuffer _iter240 : _iter239.getValue())
            {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ObjectDictionary struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        struct.values = new java.util.HashMap<java.lang.String,java.util.List<java.nio.ByteBuffer>>(2*_map241.size);
        @org.apache.thrift.annotation.Nullable java.lang.String _key242;
        @org.apache.thrift.annotation.Nullable java.util.List<java.nio.ByteBuffer> _val243;
        for (int _i244 = 0; _i244 < _map241.size; ++_i244)
        {
          _key242 = iprot.readString();
          {
            ...
            _val243 = new java.util.ArrayList<java.nio.ByteBuffer>(_list245.size);
