...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class TableValidWriteIds2 implements org.apache.thrift.TBase<TableValidWriteIds2, TableValidWriteIds2._Fields>, java.io.Serializable, Cloneable, Comparable<TableValidWriteIds2> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TableValidWriteIds2");

  private static final org.apache.thrift.protocol.TField FULL_TABLE_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField("fullTableName", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new TableValidWriteIds2StandardSchemeFactory());
    schemes.put(TupleScheme.class, new TableValidWriteIds2TupleSchemeFactory());
  }

  private FullTableName fullTableName; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TableValidWriteIds2.class, metaDataMap);
  }

  public TableValidWriteIds2() {
  }
   ...
   */
  public TableValidWriteIds2(TableValidWriteIds2 other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetFullTableName()) {
      this.fullTableName = new FullTableName(other.fullTableName);
    }
  ...
  public TableValidWriteIds2 deepCopy() {
    return new TableValidWriteIds2(this);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case FULL_TABLE_NAME:
      if (value == null) {
        ...
        setFullTableName((FullTableName)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TableValidWriteIds2)
      return this.equals((TableValidWriteIds2)that);
    return false;
  }

  public boolean equals(TableValidWriteIds2 that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TableValidWriteIds2 other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TableValidWriteIds2(");
    boolean first = true;
  ...
  private static class TableValidWriteIds2StandardSchemeFactory implements SchemeFactory {
    public TableValidWriteIds2StandardScheme getScheme() {
      return new TableValidWriteIds2StandardScheme();
    }
  }

  private static class TableValidWriteIds2StandardScheme extends StandardScheme<TableValidWriteIds2> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TableValidWriteIds2 struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // FULL_TABLE_NAME
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.fullTableName = new FullTableName();
              struct.fullTableName.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TableValidWriteIds2 struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.fullTableName != null) {
        oprot.writeFieldBegin(FULL_TABLE_NAME_FIELD_DESC);
        struct.fullTableName.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class TableValidWriteIds2TupleSchemeFactory implements SchemeFactory {
    public TableValidWriteIds2TupleScheme getScheme() {
      return new TableValidWriteIds2TupleScheme();
    }
  }

  private static class TableValidWriteIds2TupleScheme extends TupleScheme<TableValidWriteIds2> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TableValidWriteIds2 struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TableValidWriteIds2 struct) throws org.apache.thrift.TException {
