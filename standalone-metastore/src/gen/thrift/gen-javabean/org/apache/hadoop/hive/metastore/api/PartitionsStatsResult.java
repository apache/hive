            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.partStats = new java.util.HashMap<java.lang.String,java.util.List<ColumnStatisticsObj>>(2*_map490.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key491;
                @org.apache.thrift.annotation.Nullable java.util.List<ColumnStatisticsObj> _val492;
                for (int _i493 = 0; _i493 < _map490.size; ++_i493)
                {
                  _key491 = iprot.readString();
                  {
                    ...
                    _val492 = new java.util.ArrayList<ColumnStatisticsObj>(_list494.size);
                    @org.apache.thrift.annotation.Nullable ColumnStatisticsObj _elem495;
                    for (int _i496 = 0; _i496 < _list494.size; ++_i496)
                    {
                      _elem495 = new ColumnStatisticsObj();
                      _elem495.read(iprot);
                      _val492.add(_elem495);
                    }
                    iprot.readListEnd();
                  }
                  struct.partStats.put(_key491, _val492);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PartitionsStatsResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.partStats != null) {
        oprot.writeFieldBegin(PART_STATS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.util.List<ColumnStatisticsObj>> _iter497 : struct.partStats.entrySet())
          {
            oprot.writeString(_iter497.getKey());
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter497.getValue().size()));
              for (ColumnStatisticsObj _iter498 : _iter497.getValue())
              {
  ...
  private static class PartitionsStatsResultTupleScheme extends org.apache.thrift.scheme.TupleScheme<PartitionsStatsResult> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, PartitionsStatsResult struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (java.util.Map.Entry<java.lang.String, java.util.List<ColumnStatisticsObj>> _iter499 : struct.partStats.entrySet())
        {
          oprot.writeString(_iter499.getKey());
          {
            oprot.writeI32(_iter499.getValue().size());
            for (ColumnStatisticsObj _iter500 : _iter499.getValue())
            {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, PartitionsStatsResult struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TMap _map501 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.LIST, iprot.readI32());
        struct.partStats = new java.util.HashMap<java.lang.String,java.util.List<ColumnStatisticsObj>>(2*_map501.size);
        @org.apache.thrift.annotation.Nullable java.lang.String _key502;
        @org.apache.thrift.annotation.Nullable java.util.List<ColumnStatisticsObj> _val503;
        for (int _i504 = 0; _i504 < _map501.size; ++_i504)
        {
          _key502 = iprot.readString();
          {
            ...
            _val503 = new java.util.ArrayList<ColumnStatisticsObj>(_list505.size);
            @org.apache.thrift.annotation.Nullable ColumnStatisticsObj _elem506;
            for (int _i507 = 0; _i507 < _list505.size; ++_i507)
            {
              _elem506 = new ColumnStatisticsObj();
              _elem506.read(iprot);
              _val503.add(_elem506);
            }
          }
          struct.partStats.put(_key502, _val503);
        }
      }
      struct.setPartStatsIsSet(true);
