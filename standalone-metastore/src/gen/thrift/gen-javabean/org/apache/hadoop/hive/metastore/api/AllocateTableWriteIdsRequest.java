            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.txnIds = new java.util.ArrayList<java.lang.Long>(_list642.size);
                long _elem643;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.srcTxnToWriteIdList = new java.util.ArrayList<TxnToWriteId>(_list645.size);
                @org.apache.thrift.annotation.Nullable TxnToWriteId _elem646;
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.txnIds = new java.util.ArrayList<java.lang.Long>(_list652.size);
          long _elem653;
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.srcTxnToWriteIdList = new java.util.ArrayList<TxnToWriteId>(_list655.size);
          @org.apache.thrift.annotation.Nullable TxnToWriteId _elem656;
