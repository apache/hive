            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.txnIds = new java.util.ArrayList<java.lang.Long>(_list650.size);
                long _elem651;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.srcTxnToWriteIdList = new java.util.ArrayList<TxnToWriteId>(_list653.size);
                @org.apache.thrift.annotation.Nullable TxnToWriteId _elem654;
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.txnIds = new java.util.ArrayList<java.lang.Long>(_list660.size);
          long _elem661;
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.srcTxnToWriteIdList = new java.util.ArrayList<TxnToWriteId>(_list663.size);
          @org.apache.thrift.annotation.Nullable TxnToWriteId _elem664;
