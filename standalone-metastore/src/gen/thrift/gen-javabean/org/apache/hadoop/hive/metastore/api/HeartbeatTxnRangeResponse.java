            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.aborted = new java.util.HashSet<java.lang.Long>(2*_set690.size);
                long _elem691;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.nosuch = new java.util.HashSet<java.lang.Long>(2*_set693.size);
                long _elem694;
  ...
  private static class HeartbeatTxnRangeResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<HeartbeatTxnRangeResponse> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, HeartbeatTxnRangeResponse struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        struct.aborted = new java.util.HashSet<java.lang.Long>(2*_set700.size);
        long _elem701;
      ...
      struct.setAbortedIsSet(true);
      {
        ...
        struct.nosuch = new java.util.HashSet<java.lang.Long>(2*_set703.size);
        long _elem704;
