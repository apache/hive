...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class HeartbeatTxnRangeResponse implements org.apache.thrift.TBase<HeartbeatTxnRangeResponse, HeartbeatTxnRangeResponse._Fields>, java.io.Serializable, Cloneable, Comparable<HeartbeatTxnRangeResponse> {
  ...
  public int compareTo(HeartbeatTxnRangeResponse other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAborted()).compareTo(other.isSetAborted());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetNosuch()).compareTo(other.isSetNosuch());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNosuch()) {
        ...
        switch (schemeField.id) {
          case 1: // ABORTED
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set682 = iprot.readSetBegin();
                struct.aborted = new java.util.HashSet<java.lang.Long>(2*_set682.size);
                long _elem683;
                for (int _i684 = 0; _i684 < _set682.size; ++_i684)
                {
                  _elem683 = iprot.readI64();
                  struct.aborted.add(_elem683);
                }
                iprot.readSetEnd();
              }
          ...
          case 2: // NOSUCH
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set685 = iprot.readSetBegin();
                struct.nosuch = new java.util.HashSet<java.lang.Long>(2*_set685.size);
                long _elem686;
                for (int _i687 = 0; _i687 < _set685.size; ++_i687)
                {
                  _elem686 = iprot.readI64();
                  struct.nosuch.add(_elem686);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HeartbeatTxnRangeResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.aborted != null) {
        oprot.writeFieldBegin(ABORTED_FIELD_DESC);
        {
          ...
          for (long _iter688 : struct.aborted)
          {
      ...
      if (struct.nosuch != null) {
        oprot.writeFieldBegin(NOSUCH_FIELD_DESC);
        {
          ...
          for (long _iter689 : struct.nosuch)
          {
            oprot.writeI64(_iter689);
          }
          oprot.writeSetEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class HeartbeatTxnRangeResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<HeartbeatTxnRangeResponse> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, HeartbeatTxnRangeResponse struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (long _iter690 : struct.aborted)
        {
      ...
      }
      {
        ...
        for (long _iter691 : struct.nosuch)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, HeartbeatTxnRangeResponse struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TSet _set692 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I64, iprot.readI32());
        struct.aborted = new java.util.HashSet<java.lang.Long>(2*_set692.size);
        long _elem693;
        for (int _i694 = 0; _i694 < _set692.size; ++_i694)
        {
          _elem693 = iprot.readI64();
          struct.aborted.add(_elem693);
        }
      }
      struct.setAbortedIsSet(true);
      {
        org.apache.thrift.protocol.TSet _set695 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I64, iprot.readI32());
        struct.nosuch = new java.util.HashSet<java.lang.Long>(2*_set695.size);
        long _elem696;
        for (int _i697 = 0; _i697 < _set695.size; ++_i697)
        {
          _elem696 = iprot.readI64();
          struct.nosuch.add(_elem696);
        }
      }
      struct.setNosuchIsSet(true);
    }
