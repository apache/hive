            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitions = new java.util.ArrayList<Partition>(_list326.size);
                @org.apache.thrift.annotation.Nullable Partition _elem327;
                for (int _i328 = 0; _i328 < _list326.size; ++_i328)
                {
                  _elem327 = new Partition();
                  _elem327.read(iprot);
                  struct.partitions.add(_elem327);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PartitionListComposingSpec struct) throws org.apache.thrift.TException {
      ...
      if (struct.partitions != null) {
        oprot.writeFieldBegin(PARTITIONS_FIELD_DESC);
        {
          ...
          for (Partition _iter329 : struct.partitions)
          {
      ...
      if (struct.isSetPartitions()) {
        {
          ...
          for (Partition _iter330 : struct.partitions)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.partitions = new java.util.ArrayList<Partition>(_list331.size);
          @org.apache.thrift.annotation.Nullable Partition _elem332;
