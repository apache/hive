            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tblNames = new java.util.ArrayList<java.lang.String>(_list872.size);
      ...
      if (struct.tblNames != null) {
        if (struct.isSetTblNames()) {
          oprot.writeFieldBegin(TBL_NAMES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter875 : struct.tblNames)
            {
      ...
      if (struct.isSetTblNames()) {
        {
          ...
          for (java.lang.String _iter876 : struct.tblNames)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.tblNames = new java.util.ArrayList<java.lang.String>(_list877.size);
