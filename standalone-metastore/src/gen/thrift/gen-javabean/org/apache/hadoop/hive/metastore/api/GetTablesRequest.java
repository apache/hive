...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class GetTablesRequest implements org.apache.thrift.TBase<GetTablesRequest, GetTablesRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetTablesRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tblNames = new ArrayList<String>(_list994.size);
                String _elem995;
      ...
      if (struct.tblNames != null) {
        if (struct.isSetTblNames()) {
          oprot.writeFieldBegin(TBL_NAMES_FIELD_DESC);
          {
            ...
            for (String _iter1000 : struct.tblNames)
            {
      ...
      if (struct.processorCapabilities != null) {
        if (struct.isSetProcessorCapabilities()) {
          oprot.writeFieldBegin(PROCESSOR_CAPABILITIES_FIELD_DESC);
          {
            ...
            for (String _iter1001 : struct.processorCapabilities)
            {
  ...
  private static class GetTablesRequestTupleScheme extends TupleScheme<GetTablesRequest> {
      ...
      if (struct.isSetTblNames()) {
        {
          ...
          for (String _iter1002 : struct.tblNames)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, GetTablesRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list1004 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.tblNames = new ArrayList<String>(_list1004.size);
          String _elem1005;
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.processorCapabilities = new ArrayList<String>(_list1007.size);
          String _elem1008;
