            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partValues = new java.util.ArrayList<java.lang.String>(_list1258.size);
                ...
                for (int _i1260 = 0; _i1260 < _list1258.size; ++_i1260)
                {
                  ...
                  struct.partValues.add(_elem1259);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.partValues != null) {
        if (struct.isSetPartValues()) {
          oprot.writeFieldBegin(PART_VALUES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter1261 : struct.partValues)
            {
      ...
      if (struct.isSetPartValues()) {
        {
          ...
          for (java.lang.String _iter1262 : struct.partValues)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.partValues = new java.util.ArrayList<java.lang.String>(_list1263.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem1264;
          for (int _i1265 = 0; _i1265 < _list1263.size; ++_i1265)
          {
            _elem1264 = iprot.readString();
            struct.partValues.add(_elem1264);
          }
        }
        struct.setPartValuesIsSet(true);
      }
