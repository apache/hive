...
CREATE TABLE `SCHEMA_BRANCH` (
  ...
  FOREIGN KEY (`SCHEMA_METADATA_NAME`) REFERENCES `SCHEMA_METADATA_INFO` (`name`) ON DELETE CASCADE ON UPDATE CASCADE,
  UNIQUE KEY `UK_SCHEMA_BRANCH`(`NAME`, `SCHEMA_METADATA_NAME`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
