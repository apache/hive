...
CREATE TABLE "APP"."SCHEMA_BRANCH" (
...
CREATE UNIQUE INDEX "APP"."UNIQUE_SCHEMA_BRANCH" ON "APP"."SCHEMA_BRANCH" ("NAME", "SCHEMA_BRANCH");

CREATE TABLE "APP"."SCHEMA_BRANCH_VERSION_MAPPING" (
  "SCHEMA_BRANCH_ID" bigint references "APP"."SCHEMA_BRANCH" ("SCHEMA_BRANCH_ID"),
  "SCHEMA_VERSION_ID" bigint not null "APP"."SCHEMA_VERSION" ("SCHEMA_VERSION_ID"),
)

CREATE UNIQUE INDEX "APP"."UNIQUE_SCHEMA_BRANCH_AND_VERSION" ON "APP"."SCHEMA_BRANCH_VERSION_MAPPING" ("SCHEMA_BRANCH_ID", "SCHEMA_VERSION_ID");
