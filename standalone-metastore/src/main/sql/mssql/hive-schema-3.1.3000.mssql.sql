...
INSERT INTO "CDH_VERSION" ("VER_ID", "SCHEMA_VERSION", "VERSION_COMMENT") VALUES (1, '3.1.3000.7.2.11.0-Update1', 'Hive release version 3.1.3000 for CDH 3.1.3000.7.2.11.0');

SELECT 'Initialized metastore to 3.1.3000.7.2.11.0-Update1';
