...
CREATE TABLE "SCHEMA_BRANCH_VERSION_MAPPING" (
  "SCHEMA_BRANCH_ID"         NUMBER(19,0)          NOT NULL,
  "SCHEMA_VERSION_ID"    NUMBER(19,0)          NOT NULL,
  CONSTRAINT schema_branch_version_uk UNIQUE ("SCHEMA_BRANCH_ID","SCHEMA_VERSION_ID"),
  CONSTRAINT schema_branch_version_bid FOREIGN KEY ("SCHEMA_BRANCH_ID") REFERENCES "SCHEMA_BRANCH" ("SCHEMA_BRANCH_ID") ON DELETE CASCADE,
  CONSTRAINT schema_branch_version_vid FOREIGN KEY ("SCHEMA_VERSION_ID") REFERENCES "SCHEMA_VERSION" ("SCHEMA_VERSION_ID") ON DELETE CASCADE
);
