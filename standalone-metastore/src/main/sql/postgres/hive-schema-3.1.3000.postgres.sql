...
INSERT INTO "CDH_VERSION" ("VER_ID", "SCHEMA_VERSION", "VERSION_COMMENT") VALUES (1, '3.1.3000.7.2.8.0', 'Hive release version 3.1.3000 for CDH 7.2.8.0');


SELECT 'Initialized MetaStore schema for 3.1.3000.7.2.8.0';
