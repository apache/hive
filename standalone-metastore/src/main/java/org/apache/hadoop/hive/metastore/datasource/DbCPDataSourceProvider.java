...
public class DbCPDataSourceProvider implements DataSourceProvider {
  ...
  public DataSource create(Configuration hdpConfig) throws SQLException {
    ...
    // NOTE: The below code initialization are taken from HIVE-23032. Not backporting the whole patch because it is dependent on other
    // refactored code changes in standalone-metastore
