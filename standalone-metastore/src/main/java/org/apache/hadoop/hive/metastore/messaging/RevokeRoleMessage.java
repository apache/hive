...
public abstract class RevokeRoleMessage extends EventMessage {
  public RevokeRoleMessage() {
    super(EventType.REVOKE_ROLE);
  }
  ...
  public EventMessage checkValid() {
    if (getUserName() == null)
      throw new IllegalStateException("User name unset.");
