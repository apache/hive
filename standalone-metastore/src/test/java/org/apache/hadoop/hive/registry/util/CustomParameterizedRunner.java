 ...
 * {@link CustomParameterizedBlockJUnit4Runner} for each set of parameters. You can build an
 ...
 * @since 4.0
 */
public class CustomParameterizedRunner extends Suite {
    /**
    ...
    public @interface UseParametersRunnerFactory {
         ...
         *         constructor)
         */
        Class<? extends ParametersRunnerFactory> value() default CustomParameterizedBlockJUnit4RunnerFactory.class;
    }
     ...
     */
    public CustomParameterizedRunner(Class<?> klass) throws Throwable {
    ...
    protected void collectInitializationErrors(List<Throwable> errors) {
        ...
        validatePublicStaticVoidMethods(CustomParameterizedRunner.BeforeParam.class, errors);
        validatePublicStaticVoidMethods(CustomParameterizedRunner.AfterParam.class, errors);
    }
    ...
    private static class RunnersFactory {
        private static final ParametersRunnerFactory DEFAULT_FACTORY = new CustomParameterizedBlockJUnit4RunnerFactory();
