...
public class TestSchemaToolForMetastore {
  ...
  public void testValidateSequences() throws Exception {
    ...
    String[] scripts = new String[] {
        ...
        "insert into DBS values(99, 'test db1', 'hdfs:///tmp', 'hdfs:///tmp2', 'db1', 'test', 'test', 'mycat');"
    };
    ...
    scripts = new String[] {
        ...
        "delete from DBS;",
        "insert into SEQUENCE_TABLE values('org.apache.hadoop.hive.metastore.model.MDatabase', 100);",
        "insert into DBS values(102, 'test db1', 'hdfs:///tmp', 'hdfs:///tmp2', 'db1', 'test', 'test', 'mycat');"
    };
 ...
 // Test valid case
    String[] scripts = new String[] {
         ...
         "insert into DBS values(2, 'my db', 'hdfs://myhost.com:8020/user/hive/warehouse/mydb', 'hdfs://myhost.com:8020/user/hive/external/mydb', 'mydb', 'public', 'role', 'mycat');",
         "insert into DBS values(7, 'db with bad port', 'hdfs://myhost.com:8020/', 'hdfs://myhost.com:8020/external', 'haDB', 'public', 'role', 'mycat');",
    ...
    scripts = new String[] {
        ...
        "delete from SDS;",
        "delete from DBS;",
        "insert into DBS values(2, 'my db', '/user/hive/warehouse/mydb', '/user/hive/external/mydb', 'mydb', 'public', 'role', 'mycat');",
        "insert into DBS values(4, 'my db2', 'hdfs://myhost.com:8020', 'hdfs://myhost.com:8020/external', '', 'public', 'role', 'mycat');",
        "insert into DBS values(6, 'db with bad port', 'hdfs://myhost.com:8020:', 'hdfs://myhost.com:8020/external', 'zDB', 'public', 'role', 'mycat');",
        "insert into DBS values(7, 'db with bad port', 'hdfs://mynameservice.com/', 'hdfs://mynameservice.com/external', 'haDB', 'public', 'role', 'mycat');",
