...
public class TestSchemaToolForMetastore {
  ...
  public void testSchemaInitOrUgrade1() throws Exception {
    LOG.info("Starting testSchemaInitOrUgrade1");
