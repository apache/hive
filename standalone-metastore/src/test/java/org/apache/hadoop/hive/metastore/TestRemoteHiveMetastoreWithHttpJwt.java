...
public class TestRemoteHiveMetastoreWithHttpJwt {
  ...
  public void testValidJWT() throws Exception {
    ...
    String dbName = ("valid_jwt_" + TEST_DB_NAME_PREFIX + "_" + System.currentTimeMillis()).toLowerCase();
  ...
  public void testExpiredJWT() throws Exception {
    ...
    System.getenv().put("HMS_JWT", validJwtToken);
    String dbName = ("expired_jwt_" + TEST_DB_NAME_PREFIX + "_" + System.currentTimeMillis()).toLowerCase();
    HiveMetaStoreClient client = new HiveMetaStoreClient(conf);
    try {
  ...
  public void testInvalidJWT() throws Exception {
    ...
    String dbName = ("invalid_jwt_" + TEST_DB_NAME_PREFIX + "_" + System.currentTimeMillis()).toLowerCase();
    HiveMetaStoreClient client = new HiveMetaStoreClient(conf);
    try {
      Thread.sleep(TimeUnit.MILLISECONDS.toMillis(2));
      Database createdDb = new Database();
