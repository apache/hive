...
public abstract class MColumnStatistics {
  ...
  protected Long longLowValue;
  protected Long longHighValue;
  protected Double doubleLowValue;
  protected Double doubleHighValue;
  protected String decimalLowValue;
  protected String decimalHighValue;
  protected Long numNulls;
  protected Long numDVs;
  protected byte[] bitVector = new byte[] { 'H', 'L' };
  protected byte[] histogram = new byte[] {};
  protected Double avgColLen;
  protected Long maxColLen;
  protected Long numTrues;
  protected Long numFalses;
  protected long lastAnalyzed;
