...
public class CompactorPMF implements LeaderElection.LeadershipStateListener {
  ...
  public void takeLeadership(LeaderElection election) throws Exception {
    // The ObjectStore#setConf will open another PersistenceManagerFactory for compactor,
    // refer to PersistenceManagerProvider#updatePmfProperties
  }

  @Override
  public void lossLeadership(LeaderElection election) throws Exception {
    // close the compactorPmf if the current instance is no longer a leader.
