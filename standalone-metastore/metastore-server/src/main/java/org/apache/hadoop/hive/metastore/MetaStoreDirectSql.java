...
class MetaStoreDirectSql {
  ...
  private final int maxParamsInInsert;
  ...
  public MetaStoreDirectSql(PersistenceManager pm, Configuration conf, String schema) {
    ...
    this.maxParamsInInsert = MetastoreConf.getIntVar(conf, ConfVars.DIRECT_SQL_MAX_PARAMS_IN_INSERT);
  ...
  private void insertInBatch(String tableName, String columns, int columnCount, String rowFormat, int rowCount,
    ...
    if (maxParamsCount < columnCount) {
      LOG.error("Maximum number of parameters in the direct SQL batch insert query is less than the table: {}"
  ...
  private void insertPartitionKeyValInBatch(Map<Long, MPartition> partIdToPartition) throws MetaException {
    ...
    insertInBatch(PARTITION_KEY_VALS, columns, columnCount, row, rowCount, bec);
  }
  ...
  private void insertSkewedStringListInBatch(List<Long> stringListIds) throws MetaException {
    ...
    insertInBatch(SKEWED_STRING_LIST, columns, columnCount, row, rowCount, bec);
  }
  ...
  private void insertSkewedStringListValInBatch(Map<Long, List<String>> stringListIdToStringList) throws MetaException {
    ...
    insertInBatch(SKEWED_STRING_LIST_VALUES, columns, columnCount, row, rowCount, bec);
  }
  ...
  private void insertSkewedLocationInBatch(Map<Long, String> stringListIdToLocation, Map<Long, Long> stringListIdToSdId)
    ...
    insertInBatch(SKEWED_COL_VALUE_LOC_MAP, columns, columnCount, row, rowCount, bec);
  }
