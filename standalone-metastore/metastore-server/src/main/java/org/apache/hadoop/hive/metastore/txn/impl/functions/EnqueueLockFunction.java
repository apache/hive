...
import org.apache.hadoop.hive.metastore.txn.impl.queries.GetWriteIdsHandler;
...
public class EnqueueLockFunction implements TransactionalFunction<Long> {
   ...
   * @see org.apache.hadoop.hive.metastore.txn.TxnLockHandler#checkLock(long, long, boolean, boolean)
   */
  @Override
