...
public record MetastoreConnection(Connection delegate, Configuration configuration) implements Connection {
  ...
  public PreparedStatement prepareStatement(String sql) throws SQLException {
    return MetastoreStatement.getProxyStatement(configuration, delegate.prepareStatement(sql), sql);
  }

  @Override
  public CallableStatement prepareCall(String sql) throws SQLException {
    return MetastoreStatement.getProxyStatement(configuration, delegate.prepareCall(sql), sql);
  }
  ...
  public Statement createStatement(int resultSetType, int resultSetConcurrency, int resultSetHoldability)
      throws SQLException {
    return MetastoreStatement.getProxyStatement(configuration,
        delegate.createStatement(resultSetType, resultSetConcurrency, resultSetHoldability), null);
  }
  ...
  public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
    return MetastoreStatement.getProxyStatement(configuration, delegate.prepareStatement(sql, autoGeneratedKeys), sql);
  }

  @Override
  public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
    return MetastoreStatement.getProxyStatement(configuration, delegate.prepareStatement(sql, columnIndexes), sql);
  }

  @Override
  public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
    return MetastoreStatement.getProxyStatement(configuration, delegate.prepareStatement(sql, columnNames), sql);
  }
