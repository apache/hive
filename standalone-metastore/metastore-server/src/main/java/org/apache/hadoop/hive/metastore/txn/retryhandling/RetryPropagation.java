...
public enum RetryPropagation {
   ...
   * <br/><br/><b>In other words:</b> regardless if the inner or outer method fails, the outer method will be re-executed.
   */
  CREATE_OR_JOIN(3),
  /**
   ...
   * <br/><br/><b>In other words:</b> If the method fails, the error will be caught, and the method will be re-executed.
   ...
   * <br/><br/><b>In other words:</b> While this method does not being executed as a retry-call, it can be called only when 
