...
public abstract class EventMessage {
  ...
  public enum EventType {
    ...
    CREATE_ROLE(MessageBuilder.CREATE_ROLE_EVENT),
    DROP_ROLE(MessageBuilder.DROP_ROLE_EVENT),
    GRANT_ROLE(MessageBuilder.GRANT_ROLE_EVENT),
    REVOKE_ROLE(MessageBuilder.REVOKE_ROLE_EVENT),
    REVOKE_PRIVILEGES(MessageBuilder.REVOKE_PRIVILEGES_EVENT),
    GRANT_PRIVILEGES(MessageBuilder.GRANT_PRIVILEGES_EVENT);
