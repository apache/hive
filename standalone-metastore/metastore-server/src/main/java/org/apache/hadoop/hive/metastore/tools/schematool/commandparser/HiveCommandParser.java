...
class HiveCommandParser extends AbstractCommandParser {
  private final static String HIVE_NESTING_TOKEN = "SOURCE";
  private final String quoteCharacter;

  public HiveCommandParser(String dbOpts, boolean usingSqlLine, String quoteCharacter) {
