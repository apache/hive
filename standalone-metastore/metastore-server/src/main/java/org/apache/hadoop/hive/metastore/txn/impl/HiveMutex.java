...
public class HiveMutex implements TxnStore.MutexAPI {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(HiveMutex.class);
  /**
  ...
  public HiveMutex(SQLGenerator sqlGenerator, MultiDataSourceJdbcResource jdbcResource) {
