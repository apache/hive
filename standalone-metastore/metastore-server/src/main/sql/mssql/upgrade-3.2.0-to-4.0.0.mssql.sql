...
-- HIVE-24880
ALTER TABLE COMPACTION_QUEUE ADD CC_INITIATOR_ID nvarchar(128) NULL;
ALTER TABLE COMPACTION_QUEUE ADD CC_INITIATOR_VERSION nvarchar(128) NULL;
ALTER TABLE COMPACTION_QUEUE ADD CC_WORKER_VERSION nvarchar(128) NULL;
ALTER TABLE COMPLETED_COMPACTIONS ADD CQ_INITIATOR_ID nvarchar(128) NULL;
ALTER TABLE COMPLETED_COMPACTIONS ADD CQ_INITIATOR_VERSION nvarchar(128) NULL;
ALTER TABLE COMPLETED_COMPACTIONS ADD CQ_WORKER_VERSION nvarchar(128) NULL;
