...
CREATE TABLE COMPACTION_QUEUE(
	...
	CQ_CATALOG nvarchar(128) NOT NULL,
...
CREATE TABLE COMPLETED_COMPACTIONS (
	...
	CC_CATALOG nvarchar(128) NOT NULL,
...
CREATE TABLE COMPACTION_METRICS_CACHE (
    CMC_CATALOG nvarchar(128) NOT NULL,
...
CREATE TABLE COMPLETED_TXN_COMPONENTS(
	...
	CTC_CATALOG nvarchar(128) NOT NULL,
...
CREATE TABLE HIVE_LOCKS(
	...
	HL_CATALOG nvarchar(128) NOT NULL,
...
CREATE TABLE TXN_COMPONENTS(
	...
	TC_CATALOG nvarchar(128) NOT NULL,
...
CREATE TABLE WRITE_SET (
  WS_CATALOG nvarchar(128) NOT NULL,
...
CREATE TABLE TXN_TO_WRITE_ID (
  ...
  T2W_CATALOG nvarchar(128) NOT NULL,
...
CREATE TABLE NEXT_WRITE_ID (
  NWI_CATALOG nvarchar(128) NOT NULL,
...
CREATE TABLE MIN_HISTORY_WRITE_ID (
  ...
  MH_CATALOG nvarchar(128) NOT NULL,
...
CREATE TABLE MATERIALIZATION_REBUILD_LOCKS (
  ...
  MRL_CAT_NAME nvarchar(128) NOT NULL,
...
CREATE TABLE TXN_WRITE_NOTIFICATION_LOG (
  ...
  WNL_CATALOG nvarchar(128) NOT NULL,
...
-- -----------------------------------------------------------------
INSERT INTO VERSION (VER_ID, SCHEMA_VERSION, VERSION_COMMENT) VALUES (1, '4.3.0', 'Hive release version 4.3.0');
