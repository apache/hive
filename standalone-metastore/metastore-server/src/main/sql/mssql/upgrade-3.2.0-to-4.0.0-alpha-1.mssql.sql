...
-- HIVE-26049
ALTER TABLE "TC_TABLE" ALTER COLUMN "TC_TABLE" nvarchar(256);
...
ALTER TABLE "COMPACTION_QUEUE" ALTER COLUMN "CQ_TABLE" nvarchar(256);
ALTER TABLE "COMPLETED_COMPACTIONS" ALTER COLUMN "CC_TABLE" nvarchar(256);
ALTER TABLE "COMPACTION_METRICS_CACHE" ALTER COLUMN "CMC_TABLE" nvarchar(256);
ALTER TABLE "WRITE_SET" ALTER COLUMN "WS_TABLE" nvarchar(256);
ALTER TABLE "TXN_WRITE_NOTIFICATION_LOG" ALTER COLUMN "WNL_TABLE" nvarchar(256);
