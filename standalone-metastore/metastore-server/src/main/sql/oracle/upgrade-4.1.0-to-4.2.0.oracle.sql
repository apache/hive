SELECT 'Upgrading MetaStore schema from 4.1.0 to 4.2.0' AS Status from dual;
...
SELECT 'Finished upgrading MetaStore schema from 4.1.0 to 4.2.0' AS Status from dual;
