...
ALTER TABLE DC_PRIVS ADD CONSTRAINT DC_PRIVS_FK1 FOREIGN KEY (DC_NAME) REFERENCES DATACONNECTORS (NAME) INITIALLY DEFERRED ;
CREATE UNIQUE INDEX DBPRIVILEGEINDEX ON DC_PRIVS (AUTHORIZER,DC_NAME,PRINCIPAL_NAME,PRINCIPAL_TYPE,DC_PRIV,GRANTOR,GRANTOR_TYPE);
CREATE INDEX DC_PRIVS_N49 ON DC_PRIVS (DC_NAME);
