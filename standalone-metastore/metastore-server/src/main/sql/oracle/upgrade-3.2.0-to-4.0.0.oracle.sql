...
--
ALTER TABLE TBLS ADD PENDING_DROP NUMBER(1) DEFAULT 0 NOT NULL CHECK (PENDING_DROP IN (1,0));
ALTER TABLE PARTITIONS ADD PENDING_DROP NUMBER(1) DEFAULT 0 NOT NULL CHECK (PENDING_DROP IN (1,0));
