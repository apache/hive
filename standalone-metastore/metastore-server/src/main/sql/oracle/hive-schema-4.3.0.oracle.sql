...
CREATE TABLE TXN_COMPONENTS (
  TC_ID NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE COMPLETED_TXN_COMPONENTS (
  CTC_ID NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE TXN_LOCK_TBL (
  TLT_ID NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE NEXT_LOCK_ID (
  NL_ID NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE NEXT_COMPACTION_QUEUE_ID (
  NCQI_ID NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE COMPACTION_METRICS_CACHE (
    CMC_ID NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE WRITE_SET (
  WS_ID NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE MIN_HISTORY_WRITE_ID (
  MH_ID NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
