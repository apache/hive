...
-- HIVE-26049
ALTER TABLE "APP"."TXN_COMPONENTS" ALTER "TC_TABLE" SET DATA TYPE VARCHAR(255);
ALTER TABLE "APP"."HIVE_LOCKS" ALTER "HL_TABLE" SET DATA TYPE VARCHAR(255);
ALTER TABLE "APP"."COMPACTION_QUEUE" ALTER "CQ_TABLE" SET DATA TYPE VARCHAR(255);
ALTER TABLE "APP"."COMPLETED_COMPACTIONS" ALTER "CC_TABLE" SET DATA TYPE VARCHAR(255);
ALTER TABLE "APP"."COMPACTION_METRICS_CACHE" ALTER "CMC_TABLE" SET DATA TYPE VARCHAR(255);
ALTER TABLE "APP"."WRITE_SET" ALTER "WS_TABLE" SET DATA TYPE VARCHAR(255);
ALTER TABLE "APP"."TXN_WRITE_NOTIFICATION_LOG" ALTER "WNL_TABLE" SET DATA TYPE VARCHAR(255);
