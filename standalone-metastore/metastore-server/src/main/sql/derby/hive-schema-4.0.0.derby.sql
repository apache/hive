...
CREATE UNIQUE INDEX "APP"."UNIQUE_SCHEMA_BRANCH" ON "APP"."SCHEMA_BRANCH" ("NAME", "SCHEMA_NAME");

CREATE TABLE "APP"."SCHEMA_BRANCH_VERSION_MAPPING" (
  "SCHEMA_BRANCH_ID" bigint references "APP"."SCHEMA_BRANCH" ("SCHEMA_BRANCH_ID"),
  "SCHEMA_VERSION_ID" bigint references "APP"."SCHEMA_VERSION" ("SCHEMA_VERSION_ID")
);
