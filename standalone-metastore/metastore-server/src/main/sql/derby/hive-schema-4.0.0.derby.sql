...
CREATE TABLE "APP"."MV_TABLES_USED" (
  "MV_CREATION_METADATA_ID" BIGINT NOT NULL,
  "TBL_ID" BIGINT NOT NULL,
  "MVTU_UPDATE_DELETE" char(1) NOT NULL DEFAULT 'N',
  "MVTU_INSERTED_COUNT" BIGINT NOT NULL DEFAULT 0,
  "MVTU_DELETED_COUNT" BIGINT NOT NULL DEFAULT 0
);
...
ALTER TABLE "APP"."MV_TABLES_USED" ADD CONSTRAINT "MV_TABLES_USED_PK" PRIMARY KEY ("MV_CREATION_METADATA_ID", "TBL_ID");
