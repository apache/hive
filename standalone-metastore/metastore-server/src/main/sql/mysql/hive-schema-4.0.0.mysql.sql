...
CREATE TABLE SCHEDULED_EXECUTIONS (
	SCHEDULED_EXECUTION_ID INTEGER NOT NULL,
	END_TIME INTEGER,
	...
	START_TIME INTEGER,
	STATE VARCHAR(256),
	EXECUTIONS_SCHEDULED_QUERY_ID_OID BIGINT,
	CONSTRAINT SCHEDULED_EXECUTIONS_PK PRIMARY KEY (SCHEDULED_EXECUTION_ID),
	CONSTRAINT SCHEDULED_EXECUTIONS_SCHQ_FK FOREIGN KEY (EXECUTIONS_SCHEDULED_QUERY_ID_OID) REFERENCES SCHEDULED_QUERIES(SCHEDULED_QUERY_ID) ON DELETE CASCADE
);
CREATE INDEX LASTUPDATETIMEINDEX ON SCHEDULED_EXECUTIONS (LAST_UPDATE_TIME);
CREATE INDEX SCHEDULED_EXECUTIONS_N49 ON SCHEDULED_EXECUTIONS (SCHEDULED_QUERY_ID);
CREATE UNIQUE INDEX SQL190613013116950 ON SCHEDULED_EXECUTIONS (SCHEDULED_EXECUTION_ID);
CREATE INDEX SQL190613013117050 ON SCHEDULED_EXECUTIONS (EXECUTIONS_SCHEDULED_QUERY_ID_OID);
