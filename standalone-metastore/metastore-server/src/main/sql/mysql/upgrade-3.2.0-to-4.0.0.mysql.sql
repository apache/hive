...
CREATE TABLE IF NOT EXISTS `DC_PRIVS` (
  ...
  `CREATE_TIME` int(11) NOT NULL,
  `DC_NAME` VARCHAR(128) DEFAULT NULL,
  ...
  UNIQUE KEY `DCPRIVILEGEINDEX` (`AUTHORIZER`,`DC_NAME`,`PRINCIPAL_NAME`,`PRINCIPAL_TYPE`,`DC_PRIV`,`GRANTOR`,`GRANTOR_TYPE`),
  KEY `DC_PRIVS_N49` (`DC_NAME`),
  CONSTRAINT `DC_PRIVS_FK1` FOREIGN KEY (`DC_NAME`) REFERENCES `DATACONNECTORS` (`NAME`)
  ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
