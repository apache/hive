...
CREATE TABLE "TXN_LOCK_TBL" (
  ...
  CONSTRAINT "TXN_LOCK_TBL_PK" PRIMARY KEY ("TXN_LOCK")
);
...
CREATE TABLE "NEXT_LOCK_ID" (
  ...
  CONSTRAINT "NEXT_LOCK_ID_PK" PRIMARY KEY ("NL_NEXT")
);
...
CREATE TABLE "NEXT_COMPACTION_QUEUE_ID" (
  ...
  CONSTRAINT "NEXT_COMPACTION_QUEUE_ID_PK" PRIMARY KEY ("NCQ_NEXT")
);
...
CREATE TABLE "TXN_TO_WRITE_ID" (
  ...
  CONSTRAINT "TXN_TO_WRITE_ID_PK" PRIMARY KEY ("T2W_TXNID", "T2W_DATABASE", "T2W_TABLE")
);
...
CREATE TABLE "NEXT_WRITE_ID" (
  ...
  CONSTRAINT "NEXT_WRITE_ID_PK" PRIMARY KEY ("NWI_TABLE", "NWI_DATABASE")
);
...
CREATE TABLE "MIN_HISTORY_WRITE_ID" (
  ...
  CONSTRAINT "MIN_HISTORY_WRITE_ID_PK" PRIMARY KEY ("MH_TXNID", "MH_DATABASE", "MH_TABLE", "MH_WRITEID")
);
