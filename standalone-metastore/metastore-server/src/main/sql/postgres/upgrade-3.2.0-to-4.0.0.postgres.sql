...
CREATE TABLE "SP_POS_ARGS" (
  ...
  PRIMARY KEY ("SP_ID", "INTEGER_IDX")
);

ALTER TABLE ONLY "SP_POS_ARGS" ADD CONSTRAINT "SPPOSARGS_FK2" FOREIGN KEY ("SP_ID") REFERENCES "STORED_PROCS" ("SP_ID");
