...
CREATE TABLE IF NOT EXISTS "SCHEMA_BRANCH" (
   "SCHEMA_BRANCH_ID"  SERIAL  UNIQUE NOT NULL,
   "NAME"              VARCHAR(255)    NOT NULL,
   "SCHEMA_NAME"   VARCHAR(255)    NOT NULL,
   "DESCRIPTION"          TEXT,
   "TIMESTAMP"            BIGINT          DEFAULT NULL,
   PRIMARY KEY ("SCHEMA_BRANCH_ID"),
   FOREIGN KEY ("SCHEMA_BRANCH_ID") REFERENCES "I_SCHEMA" ("NAME") ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS "SCHEMA_BRANCH_VERSION_MAPPING" (
   ...
   UNIQUE ("SCHEMA_BRANCH_ID", "SCHEMA_VERSION_ID"),
