...
ALTER TABLE "IDXS" DROP CONSTRAINT "IDXS_ORIG_TBL_ID_fkey";
ALTER TABLE "IDXS" DROP CONSTRAINT "IDXS_SD_ID_fkey";
ALTER TABLE "IDXS" DROP CONSTRAINT "IDXS_INDEX_TBL_ID_fkey";
