...
CREATE INDEX "TXNS_STATE_TYPE_ID_IDX" ON "TXNS" USING btree ("TXN_STATE", "TXN_TYPE", "TXN_ID");
...
CREATE INDEX "HL_ACQUIRED_AT_IDX" ON "HIVE_LOCKS" USING btree ("HL_ACQUIRED_AT");
...
CREATE INDEX "CQ_STATE_COMMIT_TIME_IDX" ON "COMPACTION_QUEUE" USING btree ("CQ_STATE", "CQ_COMMIT_TIME");
