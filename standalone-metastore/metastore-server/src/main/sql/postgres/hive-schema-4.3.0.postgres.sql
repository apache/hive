...
CREATE TABLE "TXN_COMPONENTS" (
  ...
  "TC_CATALOG" varchar(128) NOT NULL,
...
CREATE TABLE "COMPLETED_TXN_COMPONENTS" (
  ...
  "CTC_CATALOG" varchar(128) NOT NULL,
...
CREATE TABLE "COMPACTION_QUEUE" (
  ...
  "CQ_CATALOG" varchar(128) NOT NULL,
...
CREATE TABLE "COMPLETED_COMPACTIONS" (
  ...
  "CC_CATALOG" varchar(128) NOT NULL,
...
CREATE TABLE "COMPACTION_METRICS_CACHE" (
    "CMC_CATALOG" varchar(128) NOT NULL,
...
CREATE TABLE "TXN_TO_WRITE_ID" (
  ...
  "T2W_CATALOG" varchar(128) NOT NULL,
...
CREATE TABLE "NEXT_WRITE_ID" (
  "NWI_CATALOG" varchar(128) NOT NULL,
...
CREATE TABLE "MIN_HISTORY_WRITE_ID" (
  ...
  "MH_CATALOG" varchar(128) NOT NULL,
...
CREATE TABLE "TXN_WRITE_NOTIFICATION_LOG" (
  ...
  "WNL_CATALOG" varchar(128) NOT NULL,
  ...
  PRIMARY KEY ("WNL_TXNID", "WNL_CATALOG", "WNL_DATABASE", "WNL_TABLE", "WNL_PARTITION")
);
