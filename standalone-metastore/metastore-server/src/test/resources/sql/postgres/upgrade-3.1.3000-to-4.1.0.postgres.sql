...
-- HIVE-17306
ALTER TABLE "COMPLETED_TXN_COMPONENTS" ADD COLUMN "INV_ID" BIGSERIAL PRIMARY KEY;
...
ALTER TABLE "TXN_COMPONENTS" ADD COLUMN "INV_ID" BIGSERIAL PRIMARY KEY;
ALTER TABLE "TXN_TO_WRITE_ID" ADD CONSTRAINT "TXN_TO_WRITE_ID_PK" PRIMARY KEY ("T2W_TXNID", "T2W_DATABASE", "T2W_TABLE");
ALTER TABLE "WRITE_SET" ADD COLUMN "INV_ID" BIGSERIAL PRIMARY KEY;
ALTER TABLE "COMPACTION_METRICS_CACHE" ADD COLUMN "INV_ID" BIGSERIAL PRIMARY KEY;
