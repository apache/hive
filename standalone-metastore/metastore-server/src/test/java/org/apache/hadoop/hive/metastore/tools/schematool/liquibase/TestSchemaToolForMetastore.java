...
//    dbs.add(new Object[] { new Mariadb() }); Disabled due to HIVE-27749
  ...
  */
  ...
  @Test
  public void testHiveMetastoreDbPropertiesTable() throws HiveMetaException, ParseException {
    execute("-initSchemaTo 3.0.0");
    validateMetastoreDbPropertiesTable();
  }

  @Test
  public void testMetastoreDbPropertiesAfterUpgrade() throws HiveMetaException, ParseException {
    execute("-initSchemaTo 1.2.0");
  ...
  private void executeStriptAsStream(String[] lines) throws IOException {
    ...
    try (InputStream inputStream = new ByteArrayInputStream(String.join(System.lineSeparator(), lines).getBytes(StandardCharsets.UTF_8))) {
