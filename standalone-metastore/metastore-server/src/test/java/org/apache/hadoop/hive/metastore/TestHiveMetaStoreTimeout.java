...
public class TestHiveMetaStoreTimeout {
  ...
  public static void setUp() throws Exception {
    HMSHandler.TEST_TIMEOUT_ENABLED = true;
  ...
  public static void tearDown() throws Exception {
    HMSHandler.TEST_TIMEOUT_ENABLED = false;
    try {
      client.close();
    } catch (Throwable e) {
  ...
  public void testNoTimeout() throws Exception {
    HMSHandler.TEST_TIMEOUT_VALUE = 250;
  ...
  public void testTimeout() throws Exception {
    HMSHandler.TEST_TIMEOUT_VALUE = 2 * 1000;
    ...
    // restore
    HMSHandler.TEST_TIMEOUT_VALUE = 1;
  }
  ...
  public void testResetTimeout() throws Exception {
    ...
    // reset
    HMSHandler.TEST_TIMEOUT_VALUE = 2000;
