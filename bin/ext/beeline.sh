...
beeline () {
  ...
  export HADOOP_CLIENT_OPTS="$HADOOP_CLIENT_OPTS -Dlog4j.configurationFile=beeline-log4j2.properties -Djava.net.preferIPv6Stack=true -Djava.net.preferIPv6Addresses=true"
