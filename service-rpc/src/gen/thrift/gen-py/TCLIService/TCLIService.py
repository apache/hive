...
class SetClientInfo_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'req', (TSetClientInfoReq, TSetClientInfoReq.thrift_spec), None, ), # 1
  )
...
class SetClientInfo_result:
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (TSetClientInfoResp, TSetClientInfoResp.thrift_spec), None, ), # 0
  )
