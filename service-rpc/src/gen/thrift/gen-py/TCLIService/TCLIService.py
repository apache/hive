...
class Client(Iface):
    ...
    def SetClientInfo(self, req):
        ...
        return self.recv_SetClientInfo()

    def send_SetClientInfo(self, req):
        self._oprot.writeMessageBegin('SetClientInfo', TMessageType.CALL, self._seqid)
        args = SetClientInfo_args()
        args.req = req
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_SetClientInfo(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
...
class Processor(Iface, TProcessor):
    ...
    def process_SetClientInfo(self, seqid, iprot, oprot):
        args = SetClientInfo_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = SetClientInfo_result()
        try:
            result.success = self._handler.SetClientInfo(args.req)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("SetClientInfo", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class GetQueryId_args(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(GetQueryId_args)
GetQueryId_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [TGetQueryIdReq, None], None, ),  # 1
)


class GetQueryId_result(object):
    """
    Attributes:
     - success
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(GetQueryId_result)
GetQueryId_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TGetQueryIdResp, None], None, ),  # 0
)


class SetClientInfo_args(object):
    """
    Attributes:
     - req
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('SetClientInfo_args')
        if self.req is not None:
            oprot.writeFieldBegin('req', TType.STRUCT, 1)
            self.req.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(SetClientInfo_args)
SetClientInfo_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [TSetClientInfoReq, None], None, ),  # 1
)


class SetClientInfo_result(object):
    """
    Attributes:
     - success
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = TSetClientInfoResp()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('SetClientInfo_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(SetClientInfo_result)
