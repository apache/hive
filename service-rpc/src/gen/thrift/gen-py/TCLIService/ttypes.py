...
class TUploadDataResp(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TUploadDataResp')
        if self.status is not None:
            oprot.writeFieldBegin('status', TType.STRUCT, 1)
            self.status.write(oprot)
            oprot.writeFieldEnd()
...
class TDownloadDataReq(object):
    ...
    def __init__(self, sessionHandle=None, tableName=None, query=None, format=None, downloadOptions=None,):
        self.sessionHandle = sessionHandle
        self.tableName = tableName
        self.query = query
        self.format = format
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i165 in range(_size161):
                        ...
                        self.downloadOptions[_key166] = _val167
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TDownloadDataReq')
        if self.sessionHandle is not None:
            oprot.writeFieldBegin('sessionHandle', TType.STRUCT, 1)
            self.sessionHandle.write(oprot)
            oprot.writeFieldEnd()
        ...
        if self.format is not None:
            ...
            oprot.writeFieldEnd()
        if self.downloadOptions is not None:
            oprot.writeFieldBegin('downloadOptions', TType.MAP, 5)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.downloadOptions))
            for kiter168, viter169 in self.downloadOptions.items():
...
class TDownloadDataResp(object):
    """
    Attributes:
     - status
     - operationHandle
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TDownloadDataResp')
        if self.status is not None:
            oprot.writeFieldBegin('status', TType.STRUCT, 1)
            self.status.write(oprot)
            oprot.writeFieldEnd()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i174 in range(_size170):
                        _elem175 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i181 in range(_size177):
                        _elem182 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
...
all_structs.append(TUploadDataReq)
TUploadDataReq.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'sessionHandle', [TSessionHandle, None], None, ),  # 1
...
all_structs.append(TUploadDataResp)
TUploadDataResp.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'status', [TStatus, None], None, ),  # 1
    (2, TType.STRUCT, 'operationHandle', [TOperationHandle, None], None, ),  # 2
)
all_structs.append(TDownloadDataReq)
TDownloadDataReq.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'sessionHandle', [TSessionHandle, None], None, ),  # 1
    (2, TType.STRING, 'tableName', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'query', 'UTF8', None, ),  # 3
    (4, TType.STRING, 'format', 'UTF8', None, ),  # 4
    (5, TType.MAP, 'downloadOptions', (TType.STRING, 'UTF8', TType.STRING, 'UTF8', False), None, ),  # 5
)
all_structs.append(TDownloadDataResp)
TDownloadDataResp.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'status', [TStatus, None], None, ),  # 1
    (2, TType.STRUCT, 'operationHandle', [TOperationHandle, None], None, ),  # 2
)
