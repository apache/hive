...
class TUploadDataReq
  ...
  FIELDS = {
    ...
    PATH => {:type => ::Thrift::Types::STRING, :name => 'path', :optional => true},
...
class TDownloadDataReq
  ...
  FIELDS = {
    ...
    DOWNLOADOPTIONS => {:type => ::Thrift::Types::MAP, :name => 'downloadOptions', :key => {:type => ::Thrift::Types::STRING}, :value => {:type => ::Thrift::Types::STRING}, :optional => true}
  }
