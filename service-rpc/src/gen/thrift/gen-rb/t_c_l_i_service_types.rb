...
module TOperationType
  ...
  GET_FUNCTIONS = 8
  UNKNOWN = 9
  VALUE_MAP = {0 => "EXECUTE_STATEMENT", 1 => "PROCEDURAL_SQL", 2 => "GET_TYPE_INFO", 3 => "GET_CATALOGS", 4 => "GET_SCHEMAS", 5 => "GET_TABLES", 6 => "GET_TABLE_TYPES", 7 => "GET_COLUMNS", 8 => "GET_FUNCTIONS", 9 => "UNKNOWN"}
  VALID_VALUES = Set.new([EXECUTE_STATEMENT, PROCEDURAL_SQL, GET_TYPE_INFO, GET_CATALOGS, GET_SCHEMAS, GET_TABLES, GET_TABLE_TYPES, GET_COLUMNS, GET_FUNCTIONS, UNKNOWN]).freeze
end
