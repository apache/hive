...
public class TCLIService {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("GetProgressUpdate", new GetProgressUpdate());
      return processMap;
    }
    ...
    public static class GetProgressUpdate<I extends Iface> extends org.apache.thrift.ProcessFunction<I, GetProgressUpdate_args> {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class GetProgressUpdate<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, GetProgressUpdate_args, TProgressUpdateResp> {
      public GetProgressUpdate() {
        super("GetProgressUpdate");
      }
      ...
      public AsyncMethodCallback<TProgressUpdateResp> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<TProgressUpdateResp>() { 
      ...
      public void start(I iface, GetProgressUpdate_args args, org.apache.thrift.async.AsyncMethodCallback<TProgressUpdateResp> resultHandler) throws TException {
  ...
  public static class GetProgressUpdate_args implements org.apache.thrift.TBase<GetProgressUpdate_args, GetProgressUpdate_args._Fields>, java.io.Serializable, Cloneable, Comparable<GetProgressUpdate_args>   {
    ...
    @Override
    public int compareTo(GetProgressUpdate_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("GetProgressUpdate_args(");
      boolean first = true;
    ...
    private static class GetProgressUpdate_argsStandardSchemeFactory implements SchemeFactory {
      public GetProgressUpdate_argsStandardScheme getScheme() {
        return new GetProgressUpdate_argsStandardScheme();
      }
    }

    private static class GetProgressUpdate_argsStandardScheme extends StandardScheme<GetProgressUpdate_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, GetProgressUpdate_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // REQ
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.req = new TProgressUpdateReq();
                struct.req.read(iprot);
                struct.setReqIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, GetProgressUpdate_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class GetProgressUpdate_argsTupleSchemeFactory implements SchemeFactory {
      public GetProgressUpdate_argsTupleScheme getScheme() {
        return new GetProgressUpdate_argsTupleScheme();
      }
    }

    private static class GetProgressUpdate_argsTupleScheme extends TupleScheme<GetProgressUpdate_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, GetProgressUpdate_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetReq()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, GetProgressUpdate_args struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.req = new TProgressUpdateReq();
  ...
  public static class GetProgressUpdate_result implements org.apache.thrift.TBase<GetProgressUpdate_result, GetProgressUpdate_result._Fields>, java.io.Serializable, Cloneable, Comparable<GetProgressUpdate_result>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetProgressUpdate_result");

    private static final org.apache.thrift.protocol.TField SUCCESS_FIELD_DESC = new org.apache.thrift.protocol.TField("success", org.apache.thrift.protocol.TType.STRUCT, (short)0);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new GetProgressUpdate_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new GetProgressUpdate_resultTupleSchemeFactory());
    }

    private TProgressUpdateResp success; // required
    ...
    static {
      ...
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetProgressUpdate_result.class, metaDataMap);
    }

    public GetProgressUpdate_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public GetProgressUpdate_result(GetProgressUpdate_result other) {
      if (other.isSetSuccess()) {
        this.success = new TProgressUpdateResp(other.success);
      }
    }

    public GetProgressUpdate_result deepCopy() {
      return new GetProgressUpdate_result(this);
    }
    ...
    public TProgressUpdateResp getSuccess() {
      return this.success;
    }

    public void setSuccess(TProgressUpdateResp success) {
      this.success = success;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((TProgressUpdateResp)value);
        }
        break;
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof GetProgressUpdate_result)
        return this.equals((GetProgressUpdate_result)that);
      return false;
    }

    public boolean equals(GetProgressUpdate_result that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(GetProgressUpdate_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("GetProgressUpdate_result(");
      boolean first = true;
    ...
    private static class GetProgressUpdate_resultStandardSchemeFactory implements SchemeFactory {
      public GetProgressUpdate_resultStandardScheme getScheme() {
        return new GetProgressUpdate_resultStandardScheme();
      }
    }

    private static class GetProgressUpdate_resultStandardScheme extends StandardScheme<GetProgressUpdate_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, GetProgressUpdate_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new TProgressUpdateResp();
                struct.success.read(iprot);
                struct.setSuccessIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, GetProgressUpdate_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class GetProgressUpdate_resultTupleSchemeFactory implements SchemeFactory {
      public GetProgressUpdate_resultTupleScheme getScheme() {
        return new GetProgressUpdate_resultTupleScheme();
      }
    }

    private static class GetProgressUpdate_resultTupleScheme extends TupleScheme<GetProgressUpdate_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, GetProgressUpdate_result struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, GetProgressUpdate_result struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = new TProgressUpdateResp();
