...
@org.apache.hadoop.hive.common.classification.InterfaceAudience.Public @org.apache.hadoop.hive.common.classification.InterfaceStability.Stable public class TTypeDesc implements org.apache.thrift.TBase<TTypeDesc, TTypeDesc._Fields>, java.io.Serializable, Cloneable, Comparable<TTypeDesc> {
  ...
  private @org.apache.thrift.annotation.Nullable java.util.List<TTypeEntry> types; // required
  ...
  public TTypeDesc(
    java.util.List<TTypeEntry> types)
  {
    this();
    this.types = types;
  }
  ...
  public TTypeDesc(TTypeDesc other) {
    if (other.isSetTypes()) {
      java.util.List<TTypeEntry> __this__types = new java.util.ArrayList<TTypeEntry>(other.types.size());
  ...
  public void addToTypes(TTypeEntry elem) {
    if (this.types == null) {
      this.types = new java.util.ArrayList<TTypeEntry>();
    }
    this.types.add(elem);
  }
  ...
  public void setTypes(@org.apache.thrift.annotation.Nullable java.util.List<TTypeEntry> types) {
    this.types = types;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case TYPES:
      if (value == null) {
        ...
        setTypes((java.util.List<TTypeEntry>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.types = new java.util.ArrayList<TTypeEntry>(_list30.size);
                @org.apache.thrift.annotation.Nullable TTypeEntry _elem31;
  ...
  private static class TTypeDescTupleScheme extends org.apache.thrift.scheme.TupleScheme<TTypeDesc> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TTypeDesc struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        struct.types = new java.util.ArrayList<TTypeEntry>(_list35.size);
        @org.apache.thrift.annotation.Nullable TTypeEntry _elem36;
