...
public class TProgressUpdateReq implements org.apache.thrift.TBase<TProgressUpdateReq, TProgressUpdateReq._Fields>, java.io.Serializable, Cloneable, Comparable<TProgressUpdateReq> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TProgressUpdateReq");
  ...
  static {
    schemes.put(StandardScheme.class, new TProgressUpdateReqStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TProgressUpdateReqTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TProgressUpdateReq.class, metaDataMap);
  }

  public TProgressUpdateReq() {
  }
   ...
   */
  public TProgressUpdateReq(TProgressUpdateReq other) {
    if (other.isSetOperationHandle()) {
      this.operationHandle = new TOperationHandle(other.operationHandle);
    }
  }

  public TProgressUpdateReq deepCopy() {
    return new TProgressUpdateReq(this);
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TProgressUpdateReq)
      return this.equals((TProgressUpdateReq)that);
    return false;
  }

  public boolean equals(TProgressUpdateReq that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TProgressUpdateReq other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TProgressUpdateReq(");
    boolean first = true;
  ...
  private static class TProgressUpdateReqStandardSchemeFactory implements SchemeFactory {
    public TProgressUpdateReqStandardScheme getScheme() {
      return new TProgressUpdateReqStandardScheme();
    }
  }

  private static class TProgressUpdateReqStandardScheme extends StandardScheme<TProgressUpdateReq> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TProgressUpdateReq struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TProgressUpdateReq struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TProgressUpdateReqTupleSchemeFactory implements SchemeFactory {
    public TProgressUpdateReqTupleScheme getScheme() {
      return new TProgressUpdateReqTupleScheme();
    }
  }

  private static class TProgressUpdateReqTupleScheme extends TupleScheme<TProgressUpdateReq> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TProgressUpdateReq struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      struct.operationHandle.write(oprot);
    }

    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TProgressUpdateReq struct) throws org.apache.thrift.TException {
