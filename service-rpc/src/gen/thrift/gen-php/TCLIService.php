...
interface TCLIServiceIf {
  ...
  /**
   * @param \TProgressUpdateReq $req
   * @return \TProgressUpdateResp
   */
  public function GetProgressUpdate(\TProgressUpdateReq $req);
}
...
class TCLIServiceClient implements \TCLIServiceIf {
  ...
  public function GetProgressUpdate(\TProgressUpdateReq $req)
  {
    $this->send_GetProgressUpdate($req);
    return $this->recv_GetProgressUpdate();
  }

  public function send_GetProgressUpdate(\TProgressUpdateReq $req)
  {
    $args = new \TCLIService_GetProgressUpdate_args();
    $args->req = $req;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'GetProgressUpdate', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('GetProgressUpdate', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_GetProgressUpdate()
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\TCLIService_GetProgressUpdate_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \TCLIService_GetProgressUpdate_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
    ...
    throw new \Exception("GetProgressUpdate failed: unknown result");
  }
...
class TCLIService_GetProgressUpdate_args {
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->req = new \TProgressUpdateReq();
            $xfer += $this->req->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('TCLIService_GetProgressUpdate_args');
    if ($this->req !== null) {
      if (!is_object($this->req)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
...
class TCLIService_GetProgressUpdate_result {
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new \TProgressUpdateResp();
            $xfer += $this->success->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('TCLIService_GetProgressUpdate_result');
    if ($this->success !== null) {
      if (!is_object($this->success)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
