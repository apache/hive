...
nonReserved
    ...
    | KW_FIRST | KW_FORMAT | KW_FORMATTED | KW_FUNCTIONS | KW_HISTORY | KW_HOUR | KW_IDXPROPERTIES | KW_RESPECT | KW_IGNORE
    ...
    | KW_LOCALLY
    | KW_ZORDER
    | KW_ATTACH | KW_DETACH | KW_RESOLUTION | KW_EXPLICIT | KW_STRICTEST
    | KW_BINDING | KW_AUDIT | KW_EXECUTIONS | KW_CONFLICTS | KW_COMPLIANCE | KW_UNTIL
    | KW_ERASE | KW_DEACTIVATE | KW_RELEASE | KW_REASON
    | KW_AVRO | KW_BTREE | KW_BUFFER
    | KW_ERASURE
    | KW_FIELD
    | KW_IDENTITY
    | KW_INITIAL
